...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,815 | 🐛 2,727 | 🌐 HTML | 📅 2026-03-11
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,815 | 🐛 2,727 | 🌐 HTML | 📅 2026-03-11
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,815 | 🐛 2,727 | 🌐 HTML | 📅 2026-03-11
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,815 | 🐛 2,727 | 🌐 HTML | 📅 2026-03-11
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,932 | 🐛 171 | 🌐 JavaScript | 📅 2026-03-03 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 7,947 | 🐛 114 | 🌐 TypeScript | 📅 2026-03-10 - Web component for rendering interactive 3D models.
...
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 5,973 | 🐛 7 | 🌐 JavaScript | 📅 2026-03-07 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,549 | 🐛 27 | 🌐 TypeScript | 📅 2026-03-10 - Web component for chat with AI capabilities.
...
* [`<rapi-doc>`](https://github.com/mrin9/RapiDoc) ⭐ 1,885 | 🐛 131 | 🌐 JavaScript | 📅 2026-02-11 - Web component for creating documentation from OpenAPI Specification.
...
* [`<dark-mode-toggle>`](https://github.com/GoogleChromeLabs/dark-mode-toggle) ⭐ 1,215 | 🐛 4 | 🌐 JavaScript | 📅 2026-02-14 - Custom element that allows to create a dark mode toggle or switch.
...
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 117 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-08 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [Shoelace](https://github.com/shoelace-style/shoelace) ⭐ 13,870 | 🐛 104 | 🌐 TypeScript | 📅 2026-03-05 - A forward-thinking library of web components.
* [Wired Elements](https://github.com/wiredjs/wired-elements) ⭐ 10,760 | 🐛 35 | 🌐 TypeScript | 📅 2023-10-07 - Set of common UI elements with a hand-drawn, sketchy look.
* [github-elements](https://github.com/github/github-elements) ⭐ 2,900 | 🐛 1 | 🌐 JavaScript | 📅 2025-12-08 - GitHub's Web Component collection.
* [LDRS](https://github.com/GriffinJohnston/ldrs) ⭐ 2,151 | 🐛 1 | 🌐 TypeScript | 📅 2025-10-22 - Lightweight, customizable loading animations/spinners.
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,936 | 🐛 170 | 🌐 JavaScript | 📅 2026-03-10 - Set of highly performant, accessible and flexible Web Components.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 783 | 🐛 6 | 🌐 TypeScript | 📅 2026-03-10 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 556 | 🐛 942 | 🌐 JavaScript | 📅 2026-03-10 - Evolving set of high-quality web components for building business web applications.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 270 | 🐛 1 | 🌐 JavaScript | 📅 2026-03-11 - ELMS:LN produced web components for any project.
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 239 | 🐛 328 | 🌐 JavaScript | 📅 2026-03-10 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 167 | 🐛 70 | 🌐 TypeScript | 📅 2026-03-11 - Complete library of UI components from Infragistics.
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 145 | 🐛 43 | 🌐 TypeScript | 📅 2026-03-09 - Collection of user interface web components for Umbraco CMS.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 77 | 🐛 38 | 🌐 JavaScript | 📅 2026-03-11 - Collection of web components for building Brightspace applications.
...
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 45 | 🌐 TypeScript | 📅 2026-03-10 - A schema for mutation testing results with the web components to visualize it.
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 27 | 🐛 14 | 🌐 JavaScript | 📅 2026-03-10 - Components for building web applications with Nuxeo using Web Components.
* [Titanium Elements](https://github.com/LeavittSoftware/titanium-elements) ⭐ 19 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-10 - Collection of lightweight web components used by Leavitt Group Enterprises.
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 55 | 🌐 JavaScript | 📅 2026-03-10 - Collection of web components used by TEI Publisher and apps generated by it.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 28 | 🌐 TypeScript | 📅 2026-03-10 - Ser of web components used by Equinor Fusion.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 11 | 🐛 7 | 🌐 JavaScript | 📅 2026-03-10 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,868 | 🐛 667 | 🌐 TypeScript | 📅 2026-03-11 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,791 | 🐛 164 | 🌐 SCSS | 📅 2026-03-10 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,634 | 🐛 80 | 🌐 TypeScript | 📅 2026-03-11 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,725 | 🐛 277 | 🌐 TypeScript | 📅 2026-03-11 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,492 | 🐛 216 | 🌐 TypeScript | 📅 2026-03-10 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 346 | 🐛 873 | 🌐 TypeScript | 📅 2026-03-11 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 325 | 🐛 92 | 🌐 TypeScript | 📅 2026-03-10 - Web Components implementing Siemens iX design system.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 212 | 🐛 62 | 🌐 SCSS | 📅 2026-03-10 - Set of UI components based on Momentum Design.
...
* [Astro Space UX Design System](https://github.com/RocketCommunicationsInc/astro) ⭐ 149 | 🐛 45 | 🌐 TypeScript | 📅 2026-03-10 - Set of components to build rich space app experiences with established interaction patterns.
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 132 | 🐛 228 | 🌐 HTML | 📅 2026-03-10 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 130 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 128 | 🐛 74 | 🌐 TypeScript | 📅 2026-03-10 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 65 | 🐛 44 | 🌐 TypeScript | 📅 2026-03-10 - Library of Web Components adhering to the Forge Design System.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 62 | 🐛 73 | 🌐 TypeScript | 📅 2026-03-11 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Omi](https://github.com/Tencent/omi) ⭐ 13,259 | 🐛 70 | 🌐 TypeScript | 📅 2026-01-10 - Next generation web framework in 4kb JavaScript (Web Components + JSX + Proxy + Store + Path Updating).
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,039 | 🐛 166 | 🌐 TypeScript | 📅 2026-03-10 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,634 | 🐛 80 | 🌐 TypeScript | 📅 2026-03-11 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,756 | 🐛 416 | 🌐 JavaScript | 📅 2026-03-10 - blazing fast, enterprise-grade Web Components foundation.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 135 | 🐛 6 | 🌐 TypeScript | 📅 2026-03-10 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,381 | 🐛 125 | 🌐 TypeScript | 📅 2026-03-10 - Library that extends Solid adding Custom Web Components and extensions.
...
* [nuxt-custom-elements](https://github.com/GrabarzUndPartner/nuxt-custom-elements) ⭐ 83 | 🐛 18 | 🌐 JavaScript | 📅 2026-03-10 - Export your project components as custom elements for integration into external pages.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,815 | 🐛 2,727 | 🌐 HTML | 📅 2026-03-11

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,815 | 🐛 2,727 | 🌐 HTML | 📅 2026-03-11
...
* [@webcomponents/custom-elements](https://github.com/webcomponents/polyfills/tree/master/packages/custom-elements) ⭐ 1,181 | 🐛 143 | 🌐 HTML | 📅 2026-03-10 - Custom Elements polyfill by Polymer team.
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,756 | 🐛 416 | 🌐 JavaScript | 📅 2026-03-10 - Shadow DOM polyfill by [LWC](https://lwc.dev).
* [@webcomponents/shadydom](https://github.com/webcomponents/polyfills/tree/master/packages/shadydom) ⭐ 1,181 | 🐛 143 | 🌐 HTML | 📅 2026-03-10 - ShadowDOM v1 shim.
* [@webcomponents/shadycss](https://github.com/webcomponents/polyfills/tree/master/packages/shadycss) ⭐ 1,181 | 🐛 143 | 🌐 HTML | 📅 2026-03-10 - ShadowDOM style encapsulation shim.

#### HTML Templates polyfills

* [@webcomponents/template](https://github.com/webcomponents/polyfills/tree/master/packages/template) ⭐ 1,181 | 🐛 143 | 🌐 HTML | 📅 2026-03-10 - Minimal polyfill for `<template>`.
