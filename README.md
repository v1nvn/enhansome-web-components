...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,775 | 🐛 2,699 | 🌐 HTML | 📅 2026-02-16
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,775 | 🐛 2,699 | 🌐 HTML | 📅 2026-02-16
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,775 | 🐛 2,699 | 🌐 HTML | 📅 2026-02-16
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,775 | 🐛 2,699 | 🌐 HTML | 📅 2026-02-16
...
* [web-components-examples](https://github.com/mdn/web-components-examples) ⭐ 3,360 | 🐛 4 | 🌐 JavaScript | 📅 2026-01-13 - Series of web components examples, related to the MDN web components documentation.
...
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 7,905 | 🐛 116 | 🌐 TypeScript | 📅 2026-02-12 - Web component for rendering interactive 3D models.
* [`<lite-youtube>`](https://github.com/paulirish/lite-youtube-embed) ⭐ 6,284 | 🐛 27 | 🌐 HTML | 📅 2025-11-10 - Lite YouTube embed with a focus on visual performance.
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 5,956 | 🐛 7 | 🌐 JavaScript | 📅 2026-01-22 - Web component for drawing patterns with CSS.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,416 | 🐛 18 | 🌐 JavaScript | 📅 2026-02-14 quickly into your page using custom elements.
...
* [Shoelace](https://github.com/shoelace-style/shoelace) ⭐ 13,854 | 🐛 103 | 🌐 TypeScript | 📅 2025-10-29 - A forward-thinking library of web components.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 554 | 🐛 942 | 🌐 JavaScript | 📅 2026-02-15 - Evolving set of high-quality web components for building business web applications.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 98 | 🐛 3 | 🌐 JavaScript | 📅 2026-02-15 - General use Web Components for websites and applications.
...
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 47 | 🌐 TypeScript | 📅 2026-02-16 - A schema for mutation testing results with the web components to visualize it.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,847 | 🐛 646 | 🌐 TypeScript | 📅 2026-02-12 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,749 | 🐛 164 | 🌐 SCSS | 📅 2026-02-14 - Material Design implemented as Web Components.
...
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,721 | 🐛 281 | 🌐 TypeScript | 📅 2026-02-16 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,487 | 🐛 222 | 🌐 TypeScript | 📅 2026-02-15 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 346 | 🐛 847 | 🌐 TypeScript | 📅 2026-02-16 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 321 | 🐛 96 | 🌐 TypeScript | 📅 2026-02-15 - Web Components implementing Siemens iX design system.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 63 | 🐛 70 | 🌐 TypeScript | 📅 2026-02-15 - Library of Web Components adhering to the Forge Design System.
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 59 | 🐛 71 | 🌐 TypeScript | 📅 2026-02-16 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,754 | 🐛 417 | 🌐 JavaScript | 📅 2026-02-14 - blazing fast, enterprise-grade Web Components foundation.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,111 | 🐛 131 | 🌐 TypeScript | 📅 2026-02-14 - Library that extends Solid adding Custom Web Components and extensions.
...
* [Web Components Compiler](https://github.com/ProjectEvergreen/wcc) ⭐ 120 | 🐛 22 | 🌐 JavaScript | 📅 2026-02-14 - Compiler to make server-side rendering of native web components easier.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 36 | 🌐 JavaScript | 📅 2026-02-15 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,775 | 🐛 2,699 | 🌐 HTML | 📅 2026-02-16

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,775 | 🐛 2,699 | 🌐 HTML | 📅 2026-02-16
...
* [@webcomponents/custom-elements](https://github.com/webcomponents/polyfills/tree/master/packages/custom-elements) ⭐ 1,179 | 🐛 141 | 🌐 HTML | 📅 2026-02-13 - Custom Elements polyfill by Polymer team.
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,754 | 🐛 417 | 🌐 JavaScript | 📅 2026-02-14 - Shadow DOM polyfill by [LWC](https://lwc.dev).
* [@webcomponents/shadydom](https://github.com/webcomponents/polyfills/tree/master/packages/shadydom) ⭐ 1,179 | 🐛 141 | 🌐 HTML | 📅 2026-02-13 - ShadowDOM v1 shim.
* [@webcomponents/shadycss](https://github.com/webcomponents/polyfills/tree/master/packages/shadycss) ⭐ 1,179 | 🐛 141 | 🌐 HTML | 📅 2026-02-13 - ShadowDOM style encapsulation shim.

#### HTML Templates polyfills

* [@webcomponents/template](https://github.com/webcomponents/polyfills/tree/master/packages/template) ⭐ 1,179 | 🐛 141 | 🌐 HTML | 📅 2026-02-13 - Minimal polyfill for `<template>`.
