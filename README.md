...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,828 | 🐛 2,735 | 🌐 HTML | 📅 2026-03-16
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,828 | 🐛 2,735 | 🌐 HTML | 📅 2026-03-16
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,828 | 🐛 2,735 | 🌐 HTML | 📅 2026-03-16
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,828 | 🐛 2,735 | 🌐 HTML | 📅 2026-03-16
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,932 | 🐛 171 | 🌐 JavaScript | 📅 2026-03-11 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 7,959 | 🐛 114 | 🌐 TypeScript | 📅 2026-03-13 - Web component for rendering interactive 3D models.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,445 | 🐛 19 | 🌐 JavaScript | 📅 2026-03-12 quickly into your page using custom elements.
...
* [`<range-slider>`](https://github.com/andreruffert/range-slider-element) ⭐ 90 | 🐛 7 | 🌐 JavaScript | 📅 2026-03-16 - Accessible range slider custom element with keyboard support.
...
* [Shoelace](https://github.com/shoelace-style/shoelace) ⭐ 13,876 | 🐛 105 | 🌐 TypeScript | 📅 2026-03-05 - A forward-thinking library of web components.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,936 | 🐛 170 | 🌐 JavaScript | 📅 2026-03-15 - Set of highly performant, accessible and flexible Web Components.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 555 | 🐛 943 | 🌐 JavaScript | 📅 2026-03-13 - Evolving set of high-quality web components for building business web applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 27 | 🐛 23 | 🌐 JavaScript | 📅 2026-03-15 - Components for building web applications with Nuxeo using Web Components.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,877 | 🐛 663 | 🌐 TypeScript | 📅 2026-03-14 - Library of Web Components that supports Microsoft's Fluent design language.
...
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,638 | 🐛 84 | 🌐 TypeScript | 📅 2026-03-13 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,727 | 🐛 281 | 🌐 TypeScript | 📅 2026-03-16 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 346 | 🐛 873 | 🌐 TypeScript | 📅 2026-03-16 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 328 | 🐛 94 | 🌐 TypeScript | 📅 2026-03-15 - Web Components implementing Siemens iX design system.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 62 | 🐛 77 | 🌐 TypeScript | 📅 2026-03-16 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,042 | 🐛 171 | 🌐 TypeScript | 📅 2026-03-14 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,638 | 🐛 84 | 🌐 TypeScript | 📅 2026-03-13 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,757 | 🐛 418 | 🌐 JavaScript | 📅 2026-03-12 - blazing fast, enterprise-grade Web Components foundation.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,353 | 🐛 124 | 🌐 TypeScript | 📅 2026-03-10 - Library that extends Solid adding Custom Web Components and extensions.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,828 | 🐛 2,735 | 🌐 HTML | 📅 2026-03-16

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,828 | 🐛 2,735 | 🌐 HTML | 📅 2026-03-16
...
* [@webcomponents/custom-elements](https://github.com/webcomponents/polyfills/tree/master/packages/custom-elements) ⭐ 1,182 | 🐛 143 | 🌐 HTML | 📅 2026-03-13 - Custom Elements polyfill by Polymer team.
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,757 | 🐛 418 | 🌐 JavaScript | 📅 2026-03-12 - Shadow DOM polyfill by [LWC](https://lwc.dev).
* [@webcomponents/shadydom](https://github.com/webcomponents/polyfills/tree/master/packages/shadydom) ⭐ 1,182 | 🐛 143 | 🌐 HTML | 📅 2026-03-13 - ShadowDOM v1 shim.
* [@webcomponents/shadycss](https://github.com/webcomponents/polyfills/tree/master/packages/shadycss) ⭐ 1,182 | 🐛 143 | 🌐 HTML | 📅 2026-03-13 - ShadowDOM style encapsulation shim.

#### HTML Templates polyfills

* [@webcomponents/template](https://github.com/webcomponents/polyfills/tree/master/packages/template) ⭐ 1,182 | 🐛 143 | 🌐 HTML | 📅 2026-03-13 - Minimal polyfill for `<template>`.
