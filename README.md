...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,857 | 🐛 2,762 | 🌐 HTML | 📅 2026-04-03
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,857 | 🐛 2,762 | 🌐 HTML | 📅 2026-04-03
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,857 | 🐛 2,762 | 🌐 HTML | 📅 2026-04-03
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,857 | 🐛 2,762 | 🌐 HTML | 📅 2026-04-03
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,930 | 🐛 182 | 🌐 JavaScript | 📅 2026-04-02 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 7,986 | 🐛 112 | 🌐 TypeScript | 📅 2026-04-02 - Web component for rendering interactive 3D models.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,573 | 🐛 28 | 🌐 TypeScript | 📅 2026-04-02 - Web component for chat with AI capabilities.
...
* [`<shader-doodle>`](https://github.com/halvves/shader-doodle) ⭐ 582 | 🐛 6 | 🌐 JavaScript | 📅 2023-03-04 - Web component for writing and rendering shaders.
...
* [Lume](https://github.com/lume/lume) ⭐ 1,498 | 🐛 127 | 🌐 TypeScript | 📅 2026-04-02 - Custom elements for 3D graphics. Built with Three.js for WebGL/WebGPU rendering, and Solid.js for reactivity and templating.
* [Microsoft Graph Toolkit](https://github.com/microsoftgraph/microsoft-graph-toolkit) ⭐ 1,046 | 🐛 186 | 🌐 TypeScript | 📅 2026-02-28 - Collection of web components for the Microsoft Graph.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 791 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-27 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 557 | 🐛 943 | 🌐 JavaScript | 📅 2026-04-03 - Evolving set of high-quality web components for building business web applications.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 270 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-02 - ELMS:LN produced web components for any project.
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 324 | 🌐 JavaScript | 📅 2026-04-02 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 166 | 🐛 67 | 🌐 TypeScript | 📅 2026-04-02 - Complete library of UI components from Infragistics.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 77 | 🐛 45 | 🌐 JavaScript | 📅 2026-04-02 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 35 | 🌐 JavaScript | 📅 2026-04-02 - Components for building web applications with Nuxeo using Web Components.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 12 | 🐛 8 | 🌐 JavaScript | 📅 2026-04-02 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,909 | 🐛 669 | 🌐 TypeScript | 📅 2026-04-02 - Library of Web Components that supports Microsoft's Fluent design language.
...
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,638 | 🐛 90 | 🌐 TypeScript | 📅 2026-04-03 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,730 | 🐛 291 | 🌐 TypeScript | 📅 2026-04-03 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,499 | 🐛 238 | 🌐 TypeScript | 📅 2026-04-03 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 350 | 🐛 885 | 🌐 TypeScript | 📅 2026-04-03 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 333 | 🐛 73 | 🌐 TypeScript | 📅 2026-04-02 - Web Components implementing Siemens iX design system.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 133 | 🐛 212 | 🌐 HTML | 📅 2026-04-02 - Web components for building uniform experiences with the Red Hat brand.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 66 | 🐛 36 | 🌐 TypeScript | 📅 2026-04-02 - Library of Web Components adhering to the Forge Design System.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 79 | 🌐 TypeScript | 📅 2026-04-03 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,053 | 🐛 173 | 🌐 TypeScript | 📅 2026-04-02 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,638 | 🐛 90 | 🌐 TypeScript | 📅 2026-04-03 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,354 | 🐛 120 | 🌐 TypeScript | 📅 2026-04-03 - Library that extends Solid adding Custom Web Components and extensions.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,857 | 🐛 2,762 | 🌐 HTML | 📅 2026-04-03

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,857 | 🐛 2,762 | 🌐 HTML | 📅 2026-04-03
