...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,937 | 🐛 2,799 | 🌐 HTML | 📅 2026-05-27
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,937 | 🐛 2,799 | 🌐 HTML | 📅 2026-05-27
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,937 | 🐛 2,799 | 🌐 HTML | 📅 2026-05-27
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,937 | 🐛 2,799 | 🌐 HTML | 📅 2026-05-27
...
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,086 | 🐛 113 | 🌐 TypeScript | 📅 2026-05-27 - Web component for rendering interactive 3D models.
...
* [`<emoji-picker>`](https://github.com/nolanlawson/emoji-picker-element) ⭐ 1,739 | 🐛 38 | 🌐 JavaScript | 📅 2026-05-13 - Lightweight emoji picker, distributed as a web component.
...
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 151 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-26 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,903 | 🐛 1,016 | 🌐 JavaScript | 📅 2026-05-20 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,945 | 🐛 182 | 🌐 JavaScript | 📅 2026-05-27 - Set of highly performant, accessible and flexible Web Components.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 564 | 🐛 948 | 🌐 JavaScript | 📅 2026-05-26 - Evolving set of high-quality web components for building business web applications.
* [Smart Web Components](https://github.com/HTMLElements/smart-webcomponents) ⭐ 477 | 🐛 9 | 🌐 CSS | 📅 2026-05-26 - Web components for business applications.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 273 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-26 - ELMS:LN produced web components for any project.
...
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 241 | 🐛 332 | 🌐 JavaScript | 📅 2026-05-26 - Collection of Web Components made by Clever Cloud.
...
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 148 | 🐛 56 | 🌐 TypeScript | 📅 2026-05-26 - Collection of user interface web components for Umbraco CMS.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 105 | 🐛 5 | 🌐 JavaScript | 📅 2026-05-26 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 44 | 🌐 JavaScript | 📅 2026-05-26 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 41 | 🌐 JavaScript | 📅 2026-05-27 - Components for building web applications with Nuxeo using Web Components.
...
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 56 | 🌐 JavaScript | 📅 2026-05-25 - Collection of web components used by TEI Publisher and apps generated by it.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 13 | 🐛 9 | 🌐 JavaScript | 📅 2026-05-26 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,021 | 🐛 740 | 🌐 TypeScript | 📅 2026-05-27 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,975 | 🐛 168 | 🌐 SCSS | 📅 2026-05-27 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,652 | 🐛 77 | 🌐 TypeScript | 📅 2026-05-26 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,748 | 🐛 253 | 🌐 TypeScript | 📅 2026-05-27 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,513 | 🐛 255 | 🌐 TypeScript | 📅 2026-05-26 - Adobe Spectrum design language implementation built with Web Components.
...
* [PatternFly Elements](https://github.com/patternfly/patternfly-elements) ⭐ 391 | 🐛 174 | 🌐 TypeScript | 📅 2026-05-26 - Collection of flexible and lightweight Web Components based on the Unified Design Kit.
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 364 | 🐛 908 | 🌐 TypeScript | 📅 2026-05-27 - Shared Web Components for Esri's Calcite design framework.
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 346 | 🐛 74 | 🌐 TypeScript | 📅 2026-05-26 - Web Components implementing Siemens iX design system.
...
* [Crayons](https://github.com/freshdesk/crayons) ⭐ 246 | 🐛 46 | 🌐 JavaScript | 📅 2026-05-18 - Collection of web components that adheres to the Freshworks Design System.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 139 | 🐛 191 | 🌐 HTML | 📅 2026-05-26 - Web components for building uniform experiences with the Red Hat brand.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 68 | 🐛 47 | 🌐 TypeScript | 📅 2026-05-22 - Library of Web Components adhering to the Forge Design System.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 62 | 🌐 TypeScript | 📅 2026-05-26 - Building blocks of the Lyne Design System are based on Web Components.
* [NVIDIA Elements](https://github.com/nvidia/elements) ⭐ 8 | 🐛 6 | 🌐 TypeScript | 📅 2026-05-27 - The Design Language and UI Agent Harness for AI/ML Factories, Robotics, and Autonomous Vehicles.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,094 | 🐛 183 | 🌐 TypeScript | 📅 2026-05-26 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,652 | 🐛 77 | 🌐 TypeScript | 📅 2026-05-26 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,554 | 🐛 26 | 🌐 TypeScript | 📅 2026-05-26 - Library that extends Solid adding Custom Web Components and extensions.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,903 | 🐛 1,016 | 🌐 JavaScript | 📅 2026-05-20 - Web component framework to easily create user-first experiences for the web.
...
* [Web Components Compiler](https://github.com/ProjectEvergreen/wcc) ⭐ 124 | 🐛 28 | 🌐 JavaScript | 📅 2026-05-27 - Compiler to make server-side rendering of native web components easier.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,937 | 🐛 2,799 | 🌐 HTML | 📅 2026-05-27

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,937 | 🐛 2,799 | 🌐 HTML | 📅 2026-05-27
...
* [@webcomponents/custom-elements](https://github.com/webcomponents/polyfills/tree/master/packages/custom-elements) ⭐ 1,187 | 🐛 149 | 🌐 HTML | 📅 2026-05-25 - Custom Elements polyfill by Polymer team.
...
* [@webcomponents/shadydom](https://github.com/webcomponents/polyfills/tree/master/packages/shadydom) ⭐ 1,187 | 🐛 149 | 🌐 HTML | 📅 2026-05-25 - ShadowDOM v1 shim.
* [@webcomponents/shadycss](https://github.com/webcomponents/polyfills/tree/master/packages/shadycss) ⭐ 1,187 | 🐛 149 | 🌐 HTML | 📅 2026-05-25 - ShadowDOM style encapsulation shim.

#### HTML Templates polyfills

* [@webcomponents/template](https://github.com/webcomponents/polyfills/tree/master/packages/template) ⭐ 1,187 | 🐛 149 | 🌐 HTML | 📅 2026-05-25 - Minimal polyfill for `<template>`.
