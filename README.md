...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,929 | 🐛 2,781 | 🌐 HTML | 📅 2026-05-16
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,929 | 🐛 2,781 | 🌐 HTML | 📅 2026-05-16
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,929 | 🐛 2,781 | 🌐 HTML | 📅 2026-05-16
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,929 | 🐛 2,781 | 🌐 HTML | 📅 2026-05-16
...
* [howto-components](https://github.com/GoogleChromeLabs/howto-components) ⭐ 875 | 🐛 52 | 🌐 JavaScript | 📅 2025-11-16 - Collection of web components that implement common web UI patterns.
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,936 | 🐛 171 | 🌐 JavaScript | 📅 2026-05-09 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,072 | 🐛 112 | 🌐 TypeScript | 📅 2026-04-17 - Web component for rendering interactive 3D models.
* [`<lite-youtube>`](https://github.com/paulirish/lite-youtube-embed) ⭐ 6,320 | 🐛 28 | 🌐 HTML | 📅 2025-11-10 - Lite YouTube embed with a focus on visual performance.
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 6,010 | 🐛 8 | 🌐 JavaScript | 📅 2026-04-19 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,609 | 🐛 33 | 🌐 TypeScript | 📅 2026-05-15 - Web component for chat with AI capabilities.
...
* [`<rapi-doc>`](https://github.com/mrin9/RapiDoc) ⭐ 1,892 | 🐛 135 | 🌐 JavaScript | 📅 2026-02-11 - Web component for creating documentation from OpenAPI Specification.
* [`<emoji-picker>`](https://github.com/nolanlawson/emoji-picker-element) ⭐ 1,736 | 🐛 39 | 🌐 JavaScript | 📅 2026-05-13 - Lightweight emoji picker, distributed as a web component.
...
* [`<dark-mode-toggle>`](https://github.com/GoogleChromeLabs/dark-mode-toggle) ⭐ 1,220 | 🐛 8 | 🌐 JavaScript | 📅 2026-05-08 - Custom element that allows to create a dark mode toggle or switch.
* [`<midi-player>`](https://github.com/cifkao/html-midi-player) ⭐ 875 | 🐛 21 | 🌐 TypeScript | 📅 2025-07-06 - MIDI file player and visualizer web components.
* [`<shader-doodle>`](https://github.com/halvves/shader-doodle) ⭐ 587 | 🐛 3 | 🌐 JavaScript | 📅 2026-05-06 - Web component for writing and rendering shaders.
* [`<active-table>`](https://github.com/OvidijusParsiunas/active-table) ⭐ 319 | 🐛 28 | 🌐 TypeScript | 📅 2026-02-26 - Editable table web component.
...
* [`<progressive-image>`](https://github.com/andreruffert/progressive-image-element) ⭐ 273 | 🐛 2 | 🌐 HTML | 📅 2026-05-15 - Custom element to progressively enhance image placeholders.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,498 | 🐛 24 | 🌐 JavaScript | 📅 2026-05-09 quickly into your page using custom elements.
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 148 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-14 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [`<pdfjs-viewer-element>`](https://github.com/alekswebnet/pdfjs-viewer-element) ⭐ 69 | 🐛 1 | 🌐 JavaScript | 📅 2026-04-10 - Custom element that embeds PDF.js default viewer.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,903 | 🐛 1,010 | 🌐 JavaScript | 📅 2026-05-07 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
* [Shoelace](https://github.com/shoelace-style/shoelace) ⚠️ Archived - A forward-thinking library of web components.
* [Wired Elements](https://github.com/wiredjs/wired-elements) ⭐ 10,781 | 🐛 36 | 🌐 TypeScript | 📅 2023-10-07 - Set of common UI elements with a hand-drawn, sketchy look.
* [github-elements](https://github.com/github/github-elements) ⭐ 2,906 | 🐛 1 | 🌐 JavaScript | 📅 2025-12-08 - GitHub's Web Component collection.
* [LDRS](https://github.com/GriffinJohnston/ldrs) ⭐ 2,175 | 🐛 1 | 🌐 TypeScript | 📅 2025-10-22 - Lightweight, customizable loading animations/spinners.
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,943 | 🐛 182 | 🌐 JavaScript | 📅 2026-05-15 - Set of highly performant, accessible and flexible Web Components.
...
* [Lume](https://github.com/lume/lume) ⭐ 1,502 | 🐛 127 | 🌐 TypeScript | 📅 2026-05-05 - Custom elements for 3D graphics. Built with Three.js for WebGL/WebGPU rendering, and Solid.js for reactivity and templating.
* [Microsoft Graph Toolkit](https://github.com/microsoftgraph/microsoft-graph-toolkit) ⭐ 1,056 | 🐛 186 | 🌐 TypeScript | 📅 2026-02-28 - Collection of web components for the Microsoft Graph.
* [Elix](https://github.com/elix/elix) ⭐ 836 | 🐛 12 | 🌐 JavaScript | 📅 2023-03-01 - High-quality, customizable web components for common user interface patterns.
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 806 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-02 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 564 | 🐛 943 | 🌐 JavaScript | 📅 2026-05-15 - Evolving set of high-quality web components for building business web applications.
* [Smart Web Components](https://github.com/HTMLElements/smart-webcomponents) ⭐ 476 | 🐛 9 | 🌐 CSS | 📅 2026-05-13 - Web components for business applications.
* [Apollo Elements](https://github.com/apollo-elements/apollo-elements) ⭐ 422 | 🐛 9 | 🌐 TypeScript | 📅 2026-05-09 - Custom elements for using Apollo GraphQL with various web components libraries.
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 273 | 🐛 1 | 🌐 JavaScript | 📅 2026-05-15 - ELMS:LN produced web components for any project.
* [Wokwi Elements](https://github.com/wokwi/wokwi-elements) ⭐ 244 | 🐛 24 | 🌐 TypeScript | 📅 2026-05-09 - Web Components for Arduino and various electronic parts.
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 241 | 🐛 326 | 🌐 JavaScript | 📅 2026-05-15 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 167 | 🐛 70 | 🌐 TypeScript | 📅 2026-05-15 - Complete library of UI components from Infragistics.
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 148 | 🐛 49 | 🌐 TypeScript | 📅 2026-05-13 - Collection of user interface web components for Umbraco CMS.
* [Nightingale](https://github.com/ebi-webcomponents/nightingale) ⭐ 143 | 🐛 26 | 🌐 TypeScript | 📅 2026-04-29 - Data visualisation web components for the life sciences.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 103 | 🐛 4 | 🌐 JavaScript | 📅 2026-05-15 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 47 | 🌐 JavaScript | 📅 2026-05-15 - Collection of web components for building Brightspace applications.
...
* [One Platform Components](https://github.com/1-Platform/op-components) ⭐ 32 | 🐛 17 | 🌐 TypeScript | 📅 2026-05-15 - Set of web components for Red Hat One Platform.
* [Joomla UI custom elements](https://github.com/joomla-projects/custom-elements) ⭐ 31 | 🐛 24 | 🌐 JavaScript | 📅 2026-05-09 - Compilation of Joomla 4 Custom Elements.
* [elements-sk](https://github.com/google/elements-sk) ⚠️ Archived - Collection of custom elements for "a la carte" web development.
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 36 | 🌐 JavaScript | 📅 2026-05-16 - Components for building web applications with Nuxeo using Web Components.
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 46 | 🌐 TypeScript | 📅 2026-05-16 - A schema for mutation testing results with the web components to visualize it.
* [Titanium Elements](https://github.com/LeavittSoftware/titanium-elements) ⭐ 19 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-13 - Collection of lightweight web components used by Leavitt Group Enterprises.
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 51 | 🌐 JavaScript | 📅 2026-05-14 - Collection of web components used by TEI Publisher and apps generated by it.
* [Tradeshift Elements](https://github.com/Tradeshift/elements) ⭐ 18 | 🐛 57 | 🌐 JavaScript | 📅 2026-05-13 - Reusable Tradeshift UI Components as Web Components.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 31 | 🌐 TypeScript | 📅 2026-05-14 - Ser of web components used by Equinor Fusion.
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 13 | 🐛 9 | 🌐 JavaScript | 📅 2026-05-09 - Web components library for Sme.UP.
...
* [Burnish Components](https://github.com/danfking/burnish/tree/main/packages/components) ⭐ 2 | 🐛 7 | 🌐 TypeScript | 📅 2026-05-09 - Web components for rendering MCP tool-call output as UI.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,994 | 🐛 743 | 🌐 TypeScript | 📅 2026-05-15 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,950 | 🐛 167 | 🌐 SCSS | 📅 2026-05-15 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,650 | 🐛 78 | 🌐 TypeScript | 📅 2026-05-15 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,741 | 🐛 250 | 🌐 TypeScript | 📅 2026-05-16 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,511 | 🐛 247 | 🌐 TypeScript | 📅 2026-05-15 - Adobe Spectrum design language implementation built with Web Components.
...
* [PatternFly Elements](https://github.com/patternfly/patternfly-elements) ⭐ 391 | 🐛 170 | 🌐 TypeScript | 📅 2026-05-14 - Collection of flexible and lightweight Web Components based on the Unified Design Kit.
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 361 | 🐛 906 | 🌐 TypeScript | 📅 2026-05-15 - Shared Web Components for Esri's Calcite design framework.
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 343 | 🐛 76 | 🌐 TypeScript | 📅 2026-05-13 - Web Components implementing Siemens iX design system.
...
* [Crayons](https://github.com/freshdesk/crayons) ⭐ 245 | 🐛 45 | 🌐 JavaScript | 📅 2026-04-06 - Collection of web components that adheres to the Freshworks Design System.
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 212 | 🐛 64 | 🌐 SCSS | 📅 2026-05-14 - Set of UI components based on Momentum Design.
...
* [Astro Space UX Design System](https://github.com/RocketCommunicationsInc/astro) ⭐ 150 | 🐛 64 | 🌐 TypeScript | 📅 2026-05-09 - Set of components to build rich space app experiences with established interaction patterns.
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 138 | 🐛 194 | 🌐 HTML | 📅 2026-05-15 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 130 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 129 | 🐛 70 | 🌐 TypeScript | 📅 2026-05-15 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 68 | 🐛 44 | 🌐 TypeScript | 📅 2026-05-14 - Library of Web Components adhering to the Forge Design System.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 69 | 🌐 TypeScript | 📅 2026-05-16 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,088 | 🐛 179 | 🌐 TypeScript | 📅 2026-05-15 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,650 | 🐛 78 | 🌐 TypeScript | 📅 2026-05-15 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,765 | 🐛 418 | 🌐 JavaScript | 📅 2026-05-14 - blazing fast, enterprise-grade Web Components foundation.
...
* [Panel](https://github.com/mixpanel/panel) ⭐ 274 | 🐛 16 | 🌐 JavaScript | 📅 2026-05-09 - Web Components + Virtual DOM: web standards for powerful UIs.
* [Lume Element](https://github.com/lume/element) ⭐ 185 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-25 - Write custom elements with reactivity and templating powered by Solid.js signals and effects.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 134 | 🐛 6 | 🌐 TypeScript | 📅 2026-05-13 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [DNA](https://github.com/chialab/dna) ⭐ 61 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-14 - Progressive Web Components library.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,521 | 🐛 25 | 🌐 TypeScript | 📅 2026-05-15 - Library that extends Solid adding Custom Web Components and extensions.
...
* [haunted](https://github.com/matthewp/haunted) ⭐ 2,715 | 🐛 64 | 🌐 TypeScript | 📅 2026-05-14 - React's Hooks API implemented for web components.
* [atomico](https://github.com/atomicojs/atomico) ⭐ 1,271 | 🐛 17 | 🌐 TypeScript | 📅 2026-04-20 - Small library for the creation of interfaces based on web components using functions and hooks.
...
* [preact-custom-element](https://github.com/preactjs/preact-custom-element) ⭐ 402 | 🐛 13 | 🌐 JavaScript | 📅 2026-04-21 - Generate/register a custom element from a preact component.
...
* [nuxt-custom-elements](https://github.com/GrabarzUndPartner/nuxt-custom-elements) ⭐ 83 | 🐛 15 | 🌐 JavaScript | 📅 2026-05-12 - Export your project components as custom elements for integration into external pages.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,903 | 🐛 1,010 | 🌐 JavaScript | 📅 2026-05-07 - Web component framework to easily create user-first experiences for the web.
...
* [Web Components Compiler](https://github.com/ProjectEvergreen/wcc) ⭐ 124 | 🐛 28 | 🌐 JavaScript | 📅 2026-05-13 - Compiler to make server-side rendering of native web components easier.
...
* [cypress-lit](https://github.com/simonireilly/cypress-lit) ⭐ 25 | 🐛 13 | 🌐 TypeScript | 📅 2026-05-14 - Test your Lit elements and native web components in Cypress with all the modern browsers.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 36 | 🌐 JavaScript | 📅 2026-05-15 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,929 | 🐛 2,781 | 🌐 HTML | 📅 2026-05-16

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,929 | 🐛 2,781 | 🌐 HTML | 📅 2026-05-16
...
* [`ElementInternals`'s `states` property and the `:state()` pseudo class](https://github.com/w3c/webcomponents/blob/gh-pages/proposals/custom-states-and-state-pseudo-class.md) ⭐ 4,491 | 🐛 204 | 🌐 HTML | 📅 2025-12-09
...
* [@webcomponents/custom-elements](https://github.com/webcomponents/polyfills/tree/master/packages/custom-elements) ⭐ 1,187 | 🐛 149 | 🌐 HTML | 📅 2026-05-06 - Custom Elements polyfill by Polymer team.
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,765 | 🐛 418 | 🌐 JavaScript | 📅 2026-05-14 - Shadow DOM polyfill by [LWC](https://lwc.dev).
* [@webcomponents/shadydom](https://github.com/webcomponents/polyfills/tree/master/packages/shadydom) ⭐ 1,187 | 🐛 149 | 🌐 HTML | 📅 2026-05-06 - ShadowDOM v1 shim.
* [@webcomponents/shadycss](https://github.com/webcomponents/polyfills/tree/master/packages/shadycss) ⭐ 1,187 | 🐛 149 | 🌐 HTML | 📅 2026-05-06 - ShadowDOM style encapsulation shim.

#### HTML Templates polyfills

* [@webcomponents/template](https://github.com/webcomponents/polyfills/tree/master/packages/template) ⭐ 1,187 | 🐛 149 | 🌐 HTML | 📅 2026-05-06 - Minimal polyfill for `<template>`.
