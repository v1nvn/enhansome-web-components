...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,875 | 🐛 2,764 | 🌐 HTML | 📅 2026-04-08
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,875 | 🐛 2,764 | 🌐 HTML | 📅 2026-04-08
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,875 | 🐛 2,764 | 🌐 HTML | 📅 2026-04-08
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,875 | 🐛 2,764 | 🌐 HTML | 📅 2026-04-08
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,934 | 🐛 182 | 🌐 JavaScript | 📅 2026-04-04 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 7,989 | 🐛 111 | 🌐 TypeScript | 📅 2026-04-07 - Web component for rendering interactive 3D models.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,575 | 🐛 28 | 🌐 TypeScript | 📅 2026-04-07 - Web component for chat with AI capabilities.
...
* [`<dark-mode-toggle>`](https://github.com/GoogleChromeLabs/dark-mode-toggle) ⭐ 1,219 | 🐛 6 | 🌐 JavaScript | 📅 2026-04-02 - Custom element that allows to create a dark mode toggle or switch.
* [`<midi-player>`](https://github.com/cifkao/html-midi-player) ⭐ 865 | 🐛 21 | 🌐 TypeScript | 📅 2025-07-06 - MIDI file player and visualizer web components.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,457 | 🐛 17 | 🌐 JavaScript | 📅 2026-03-31 quickly into your page using custom elements.
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 134 | 🐛 4 | 🌐 TypeScript | 📅 2026-04-07 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,918 | 🐛 1,009 | 🌐 JavaScript | 📅 2026-03-30 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 560 | 🐛 940 | 🌐 JavaScript | 📅 2026-04-07 - Evolving set of high-quality web components for building business web applications.
...
* [Apollo Elements](https://github.com/apollo-elements/apollo-elements) ⭐ 422 | 🐛 7 | 🌐 TypeScript | 📅 2026-03-27 - Custom elements for using Apollo GraphQL with various web components libraries.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 166 | 🐛 64 | 🌐 TypeScript | 📅 2026-04-07 - Complete library of UI components from Infragistics.
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 147 | 🐛 52 | 🌐 TypeScript | 📅 2026-04-07 - Collection of user interface web components for Umbraco CMS.
...
* [Blackstone UI](https://github.com/kjantzer/bui) ⭐ 110 | 🐛 17 | 🌐 JavaScript | 📅 2026-03-19 - Web components for creating interfaces by Blackstone Publishing.
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 103 | 🐛 2 | 🌐 JavaScript | 📅 2026-04-07 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 77 | 🐛 48 | 🌐 JavaScript | 📅 2026-04-08 - Collection of web components for building Brightspace applications.
...
* [One Platform Components](https://github.com/1-Platform/op-components) ⭐ 31 | 🐛 17 | 🌐 TypeScript | 📅 2026-04-01 - Set of web components for Red Hat One Platform.
* [elements-sk](https://github.com/google/elements-sk) ⚠️ Archived - Collection of custom elements for "a la carte" web development.
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 34 | 🌐 JavaScript | 📅 2026-04-07 - Components for building web applications with Nuxeo using Web Components.
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 45 | 🌐 TypeScript | 📅 2026-04-07 - A schema for mutation testing results with the web components to visualize it.
* [Titanium Elements](https://github.com/LeavittSoftware/titanium-elements) ⭐ 19 | 🐛 5 | 🌐 TypeScript | 📅 2026-04-07 - Collection of lightweight web components used by Leavitt Group Enterprises.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 15 | 🌐 TypeScript | 📅 2026-04-07 - Ser of web components used by Equinor Fusion.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,919 | 🐛 672 | 🌐 TypeScript | 📅 2026-04-07 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,844 | 🐛 162 | 🌐 SCSS | 📅 2026-04-08 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,641 | 🐛 94 | 🌐 TypeScript | 📅 2026-04-08 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,731 | 🐛 285 | 🌐 TypeScript | 📅 2026-04-08 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,500 | 🐛 245 | 🌐 TypeScript | 📅 2026-04-07 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 352 | 🐛 875 | 🌐 TypeScript | 📅 2026-04-08 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 332 | 🐛 80 | 🌐 TypeScript | 📅 2026-04-07 - Web Components implementing Siemens iX design system.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 133 | 🐛 189 | 🌐 HTML | 📅 2026-04-07 - Web components for building uniform experiences with the Red Hat brand.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 80 | 🌐 TypeScript | 📅 2026-04-08 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,051 | 🐛 177 | 🌐 TypeScript | 📅 2026-04-07 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,641 | 🐛 94 | 🌐 TypeScript | 📅 2026-04-08 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,761 | 🐛 416 | 🌐 JavaScript | 📅 2026-04-07 - blazing fast, enterprise-grade Web Components foundation.
...
* [Lume Element](https://github.com/lume/element) ⭐ 185 | 🐛 29 | 🌐 TypeScript | 📅 2026-04-07 - Write custom elements with reactivity and templating powered by Solid.js signals and effects.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,362 | 🐛 115 | 🌐 TypeScript | 📅 2026-04-06 - Library that extends Solid adding Custom Web Components and extensions.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,918 | 🐛 1,009 | 🌐 JavaScript | 📅 2026-03-30 - Web component framework to easily create user-first experiences for the web.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,875 | 🐛 2,764 | 🌐 HTML | 📅 2026-04-08

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,875 | 🐛 2,764 | 🌐 HTML | 📅 2026-04-08
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,761 | 🐛 416 | 🌐 JavaScript | 📅 2026-04-07 - Shadow DOM polyfill by [LWC](https://lwc.dev).
