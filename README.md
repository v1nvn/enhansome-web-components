...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,830 | 🐛 2,751 | 🌐 HTML | 📅 2026-03-24
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,830 | 🐛 2,751 | 🌐 HTML | 📅 2026-03-24
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,830 | 🐛 2,751 | 🌐 HTML | 📅 2026-03-24
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,830 | 🐛 2,751 | 🌐 HTML | 📅 2026-03-24
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,932 | 🐛 180 | 🌐 JavaScript | 📅 2026-03-21 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 7,968 | 🐛 114 | 🌐 TypeScript | 📅 2026-03-23 - Web component for rendering interactive 3D models.
...
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 5,976 | 🐛 7 | 🌐 JavaScript | 📅 2026-03-07 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,559 | 🐛 29 | 🌐 TypeScript | 📅 2026-03-23 - Web component for chat with AI capabilities.
* [`<vime-player>`](https://github.com/vime-js/vime) ⭐ 2,843 | 🐛 172 | 🌐 TypeScript | 📅 2024-11-17 - Customizable, extensible, accessible and framework agnostic media player.
...
* [`<dark-mode-toggle>`](https://github.com/GoogleChromeLabs/dark-mode-toggle) ⭐ 1,218 | 🐛 5 | 🌐 JavaScript | 📅 2026-03-21 - Custom element that allows to create a dark mode toggle or switch.
* [`<midi-player>`](https://github.com/cifkao/html-midi-player) ⭐ 860 | 🐛 20 | 🌐 TypeScript | 📅 2025-07-06 - MIDI file player and visualizer web components.
...
* [`<api-viewer>`](https://github.com/web-padawan/api-viewer-element) ⭐ 283 | 🐛 19 | 🌐 TypeScript | 📅 2026-03-22 - API documentation and live playground for Web Components.
...
* [`<json-viewer>`](https://github.com/alenaksu/json-viewer) ⭐ 235 | 🐛 8 | 🌐 TypeScript | 📅 2025-04-03 - Web component to visualize JSON data in a tree view.
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,451 | 🐛 23 | 🌐 JavaScript | 📅 2026-03-21 quickly into your page using custom elements.
...
* [`<pdfjs-viewer-element>`](https://github.com/alekswebnet/pdfjs-viewer-element) ⭐ 66 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-23 - Custom element that embeds PDF.js default viewer.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,921 | 🐛 1,009 | 🌐 JavaScript | 📅 2026-03-04 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
* [Shoelace](https://github.com/shoelace-style/shoelace) ⭐ 13,879 | 🐛 105 | 🌐 TypeScript | 📅 2026-03-05 - A forward-thinking library of web components.
* [Wired Elements](https://github.com/wiredjs/wired-elements) ⭐ 10,766 | 🐛 35 | 🌐 TypeScript | 📅 2023-10-07 - Set of common UI elements with a hand-drawn, sketchy look.
* [github-elements](https://github.com/github/github-elements) ⭐ 2,901 | 🐛 1 | 🌐 JavaScript | 📅 2025-12-08 - GitHub's Web Component collection.
* [LDRS](https://github.com/GriffinJohnston/ldrs) ⭐ 2,161 | 🐛 1 | 🌐 TypeScript | 📅 2025-10-22 - Lightweight, customizable loading animations/spinners.
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,937 | 🐛 173 | 🌐 JavaScript | 📅 2026-03-22 - Set of highly performant, accessible and flexible Web Components.
...
* [Microsoft Graph Toolkit](https://github.com/microsoftgraph/microsoft-graph-toolkit) ⭐ 1,048 | 🐛 188 | 🌐 TypeScript | 📅 2026-02-28 - Collection of web components for the Microsoft Graph.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 787 | 🐛 4 | 🌐 TypeScript | 📅 2026-03-24 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 557 | 🐛 937 | 🌐 JavaScript | 📅 2026-03-23 - Evolving set of high-quality web components for building business web applications.
...
* [Apollo Elements](https://github.com/apollo-elements/apollo-elements) ⭐ 421 | 🐛 5 | 🌐 TypeScript | 📅 2026-03-21 - Custom elements for using Apollo GraphQL with various web components libraries.
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 270 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-23 - ELMS:LN produced web components for any project.
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 323 | 🌐 JavaScript | 📅 2026-03-23 - Collection of Web Components made by Clever Cloud.
* [Wokwi Elements](https://github.com/wokwi/wokwi-elements) ⭐ 229 | 🐛 24 | 🌐 TypeScript | 📅 2026-03-20 - Web Components for Arduino and various electronic parts.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 166 | 🐛 69 | 🌐 TypeScript | 📅 2026-03-23 - Complete library of UI components from Infragistics.
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 146 | 🐛 51 | 🌐 TypeScript | 📅 2026-03-23 - Collection of user interface web components for Umbraco CMS.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 103 | 🐛 2 | 🌐 JavaScript | 📅 2026-03-21 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 38 | 🌐 JavaScript | 📅 2026-03-23 - Collection of web components for building Brightspace applications.
...
* [Joomla UI custom elements](https://github.com/joomla-projects/custom-elements) ⭐ 31 | 🐛 17 | 🌐 JavaScript | 📅 2026-03-07 - Compilation of Joomla 4 Custom Elements.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 28 | 🐛 27 | 🌐 JavaScript | 📅 2026-03-23 - Components for building web applications with Nuxeo using Web Components.
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 45 | 🌐 TypeScript | 📅 2026-03-23 - A schema for mutation testing results with the web components to visualize it.
* [Titanium Elements](https://github.com/LeavittSoftware/titanium-elements) ⭐ 19 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-18 - Collection of lightweight web components used by Leavitt Group Enterprises.
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 53 | 🌐 JavaScript | 📅 2026-03-18 - Collection of web components used by TEI Publisher and apps generated by it.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 13 | 🌐 TypeScript | 📅 2026-03-23 - Ser of web components used by Equinor Fusion.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 12 | 🐛 8 | 🌐 JavaScript | 📅 2026-03-23 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,883 | 🐛 661 | 🌐 TypeScript | 📅 2026-03-23 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,816 | 🐛 161 | 🌐 SCSS | 📅 2026-03-14 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,640 | 🐛 84 | 🌐 TypeScript | 📅 2026-03-24 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,728 | 🐛 292 | 🌐 TypeScript | 📅 2026-03-24 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,494 | 🐛 232 | 🌐 TypeScript | 📅 2026-03-23 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 349 | 🐛 869 | 🌐 TypeScript | 📅 2026-03-23 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 331 | 🐛 88 | 🌐 TypeScript | 📅 2026-03-23 - Web Components implementing Siemens iX design system.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 212 | 🐛 64 | 🌐 SCSS | 📅 2026-03-23 - Set of UI components based on Momentum Design.
...
* [Astro Space UX Design System](https://github.com/RocketCommunicationsInc/astro) ⭐ 149 | 🐛 48 | 🌐 TypeScript | 📅 2026-03-21 - Set of components to build rich space app experiences with established interaction patterns.
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 133 | 🐛 228 | 🌐 HTML | 📅 2026-03-23 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 130 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 128 | 🐛 74 | 🌐 TypeScript | 📅 2026-03-23 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 65 | 🐛 40 | 🌐 TypeScript | 📅 2026-03-20 - Library of Web Components adhering to the Forge Design System.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 62 | 🐛 84 | 🌐 TypeScript | 📅 2026-03-24 - Building blocks of the Lyne Design System are based on Web Components.
* [Zooplus web components](https://github.com/zooplus/zoo-web-components) ⭐ 50 | 🐛 6 | 🌐 JavaScript | 📅 2026-03-20 - Set of web components that implement Z+ shop style guide.
...
* [Omi](https://github.com/Tencent/omi) ⭐ 13,257 | 🐛 70 | 🌐 TypeScript | 📅 2026-03-17 - Next generation web framework in 4kb JavaScript (Web Components + JSX + Proxy + Store + Path Updating).
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,050 | 🐛 172 | 🌐 TypeScript | 📅 2026-03-23 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,640 | 🐛 84 | 🌐 TypeScript | 📅 2026-03-24 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,760 | 🐛 421 | 🌐 JavaScript | 📅 2026-03-24 - blazing fast, enterprise-grade Web Components foundation.
...
* [Panel](https://github.com/mixpanel/panel) ⭐ 276 | 🐛 11 | 🌐 JavaScript | 📅 2026-03-24 - Web Components + Virtual DOM: web standards for powerful UIs.
* [Lume Element](https://github.com/lume/element) ⭐ 184 | 🐛 26 | 🌐 TypeScript | 📅 2026-03-10 - Write custom elements with reactivity and templating powered by Solid.js signals and effects.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 134 | 🐛 6 | 🌐 TypeScript | 📅 2026-03-24 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,383 | 🐛 123 | 🌐 TypeScript | 📅 2026-03-23 - Library that extends Solid adding Custom Web Components and extensions.
...
* [haunted](https://github.com/matthewp/haunted) ⭐ 2,708 | 🐛 61 | 🌐 TypeScript | 📅 2026-03-06 - React's Hooks API implemented for web components.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,921 | 🐛 1,009 | 🌐 JavaScript | 📅 2026-03-04 - Web component framework to easily create user-first experiences for the web.
...
* [hello-web-components](https://github.com/fernandopasik/hello-web-components) ⭐ 31 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-21 - Simple starter hello world web component written in TypeScript.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 36 | 🌐 JavaScript | 📅 2026-03-20 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,830 | 🐛 2,751 | 🌐 HTML | 📅 2026-03-24

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,830 | 🐛 2,751 | 🌐 HTML | 📅 2026-03-24
...
* [@webcomponents/custom-elements](https://github.com/webcomponents/polyfills/tree/master/packages/custom-elements) ⭐ 1,183 | 🐛 146 | 🌐 HTML | 📅 2026-03-19 - Custom Elements polyfill by Polymer team.
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,760 | 🐛 421 | 🌐 JavaScript | 📅 2026-03-24 - Shadow DOM polyfill by [LWC](https://lwc.dev).
* [@webcomponents/shadydom](https://github.com/webcomponents/polyfills/tree/master/packages/shadydom) ⭐ 1,183 | 🐛 146 | 🌐 HTML | 📅 2026-03-19 - ShadowDOM v1 shim.
* [@webcomponents/shadycss](https://github.com/webcomponents/polyfills/tree/master/packages/shadycss) ⭐ 1,183 | 🐛 146 | 🌐 HTML | 📅 2026-03-19 - ShadowDOM style encapsulation shim.

#### HTML Templates polyfills

* [@webcomponents/template](https://github.com/webcomponents/polyfills/tree/master/packages/template) ⭐ 1,183 | 🐛 146 | 🌐 HTML | 📅 2026-03-19 - Minimal polyfill for `<template>`.
