...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,871 | 🐛 2,762 | 🌐 HTML | 📅 2026-04-09
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,871 | 🐛 2,762 | 🌐 HTML | 📅 2026-04-09
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,871 | 🐛 2,762 | 🌐 HTML | 📅 2026-04-09
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,871 | 🐛 2,762 | 🌐 HTML | 📅 2026-04-09
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,934 | 🐛 183 | 🌐 JavaScript | 📅 2026-04-04 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 7,990 | 🐛 111 | 🌐 TypeScript | 📅 2026-04-07 - Web component for rendering interactive 3D models.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,578 | 🐛 28 | 🌐 TypeScript | 📅 2026-04-07 - Web component for chat with AI capabilities.
...
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 134 | 🐛 2 | 🌐 TypeScript | 📅 2026-04-08 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,938 | 🐛 178 | 🌐 JavaScript | 📅 2026-04-09 - Set of highly performant, accessible and flexible Web Components.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 560 | 🐛 942 | 🌐 JavaScript | 📅 2026-04-08 - Evolving set of high-quality web components for building business web applications.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 270 | 🐛 1 | 🌐 JavaScript | 📅 2026-04-07 - ELMS:LN produced web components for any project.
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 328 | 🌐 JavaScript | 📅 2026-04-08 - Collection of Web Components made by Clever Cloud.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 103 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-08 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 77 | 🐛 45 | 🌐 JavaScript | 📅 2026-04-08 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 30 | 🌐 JavaScript | 📅 2026-04-08 - Components for building web applications with Nuxeo using Web Components.
...
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 55 | 🌐 JavaScript | 📅 2026-04-08 - Collection of web components used by TEI Publisher and apps generated by it.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 16 | 🌐 TypeScript | 📅 2026-04-08 - Ser of web components used by Equinor Fusion.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 12 | 🐛 8 | 🌐 JavaScript | 📅 2026-04-08 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,917 | 🐛 671 | 🌐 TypeScript | 📅 2026-04-09 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,851 | 🐛 162 | 🌐 SCSS | 📅 2026-04-08 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,640 | 🐛 91 | 🌐 TypeScript | 📅 2026-04-09 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,730 | 🐛 286 | 🌐 TypeScript | 📅 2026-04-09 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,501 | 🐛 245 | 🌐 TypeScript | 📅 2026-04-08 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 351 | 🐛 876 | 🌐 TypeScript | 📅 2026-04-09 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 332 | 🐛 79 | 🌐 TypeScript | 📅 2026-04-08 - Web Components implementing Siemens iX design system.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 133 | 🐛 184 | 🌐 HTML | 📅 2026-04-08 - Web components for building uniform experiences with the Red Hat brand.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 79 | 🌐 TypeScript | 📅 2026-04-09 - Building blocks of the Lyne Design System are based on Web Components.
* [Zooplus web components](https://github.com/zooplus/zoo-web-components) ⭐ 50 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-08 - Set of web components that implement Z+ shop style guide.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,051 | 🐛 175 | 🌐 TypeScript | 📅 2026-04-08 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,640 | 🐛 91 | 🌐 TypeScript | 📅 2026-04-09 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,761 | 🐛 419 | 🌐 JavaScript | 📅 2026-04-08 - blazing fast, enterprise-grade Web Components foundation.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,373 | 🐛 115 | 🌐 TypeScript | 📅 2026-04-06 - Library that extends Solid adding Custom Web Components and extensions.
...
* [hello-web-components](https://github.com/fernandopasik/hello-web-components) ⭐ 31 | 🐛 5 | 🌐 TypeScript | 📅 2026-04-08 - Simple starter hello world web component written in TypeScript.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 37 | 🌐 JavaScript | 📅 2026-04-08 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,871 | 🐛 2,762 | 🌐 HTML | 📅 2026-04-09

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,871 | 🐛 2,762 | 🌐 HTML | 📅 2026-04-09
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,761 | 🐛 419 | 🌐 JavaScript | 📅 2026-04-08 - Shadow DOM polyfill by [LWC](https://lwc.dev).
