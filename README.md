...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,833 | 🐛 2,735 | 🌐 HTML | 📅 2026-03-18
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,833 | 🐛 2,735 | 🌐 HTML | 📅 2026-03-18
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,833 | 🐛 2,735 | 🌐 HTML | 📅 2026-03-18
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,833 | 🐛 2,735 | 🌐 HTML | 📅 2026-03-18
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,556 | 🐛 27 | 🌐 TypeScript | 📅 2026-03-17 - Web component for chat with AI capabilities.
...
* [`<emoji-picker>`](https://github.com/nolanlawson/emoji-picker-element) ⭐ 1,725 | 🐛 33 | 🌐 JavaScript | 📅 2026-03-05 - Lightweight emoji picker, distributed as a web component.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,446 | 🐛 22 | 🌐 JavaScript | 📅 2026-03-18 quickly into your page using custom elements.
...
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 122 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-14 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [Shoelace](https://github.com/shoelace-style/shoelace) ⭐ 13,874 | 🐛 105 | 🌐 TypeScript | 📅 2026-03-05 - A forward-thinking library of web components.
...
* [LDRS](https://github.com/GriffinJohnston/ldrs) ⭐ 2,158 | 🐛 1 | 🌐 TypeScript | 📅 2025-10-22 - Lightweight, customizable loading animations/spinners.
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,935 | 🐛 170 | 🌐 JavaScript | 📅 2026-03-17 - Set of highly performant, accessible and flexible Web Components.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 556 | 🐛 943 | 🌐 JavaScript | 📅 2026-03-17 - Evolving set of high-quality web components for building business web applications.
...
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 324 | 🌐 JavaScript | 📅 2026-03-17 - Collection of Web Components made by Clever Cloud.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 102 | 🐛 2 | 🌐 JavaScript | 📅 2026-03-17 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 39 | 🌐 JavaScript | 📅 2026-03-17 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 27 | 🐛 25 | 🌐 JavaScript | 📅 2026-03-16 - Components for building web applications with Nuxeo using Web Components.
* [Titanium Elements](https://github.com/LeavittSoftware/titanium-elements) ⭐ 19 | 🐛 4 | 🌐 TypeScript | 📅 2026-03-17 - Collection of lightweight web components used by Leavitt Group Enterprises.
...
* [Furo Webcomponents](https://github.com/eclipse/eclipsefuro-web) ⭐ 12 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-17 - Enterprise ready set of web components which work best with Eclipse Furo.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,878 | 🐛 666 | 🌐 TypeScript | 📅 2026-03-17 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,808 | 🐛 161 | 🌐 SCSS | 📅 2026-03-14 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,640 | 🐛 80 | 🌐 TypeScript | 📅 2026-03-17 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,727 | 🐛 283 | 🌐 TypeScript | 📅 2026-03-18 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,493 | 🐛 221 | 🌐 TypeScript | 📅 2026-03-17 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 348 | 🐛 879 | 🌐 TypeScript | 📅 2026-03-18 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 329 | 🐛 94 | 🌐 TypeScript | 📅 2026-03-17 - Web Components implementing Siemens iX design system.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 132 | 🐛 225 | 🌐 HTML | 📅 2026-03-17 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 130 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 128 | 🐛 76 | 🌐 TypeScript | 📅 2026-03-18 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 65 | 🐛 40 | 🌐 TypeScript | 📅 2026-03-17 - Library of Web Components adhering to the Forge Design System.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 62 | 🐛 74 | 🌐 TypeScript | 📅 2026-03-17 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,045 | 🐛 171 | 🌐 TypeScript | 📅 2026-03-17 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,640 | 🐛 80 | 🌐 TypeScript | 📅 2026-03-17 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,758 | 🐛 417 | 🌐 JavaScript | 📅 2026-03-18 - blazing fast, enterprise-grade Web Components foundation.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,335 | 🐛 129 | 🌐 TypeScript | 📅 2026-03-17 - Library that extends Solid adding Custom Web Components and extensions.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,833 | 🐛 2,735 | 🌐 HTML | 📅 2026-03-18

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,833 | 🐛 2,735 | 🌐 HTML | 📅 2026-03-18
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,758 | 🐛 417 | 🌐 JavaScript | 📅 2026-03-18 - Shadow DOM polyfill by [LWC](https://lwc.dev).
