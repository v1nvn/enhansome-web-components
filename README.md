...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,775 | 🐛 2,738 | 🌐 HTML | 📅 2026-02-20
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,775 | 🐛 2,738 | 🌐 HTML | 📅 2026-02-20
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,775 | 🐛 2,738 | 🌐 HTML | 📅 2026-02-20
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,775 | 🐛 2,738 | 🌐 HTML | 📅 2026-02-20
...
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 7,911 | 🐛 118 | 🌐 TypeScript | 📅 2026-02-19 - Web component for rendering interactive 3D models.
* [`<lite-youtube>`](https://github.com/paulirish/lite-youtube-embed) ⭐ 6,287 | 🐛 27 | 🌐 HTML | 📅 2025-11-10 - Lite YouTube embed with a focus on visual performance.
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 5,962 | 🐛 7 | 🌐 JavaScript | 📅 2026-01-22 - Web component for drawing patterns with CSS.
...
* [`<range-slider>`](https://github.com/andreruffert/range-slider-element) ⭐ 88 | 🐛 7 | 🌐 JavaScript | 📅 2026-02-16 - Accessible range slider custom element with keyboard support.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,918 | 🐛 1,011 | 🌐 JavaScript | 📅 2026-01-17 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
* [Shoelace](https://github.com/shoelace-style/shoelace) ⭐ 13,857 | 🐛 103 | 🌐 TypeScript | 📅 2026-02-19 - A forward-thinking library of web components.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 773 | 🐛 4 | 🌐 TypeScript | 📅 2026-02-16 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 554 | 🐛 935 | 🌐 JavaScript | 📅 2026-02-19 - Evolving set of high-quality web components for building business web applications.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 269 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-19 - ELMS:LN produced web components for any project.
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 238 | 🐛 324 | 🌐 JavaScript | 📅 2026-02-19 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 168 | 🐛 61 | 🌐 TypeScript | 📅 2026-02-19 - Complete library of UI components from Infragistics.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 98 | 🐛 2 | 🌐 JavaScript | 📅 2026-02-19 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 77 | 🐛 37 | 🌐 JavaScript | 📅 2026-02-19 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 27 | 🐛 31 | 🌐 JavaScript | 📅 2026-02-19 - Components for building web applications with Nuxeo using Web Components.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 23 | 🌐 TypeScript | 📅 2026-02-19 - Ser of web components used by Equinor Fusion.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 11 | 🐛 6 | 🌐 JavaScript | 📅 2026-02-19 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,853 | 🐛 650 | 🌐 TypeScript | 📅 2026-02-19 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,755 | 🐛 164 | 🌐 SCSS | 📅 2026-02-14 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,619 | 🐛 81 | 🌐 TypeScript | 📅 2026-02-20 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,721 | 🐛 292 | 🌐 TypeScript | 📅 2026-02-20 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,488 | 🐛 225 | 🌐 TypeScript | 📅 2026-02-20 - Adobe Spectrum design language implementation built with Web Components.
...
* [PatternFly Elements](https://github.com/patternfly/patternfly-elements) ⭐ 388 | 🐛 207 | 🌐 TypeScript | 📅 2026-02-10 - Collection of flexible and lightweight Web Components based on the Unified Design Kit.
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 346 | 🐛 856 | 🌐 TypeScript | 📅 2026-02-20 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 322 | 🐛 94 | 🌐 TypeScript | 📅 2026-02-19 - Web Components implementing Siemens iX design system.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 212 | 🐛 62 | 🌐 SCSS | 📅 2026-02-12 - Set of UI components based on Momentum Design.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 58 | 🐛 72 | 🌐 TypeScript | 📅 2026-02-19 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,034 | 🐛 164 | 🌐 TypeScript | 📅 2026-02-19 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,619 | 🐛 81 | 🌐 TypeScript | 📅 2026-02-20 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,202 | 🐛 131 | 🌐 TypeScript | 📅 2026-02-19 - Library that extends Solid adding Custom Web Components and extensions.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,918 | 🐛 1,011 | 🌐 JavaScript | 📅 2026-01-17 - Web component framework to easily create user-first experiences for the web.
* [WebC](https://github.com/11ty/webc) ⭐ 1,408 | 🐛 64 | 🌐 JavaScript | 📅 2025-12-02 - Framework-independent standalone HTML serializer for generating markup for web components.
...
* [hello-web-components](https://github.com/fernandopasik/hello-web-components) ⭐ 31 | 🐛 6 | 🌐 TypeScript | 📅 2026-02-19 - Simple starter hello world web component written in TypeScript.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 36 | 🌐 JavaScript | 📅 2026-02-19 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,775 | 🐛 2,738 | 🌐 HTML | 📅 2026-02-20

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,775 | 🐛 2,738 | 🌐 HTML | 📅 2026-02-20
...
* [`ElementInternals`'s `states` property and the `:state()` pseudo class](https://github.com/w3c/webcomponents/blob/gh-pages/proposals/custom-states-and-state-pseudo-class.md) ⭐ 4,478 | 🐛 203 | 🌐 HTML | 📅 2025-12-09
