...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,900 | 🐛 2,784 | 🌐 HTML | 📅 2026-04-24
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,900 | 🐛 2,784 | 🌐 HTML | 📅 2026-04-24
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,900 | 🐛 2,784 | 🌐 HTML | 📅 2026-04-24
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,900 | 🐛 2,784 | 🌐 HTML | 📅 2026-04-24
...
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,022 | 🐛 112 | 🌐 TypeScript | 📅 2026-04-17 - Web component for rendering interactive 3D models.
...
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 5,985 | 🐛 8 | 🌐 JavaScript | 📅 2026-04-19 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,589 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-22 - Web component for chat with AI capabilities.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,482 | 🐛 20 | 🌐 JavaScript | 📅 2026-04-23 quickly into your page using custom elements.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,938 | 🐛 175 | 🌐 JavaScript | 📅 2026-04-23 - Set of highly performant, accessible and flexible Web Components.
* [Blaze UI Atoms](https://github.com/BlazeSoftware/atoms) ⭐ 1,554 | 🐛 4 | 🌐 TypeScript | 📅 2023-06-20 - Set of web components powered by Blaze CSS.
...
* [Microsoft Graph Toolkit](https://github.com/microsoftgraph/microsoft-graph-toolkit) ⭐ 1,053 | 🐛 186 | 🌐 TypeScript | 📅 2026-02-28 - Collection of web components for the Microsoft Graph.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 799 | 🐛 2 | 🌐 TypeScript | 📅 2026-04-10 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 562 | 🐛 946 | 🌐 JavaScript | 📅 2026-04-23 - Evolving set of high-quality web components for building business web applications.
* [Smart Web Components](https://github.com/HTMLElements/smart-webcomponents) ⭐ 473 | 🐛 6 | 🌐 CSS | 📅 2026-02-03 - Web components for business applications.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 271 | 🐛 1 | 🌐 JavaScript | 📅 2026-04-23 - ELMS:LN produced web components for any project.
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 241 | 🐛 328 | 🌐 JavaScript | 📅 2026-04-23 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 166 | 🐛 68 | 🌐 TypeScript | 📅 2026-04-22 - Complete library of UI components from Infragistics.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 103 | 🐛 7 | 🌐 JavaScript | 📅 2026-04-23 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 57 | 🌐 JavaScript | 📅 2026-04-23 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 18 | 🌐 JavaScript | 📅 2026-04-24 - Components for building web applications with Nuxeo using Web Components.
...
* [Titanium Elements](https://github.com/LeavittSoftware/titanium-elements) ⭐ 19 | 🐛 3 | 🌐 TypeScript | 📅 2026-04-23 - Collection of lightweight web components used by Leavitt Group Enterprises.
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 47 | 🌐 JavaScript | 📅 2026-04-23 - Collection of web components used by TEI Publisher and apps generated by it.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 15 | 🌐 TypeScript | 📅 2026-04-23 - Ser of web components used by Equinor Fusion.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,947 | 🐛 676 | 🌐 TypeScript | 📅 2026-04-23 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,895 | 🐛 164 | 🌐 SCSS | 📅 2026-04-22 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,644 | 🐛 74 | 🌐 TypeScript | 📅 2026-04-24 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,736 | 🐛 274 | 🌐 TypeScript | 📅 2026-04-24 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,506 | 🐛 236 | 🌐 TypeScript | 📅 2026-04-24 - Adobe Spectrum design language implementation built with Web Components.
...
* [PatternFly Elements](https://github.com/patternfly/patternfly-elements) ⭐ 390 | 🐛 196 | 🌐 TypeScript | 📅 2026-04-24 - Collection of flexible and lightweight Web Components based on the Unified Design Kit.
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 353 | 🐛 895 | 🌐 TypeScript | 📅 2026-04-24 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 338 | 🐛 81 | 🌐 TypeScript | 📅 2026-04-24 - Web Components implementing Siemens iX design system.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 212 | 🐛 63 | 🌐 SCSS | 📅 2026-04-23 - Set of UI components based on Momentum Design.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 134 | 🐛 162 | 🌐 HTML | 📅 2026-04-23 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 130 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 129 | 🐛 79 | 🌐 TypeScript | 📅 2026-04-23 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 67 | 🐛 40 | 🌐 TypeScript | 📅 2026-04-23 - Library of Web Components adhering to the Forge Design System.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 76 | 🌐 TypeScript | 📅 2026-04-23 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Omi](https://github.com/Tencent/omi) ⭐ 13,263 | 🐛 70 | 🌐 TypeScript | 📅 2026-03-27 - Next generation web framework in 4kb JavaScript (Web Components + JSX + Proxy + Store + Path Updating).
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,077 | 🐛 177 | 🌐 TypeScript | 📅 2026-04-23 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,644 | 🐛 74 | 🌐 TypeScript | 📅 2026-04-24 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,763 | 🐛 421 | 🌐 JavaScript | 📅 2026-04-23 - blazing fast, enterprise-grade Web Components foundation.
...
* [Lume Element](https://github.com/lume/element) ⭐ 186 | 🐛 30 | 🌐 TypeScript | 📅 2026-04-10 - Write custom elements with reactivity and templating powered by Solid.js signals and effects.
...
* [DNA](https://github.com/chialab/dna) ⭐ 60 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-23 - Progressive Web Components library.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,446 | 🐛 81 | 🌐 TypeScript | 📅 2026-04-23 - Library that extends Solid adding Custom Web Components and extensions.
...
* [Web Components Compiler](https://github.com/ProjectEvergreen/wcc) ⭐ 122 | 🐛 26 | 🌐 JavaScript | 📅 2026-04-23 - Compiler to make server-side rendering of native web components easier.
...
* [cypress-lit](https://github.com/simonireilly/cypress-lit) ⭐ 25 | 🐛 13 | 🌐 TypeScript | 📅 2026-04-23 - Test your Lit elements and native web components in Cypress with all the modern browsers.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,900 | 🐛 2,784 | 🌐 HTML | 📅 2026-04-24

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,900 | 🐛 2,784 | 🌐 HTML | 📅 2026-04-24
...
* [`ElementInternals`'s `states` property and the `:state()` pseudo class](https://github.com/w3c/webcomponents/blob/gh-pages/proposals/custom-states-and-state-pseudo-class.md) ⭐ 4,488 | 🐛 203 | 🌐 HTML | 📅 2025-12-09
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,763 | 🐛 421 | 🌐 JavaScript | 📅 2026-04-23 - Shadow DOM polyfill by [LWC](https://lwc.dev).
