...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,896 | 🐛 2,797 | 🌐 HTML | 📅 2026-04-23
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,896 | 🐛 2,797 | 🌐 HTML | 📅 2026-04-23
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,896 | 🐛 2,797 | 🌐 HTML | 📅 2026-04-23
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,896 | 🐛 2,797 | 🌐 HTML | 📅 2026-04-23
...
* [`<lite-youtube>`](https://github.com/paulirish/lite-youtube-embed) ⭐ 6,308 | 🐛 29 | 🌐 HTML | 📅 2025-11-10 - Lite YouTube embed with a focus on visual performance.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,591 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-22 - Web component for chat with AI capabilities.
* [`<vime-player>`](https://github.com/vime-js/vime) ⭐ 2,837 | 🐛 171 | 🌐 TypeScript | 📅 2024-11-17 - Customizable, extensible, accessible and framework agnostic media player.
...
* [`<midi-player>`](https://github.com/cifkao/html-midi-player) ⭐ 870 | 🐛 21 | 🌐 TypeScript | 📅 2025-07-06 - MIDI file player and visualizer web components.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,479 | 🐛 19 | 🌐 JavaScript | 📅 2026-04-21 quickly into your page using custom elements.
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 137 | 🐛 4 | 🌐 TypeScript | 📅 2026-04-21 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,911 | 🐛 1,007 | 🌐 JavaScript | 📅 2026-04-15 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 800 | 🐛 2 | 🌐 TypeScript | 📅 2026-04-10 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 562 | 🐛 948 | 🌐 JavaScript | 📅 2026-04-22 - Evolving set of high-quality web components for building business web applications.
...
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 329 | 🌐 JavaScript | 📅 2026-04-22 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 166 | 🐛 67 | 🌐 TypeScript | 📅 2026-04-22 - Complete library of UI components from Infragistics.
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 148 | 🐛 53 | 🌐 TypeScript | 📅 2026-04-20 - Collection of user interface web components for Umbraco CMS.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 103 | 🐛 7 | 🌐 JavaScript | 📅 2026-04-22 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 55 | 🌐 JavaScript | 📅 2026-04-22 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 18 | 🌐 JavaScript | 📅 2026-04-23 - Components for building web applications with Nuxeo using Web Components.
...
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 46 | 🌐 JavaScript | 📅 2026-04-22 - Collection of web components used by TEI Publisher and apps generated by it.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 14 | 🌐 TypeScript | 📅 2026-04-22 - Ser of web components used by Equinor Fusion.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 12 | 🐛 9 | 🌐 JavaScript | 📅 2026-04-23 - Web components library for Sme.UP.
...
* [Burnish Components](https://github.com/danfking/burnish/tree/main/packages/components) ⭐ 2 | 🐛 6 | 🌐 TypeScript | 📅 2026-04-22 - Web components for rendering MCP tool-call output as UI.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,945 | 🐛 678 | 🌐 TypeScript | 📅 2026-04-23 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,888 | 🐛 164 | 🌐 SCSS | 📅 2026-04-22 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,643 | 🐛 78 | 🌐 TypeScript | 📅 2026-04-23 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,736 | 🐛 280 | 🌐 TypeScript | 📅 2026-04-23 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,504 | 🐛 233 | 🌐 TypeScript | 📅 2026-04-22 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 353 | 🐛 898 | 🌐 TypeScript | 📅 2026-04-23 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 338 | 🐛 83 | 🌐 TypeScript | 📅 2026-04-22 - Web Components implementing Siemens iX design system.
* [Crayons](https://github.com/freshdesk/crayons) ⭐ 243 | 🐛 45 | 🌐 JavaScript | 📅 2026-04-06 - Collection of web components that adheres to the Freshworks Design System.
...
* [Astro Space UX Design System](https://github.com/RocketCommunicationsInc/astro) ⭐ 150 | 🐛 57 | 🌐 TypeScript | 📅 2026-04-23 - Set of components to build rich space app experiences with established interaction patterns.
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 134 | 🐛 165 | 🌐 HTML | 📅 2026-04-22 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 130 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 129 | 🐛 78 | 🌐 TypeScript | 📅 2026-04-23 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 85 | 🌐 TypeScript | 📅 2026-04-22 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,074 | 🐛 177 | 🌐 TypeScript | 📅 2026-04-22 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,643 | 🐛 78 | 🌐 TypeScript | 📅 2026-04-23 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 134 | 🐛 7 | 🌐 TypeScript | 📅 2026-04-22 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,440 | 🐛 80 | 🌐 TypeScript | 📅 2026-04-23 - Library that extends Solid adding Custom Web Components and extensions.
...
* [atomico](https://github.com/atomicojs/atomico) ⭐ 1,268 | 🐛 17 | 🌐 TypeScript | 📅 2026-04-20 - Small library for the creation of interfaces based on web components using functions and hooks.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,911 | 🐛 1,007 | 🌐 JavaScript | 📅 2026-04-15 - Web component framework to easily create user-first experiences for the web.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,896 | 🐛 2,797 | 🌐 HTML | 📅 2026-04-23

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,896 | 🐛 2,797 | 🌐 HTML | 📅 2026-04-23
