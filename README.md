...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,940 | 🐛 2,762 | 🌐 HTML | 📅 2026-06-03
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,940 | 🐛 2,762 | 🌐 HTML | 📅 2026-06-03
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,940 | 🐛 2,762 | 🌐 HTML | 📅 2026-06-03
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,940 | 🐛 2,762 | 🌐 HTML | 📅 2026-06-03
...
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,104 | 🐛 115 | 🌐 TypeScript | 📅 2026-06-01 - Web component for rendering interactive 3D models.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,626 | 🐛 34 | 🌐 TypeScript | 📅 2026-06-01 - Web component for chat with AI capabilities.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,520 | 🐛 18 | 🌐 JavaScript | 📅 2026-06-01 quickly into your page using custom elements.
...
* [Wired Elements](https://github.com/wiredjs/wired-elements) ⭐ 10,789 | 🐛 36 | 🌐 TypeScript | 📅 2023-10-07 - Set of common UI elements with a hand-drawn, sketchy look.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,947 | 🐛 186 | 🌐 JavaScript | 📅 2026-06-02 - Set of highly performant, accessible and flexible Web Components.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 565 | 🐛 946 | 🌐 JavaScript | 📅 2026-06-03 - Evolving set of high-quality web components for building business web applications.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 273 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-02 - ELMS:LN produced web components for any project.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 167 | 🐛 59 | 🌐 TypeScript | 📅 2026-06-02 - Complete library of UI components from Infragistics.
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 148 | 🐛 51 | 🌐 TypeScript | 📅 2026-06-02 - Collection of user interface web components for Umbraco CMS.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 105 | 🐛 4 | 🌐 JavaScript | 📅 2026-06-02 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 42 | 🌐 JavaScript | 📅 2026-06-02 - Collection of web components for building Brightspace applications.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,037 | 🐛 736 | 🌐 TypeScript | 📅 2026-06-03 - Library of Web Components that supports Microsoft's Fluent design language.
...
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,749 | 🐛 247 | 🌐 TypeScript | 📅 2026-06-03 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,515 | 🐛 255 | 🌐 TypeScript | 📅 2026-06-03 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 365 | 🐛 905 | 🌐 TypeScript | 📅 2026-06-03 - Shared Web Components for Esri's Calcite design framework.
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 347 | 🐛 82 | 🌐 TypeScript | 📅 2026-06-03 - Web Components implementing Siemens iX design system.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 139 | 🐛 194 | 🌐 HTML | 📅 2026-06-02 - Web components for building uniform experiences with the Red Hat brand.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 63 | 🌐 TypeScript | 📅 2026-06-03 - Building blocks of the Lyne Design System are based on Web Components.
* [NVIDIA Elements](https://github.com/nvidia/elements) ⭐ 12 | 🐛 2 | 🌐 TypeScript | 📅 2026-06-02 - The Design Language and UI Agent Harness for AI/ML Factories, Robotics, and Autonomous Vehicles.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,094 | 🐛 186 | 🌐 TypeScript | 📅 2026-06-03 - Compiler for generating Web Components.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,569 | 🐛 39 | 🌐 TypeScript | 📅 2026-06-01 - Library that extends Solid adding Custom Web Components and extensions.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,940 | 🐛 2,762 | 🌐 HTML | 📅 2026-06-03

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,940 | 🐛 2,762 | 🌐 HTML | 📅 2026-06-03
