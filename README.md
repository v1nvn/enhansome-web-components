...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,919 | 🐛 2,773 | 🌐 HTML | 📅 2026-05-08
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,919 | 🐛 2,773 | 🌐 HTML | 📅 2026-05-08
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,919 | 🐛 2,773 | 🌐 HTML | 📅 2026-05-08
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,919 | 🐛 2,773 | 🌐 HTML | 📅 2026-05-08
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,936 | 🐛 184 | 🌐 JavaScript | 📅 2026-05-07 - Rich text editor custom element for everyday writing.
...
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 6,004 | 🐛 8 | 🌐 JavaScript | 📅 2026-04-19 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,601 | 🐛 33 | 🌐 TypeScript | 📅 2026-04-22 - Web component for chat with AI capabilities.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,493 | 🐛 20 | 🌐 JavaScript | 📅 2026-05-07 quickly into your page using custom elements.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,941 | 🐛 181 | 🌐 JavaScript | 📅 2026-05-08 - Set of highly performant, accessible and flexible Web Components.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 562 | 🐛 943 | 🌐 JavaScript | 📅 2026-05-07 - Evolving set of high-quality web components for building business web applications.
...
* [Apollo Elements](https://github.com/apollo-elements/apollo-elements) ⭐ 422 | 🐛 8 | 🌐 TypeScript | 📅 2026-05-08 - Custom elements for using Apollo GraphQL with various web components libraries.
...
* [Wokwi Elements](https://github.com/wokwi/wokwi-elements) ⭐ 243 | 🐛 24 | 🌐 TypeScript | 📅 2026-04-07 - Web Components for Arduino and various electronic parts.
...
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 148 | 🐛 54 | 🌐 TypeScript | 📅 2026-05-07 - Collection of user interface web components for Umbraco CMS.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 103 | 🐛 4 | 🌐 JavaScript | 📅 2026-05-07 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 63 | 🌐 JavaScript | 📅 2026-05-07 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 33 | 🌐 JavaScript | 📅 2026-05-07 - Components for building web applications with Nuxeo using Web Components.
...
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 52 | 🌐 JavaScript | 📅 2026-05-07 - Collection of web components used by TEI Publisher and apps generated by it.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 34 | 🌐 TypeScript | 📅 2026-05-07 - Ser of web components used by Equinor Fusion.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,964 | 🐛 681 | 🌐 TypeScript | 📅 2026-05-07 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,925 | 🐛 165 | 🌐 SCSS | 📅 2026-05-07 - Material Design implemented as Web Components.
...
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,738 | 🐛 272 | 🌐 TypeScript | 📅 2026-05-08 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,508 | 🐛 250 | 🌐 TypeScript | 📅 2026-05-07 - Adobe Spectrum design language implementation built with Web Components.
...
* [PatternFly Elements](https://github.com/patternfly/patternfly-elements) ⭐ 391 | 🐛 158 | 🌐 TypeScript | 📅 2026-05-07 - Collection of flexible and lightweight Web Components based on the Unified Design Kit.
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 360 | 🐛 899 | 🌐 TypeScript | 📅 2026-05-08 - Shared Web Components for Esri's Calcite design framework.
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 341 | 🐛 77 | 🌐 TypeScript | 📅 2026-05-07 - Web Components implementing Siemens iX design system.
...
* [Astro Space UX Design System](https://github.com/RocketCommunicationsInc/astro) ⭐ 150 | 🐛 60 | 🌐 TypeScript | 📅 2026-05-08 - Set of components to build rich space app experiences with established interaction patterns.
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 136 | 🐛 190 | 🌐 HTML | 📅 2026-05-07 - Web components for building uniform experiences with the Red Hat brand.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 68 | 🐛 45 | 🌐 TypeScript | 📅 2026-05-07 - Library of Web Components adhering to the Forge Design System.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 60 | 🌐 TypeScript | 📅 2026-05-08 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,084 | 🐛 180 | 🌐 TypeScript | 📅 2026-05-07 - Compiler for generating Web Components.
...
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,764 | 🐛 412 | 🌐 JavaScript | 📅 2026-05-07 - blazing fast, enterprise-grade Web Components foundation.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,493 | 🐛 61 | 🌐 TypeScript | 📅 2026-05-07 - Library that extends Solid adding Custom Web Components and extensions.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,919 | 🐛 2,773 | 🌐 HTML | 📅 2026-05-08

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,919 | 🐛 2,773 | 🌐 HTML | 📅 2026-05-08
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,764 | 🐛 412 | 🌐 JavaScript | 📅 2026-05-07 - Shadow DOM polyfill by [LWC](https://lwc.dev).
