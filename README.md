...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,775 | 🐛 2,697 | 🌐 HTML | 📅 2026-02-15
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,775 | 🐛 2,697 | 🌐 HTML | 📅 2026-02-15
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,775 | 🐛 2,697 | 🌐 HTML | 📅 2026-02-15
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,775 | 🐛 2,697 | 🌐 HTML | 📅 2026-02-15
...
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 5,952 | 🐛 7 | 🌐 JavaScript | 📅 2026-01-22 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,529 | 🐛 21 | 🌐 TypeScript | 📅 2026-02-05 - Web component for chat with AI capabilities.
...
* [`<emoji-picker>`](https://github.com/nolanlawson/emoji-picker-element) ⭐ 1,716 | 🐛 35 | 🌐 JavaScript | 📅 2026-02-14 - Lightweight emoji picker, distributed as a web component.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,414 | 🐛 18 | 🌐 JavaScript | 📅 2026-02-14 quickly into your page using custom elements.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,915 | 🐛 1,010 | 🌐 JavaScript | 📅 2026-01-17 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,930 | 🐛 163 | 🌐 JavaScript | 📅 2026-02-14 - Set of highly performant, accessible and flexible Web Components.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 772 | 🐛 4 | 🌐 TypeScript | 📅 2026-02-06 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 553 | 🐛 943 | 🌐 JavaScript | 📅 2026-02-14 - Evolving set of high-quality web components for building business web applications.
...
* [Apollo Elements](https://github.com/apollo-elements/apollo-elements) ⭐ 423 | 🐛 1 | 🌐 TypeScript | 📅 2026-02-14 - Custom elements for using Apollo GraphQL with various web components libraries.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 168 | 🐛 66 | 🌐 TypeScript | 📅 2026-02-14 - Complete library of UI components from Infragistics.
...
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 46 | 🌐 TypeScript | 📅 2026-02-14 - A schema for mutation testing results with the web components to visualize it.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 11 | 🐛 6 | 🌐 JavaScript | 📅 2026-02-14 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,848 | 🐛 646 | 🌐 TypeScript | 📅 2026-02-12 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,747 | 🐛 164 | 🌐 SCSS | 📅 2026-02-14 - Material Design implemented as Web Components.
...
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,721 | 🐛 281 | 🌐 TypeScript | 📅 2026-02-15 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,487 | 🐛 222 | 🌐 TypeScript | 📅 2026-02-14 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 346 | 🐛 847 | 🌐 TypeScript | 📅 2026-02-14 - Shared Web Components for Esri's Calcite design framework.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 59 | 🐛 71 | 🌐 TypeScript | 📅 2026-02-15 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,025 | 🐛 163 | 🌐 TypeScript | 📅 2026-02-13 - Compiler for generating Web Components.
...
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,753 | 🐛 417 | 🌐 JavaScript | 📅 2026-02-14 - blazing fast, enterprise-grade Web Components foundation.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,112 | 🐛 131 | 🌐 TypeScript | 📅 2026-02-14 - Library that extends Solid adding Custom Web Components and extensions.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,915 | 🐛 1,010 | 🌐 JavaScript | 📅 2026-01-17 - Web component framework to easily create user-first experiences for the web.
* [WebC](https://github.com/11ty/webc) ⭐ 1,407 | 🐛 61 | 🌐 JavaScript | 📅 2025-12-02 - Framework-independent standalone HTML serializer for generating markup for web components.
* [Web Components Compiler](https://github.com/ProjectEvergreen/wcc) ⭐ 120 | 🐛 21 | 🌐 JavaScript | 📅 2026-02-14 - Compiler to make server-side rendering of native web components easier.
...
* [hello-web-components](https://github.com/fernandopasik/hello-web-components) ⭐ 31 | 🐛 6 | 🌐 TypeScript | 📅 2026-02-14 - Simple starter hello world web component written in TypeScript.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,775 | 🐛 2,697 | 🌐 HTML | 📅 2026-02-15

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,775 | 🐛 2,697 | 🌐 HTML | 📅 2026-02-15
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,753 | 🐛 417 | 🌐 JavaScript | 📅 2026-02-14 - Shadow DOM polyfill by [LWC](https://lwc.dev).
