...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,768 | 🐛 2,704 | 🌐 HTML | 📅 2026-02-08
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,768 | 🐛 2,704 | 🌐 HTML | 📅 2026-02-08
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,768 | 🐛 2,704 | 🌐 HTML | 📅 2026-02-08
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,768 | 🐛 2,704 | 🌐 HTML | 📅 2026-02-08
...
* [web-components-examples](https://github.com/mdn/web-components-examples) ⭐ 3,355 | 🐛 4 | 🌐 JavaScript | 📅 2026-01-13 - Series of web components examples, related to the MDN web components documentation.
...
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 7,890 | 🐛 115 | 🌐 TypeScript | 📅 2026-02-03 - Web component for rendering interactive 3D models.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,518 | 🐛 21 | 🌐 TypeScript | 📅 2026-02-05 - Web component for chat with AI capabilities.
...
* [`<rapi-doc>`](https://github.com/mrin9/RapiDoc) ⭐ 1,880 | 🐛 130 | 🌐 JavaScript | 📅 2026-02-07 - Web component for creating documentation from OpenAPI Specification.
* [`<emoji-picker>`](https://github.com/nolanlawson/emoji-picker-element) ⭐ 1,715 | 🐛 36 | 🌐 JavaScript | 📅 2026-01-21 - Lightweight emoji picker, distributed as a web component.
...
* [`<midi-player>`](https://github.com/cifkao/html-midi-player) ⭐ 850 | 🐛 19 | 🌐 TypeScript | 📅 2025-07-06 - MIDI file player and visualizer web components.
...
* [Shoelace](https://github.com/shoelace-style/shoelace) ⭐ 13,846 | 🐛 102 | 🌐 TypeScript | 📅 2025-10-29 - A forward-thinking library of web components.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,929 | 🐛 159 | 🌐 JavaScript | 📅 2026-02-07 - Set of highly performant, accessible and flexible Web Components.
...
* [Microsoft Graph Toolkit](https://github.com/microsoftgraph/microsoft-graph-toolkit) ⭐ 1,041 | 🐛 186 | 🌐 TypeScript | 📅 2026-02-07 - Collection of web components for the Microsoft Graph.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 98 | 🐛 2 | 🌐 JavaScript | 📅 2026-02-07 - General use Web Components for websites and applications.
...
* [One Platform Components](https://github.com/1-Platform/op-components) ⭐ 31 | 🐛 17 | 🌐 TypeScript | 📅 2026-02-07 - Set of web components for Red Hat One Platform.
* [elements-sk](https://github.com/google/elements-sk) ⚠️ Archived - Collection of custom elements for "a la carte" web development.
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 46 | 🌐 TypeScript | 📅 2026-02-07 - A schema for mutation testing results with the web components to visualize it.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,841 | 🐛 651 | 🌐 TypeScript | 📅 2026-02-07 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,724 | 🐛 162 | 🌐 SCSS | 📅 2026-02-02 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,612 | 🐛 87 | 🌐 TypeScript | 📅 2026-02-07 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,719 | 🐛 280 | 🌐 TypeScript | 📅 2026-02-08 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 346 | 🐛 845 | 🌐 TypeScript | 📅 2026-02-08 - Shared Web Components for Esri's Calcite design framework.
...
* [Astro Space UX Design System](https://github.com/RocketCommunicationsInc/astro) ⭐ 149 | 🐛 33 | 🌐 TypeScript | 📅 2026-02-07 - Set of components to build rich space app experiences with established interaction patterns.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 59 | 🐛 71 | 🌐 TypeScript | 📅 2026-02-08 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,019 | 🐛 163 | 🌐 TypeScript | 📅 2026-02-07 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,612 | 🐛 87 | 🌐 TypeScript | 📅 2026-02-07 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,752 | 🐛 416 | 🌐 JavaScript | 📅 2026-02-06 - blazing fast, enterprise-grade Web Components foundation.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 135 | 🐛 7 | 🌐 TypeScript | 📅 2026-02-08 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,065 | 🐛 129 | 🌐 TypeScript | 📅 2026-01-26 - Library that extends Solid adding Custom Web Components and extensions.
...
* [nuxt-custom-elements](https://github.com/GrabarzUndPartner/nuxt-custom-elements) ⭐ 83 | 🐛 18 | 🌐 JavaScript | 📅 2026-02-08 - Export your project components as custom elements for integration into external pages.
...
* [Web Components Compiler](https://github.com/ProjectEvergreen/wcc) ⭐ 120 | 🐛 20 | 🌐 JavaScript | 📅 2026-02-08 - Compiler to make server-side rendering of native web components easier.
...
* [shadow-automation-selenium](https://github.com/sukgu/shadow-automation-selenium) ⭐ 116 | 🐛 9 | 🌐 Java | 📅 2026-02-07 - Shadow DOM automation using Selenium.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,768 | 🐛 2,704 | 🌐 HTML | 📅 2026-02-08

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,768 | 🐛 2,704 | 🌐 HTML | 📅 2026-02-08
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,752 | 🐛 416 | 🌐 JavaScript | 📅 2026-02-06 - Shadow DOM polyfill by [LWC](https://lwc.dev).
