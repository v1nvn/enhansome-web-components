...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,767 | 🐛 2,703 | 🌐 HTML | 📅 2026-02-07
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,767 | 🐛 2,703 | 🌐 HTML | 📅 2026-02-07
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,767 | 🐛 2,703 | 🌐 HTML | 📅 2026-02-07
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,767 | 🐛 2,703 | 🌐 HTML | 📅 2026-02-07
...
* [web-components-examples](https://github.com/mdn/web-components-examples) ⭐ 3,354 | 🐛 4 | 🌐 JavaScript | 📅 2026-01-13 - Series of web components examples, related to the MDN web components documentation.
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,902 | 🐛 173 | 🌐 JavaScript | 📅 2026-01-09 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 7,889 | 🐛 115 | 🌐 TypeScript | 📅 2026-02-03 - Web component for rendering interactive 3D models.
* [`<lite-youtube>`](https://github.com/paulirish/lite-youtube-embed) ⭐ 6,282 | 🐛 25 | 🌐 HTML | 📅 2025-11-10 - Lite YouTube embed with a focus on visual performance.
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 5,886 | 🐛 7 | 🌐 JavaScript | 📅 2026-01-22 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,517 | 🐛 21 | 🌐 TypeScript | 📅 2026-02-05 - Web component for chat with AI capabilities.
...
* [`<rapi-doc>`](https://github.com/mrin9/RapiDoc) ⭐ 1,880 | 🐛 129 | 🌐 JavaScript | 📅 2026-01-21 - Web component for creating documentation from OpenAPI Specification.
* [`<emoji-picker>`](https://github.com/nolanlawson/emoji-picker-element) ⭐ 1,715 | 🐛 35 | 🌐 JavaScript | 📅 2026-01-21 - Lightweight emoji picker, distributed as a web component.
...
* [`<dark-mode-toggle>`](https://github.com/GoogleChromeLabs/dark-mode-toggle) ⭐ 1,212 | 🐛 4 | 🌐 JavaScript | 📅 2026-01-22 - Custom element that allows to create a dark mode toggle or switch.
* [`<midi-player>`](https://github.com/cifkao/html-midi-player) ⭐ 849 | 🐛 19 | 🌐 TypeScript | 📅 2025-07-06 - MIDI file player and visualizer web components.
...
* [`<active-table>`](https://github.com/OvidijusParsiunas/active-table) ⭐ 308 | 🐛 26 | 🌐 TypeScript | 📅 2025-05-13 - Editable table web component.
...
* [`<progressive-image>`](https://github.com/andreruffert/progressive-image-element) ⭐ 273 | 🐛 2 | 🌐 HTML | 📅 2026-02-04 - Custom element to progressively enhance image placeholders.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,403 | 🐛 17 | 🌐 JavaScript | 📅 2026-02-03 quickly into your page using custom elements.
...
* [`<range-slider>`](https://github.com/andreruffert/range-slider-element) ⭐ 87 | 🐛 7 | 🌐 JavaScript | 📅 2026-01-26 - Accessible range slider custom element with keyboard support.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,919 | 🐛 1,007 | 🌐 JavaScript | 📅 2026-01-17 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
* [Shoelace](https://github.com/shoelace-style/shoelace) ⭐ 13,845 | 🐛 102 | 🌐 TypeScript | 📅 2025-10-29 - A forward-thinking library of web components.
* [Wired Elements](https://github.com/wiredjs/wired-elements) ⭐ 10,749 | 🐛 35 | 🌐 TypeScript | 📅 2023-10-07 - Set of common UI elements with a hand-drawn, sketchy look.
* [github-elements](https://github.com/github/github-elements) ⭐ 2,897 | 🐛 1 | 🌐 JavaScript | 📅 2025-12-08 - GitHub's Web Component collection.
* [LDRS](https://github.com/GriffinJohnston/ldrs) ⭐ 2,148 | 🐛 1 | 🌐 TypeScript | 📅 2025-10-22 - Lightweight, customizable loading animations/spinners.
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,929 | 🐛 159 | 🌐 JavaScript | 📅 2026-02-05 - Set of highly performant, accessible and flexible Web Components.
...
* [Lume](https://github.com/lume/lume) ⭐ 1,487 | 🐛 124 | 🌐 TypeScript | 📅 2026-02-07 - Custom elements for 3D graphics. Built with Three.js for WebGL/WebGPU rendering, and Solid.js for reactivity and templating.
* [Microsoft Graph Toolkit](https://github.com/microsoftgraph/microsoft-graph-toolkit) ⭐ 1,041 | 🐛 185 | 🌐 TypeScript | 📅 2026-01-21 - Collection of web components for the Microsoft Graph.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 768 | 🐛 4 | 🌐 TypeScript | 📅 2026-02-06 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
* [Playground Elements](https://github.com/PolymerLabs/playground-elements) ⭐ 640 | 🐛 97 | 🌐 TypeScript | 📅 2025-10-02 - Serverless code experiences with web components.
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 551 | 🐛 939 | 🌐 JavaScript | 📅 2026-02-06 - Evolving set of high-quality web components for building business web applications.
...
* [Apollo Elements](https://github.com/apollo-elements/apollo-elements) ⭐ 423 | 🐛 1 | 🌐 TypeScript | 📅 2026-01-01 - Custom elements for using Apollo GraphQL with various web components libraries.
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 269 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-06 - ELMS:LN produced web components for any project.
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 238 | 🐛 322 | 🌐 JavaScript | 📅 2026-02-04 - Collection of Web Components made by Clever Cloud.
* [Wokwi Elements](https://github.com/wokwi/wokwi-elements) ⭐ 224 | 🐛 18 | 🌐 TypeScript | 📅 2026-01-22 - Web Components for Arduino and various electronic parts.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 168 | 🐛 63 | 🌐 TypeScript | 📅 2026-02-06 - Complete library of UI components from Infragistics.
...
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 142 | 🐛 47 | 🌐 TypeScript | 📅 2026-02-02 - Collection of user interface web components for Umbraco CMS.
...
* [AXA Pattern Library](https://github.com/axa-ch-webhub-cloud/pattern-library) ⭐ 128 | 🐛 27 | 🌐 JavaScript | 📅 2023-12-04 - AXA CH UI components library built with Web Components.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 98 | 🐛 2 | 🌐 JavaScript | 📅 2026-01-27 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 77 | 🐛 42 | 🌐 JavaScript | 📅 2026-02-06 - Collection of web components for building Brightspace applications.
* [Medblocks UI](https://github.com/medblocks/medblocks-ui) ⭐ 67 | 🐛 12 | 🌐 TypeScript | 📅 2025-05-29 - Web Components for rapid development of openEHR and FHIR systems.
* [TrendChart Elements](https://github.com/WebLogin/trendchart-elements) ⭐ 63 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-06 - Components to generate simple, light and responsive charts.
...
* [Joomla UI custom elements](https://github.com/joomla-projects/custom-elements) ⭐ 31 | 🐛 12 | 🌐 JavaScript | 📅 2026-01-25 - Compilation of Joomla 4 Custom Elements.
* [One Platform Components](https://github.com/1-Platform/op-components) ⭐ 31 | 🐛 17 | 🌐 TypeScript | 📅 2026-02-02 - Set of web components for Red Hat One Platform.
* [elements-sk](https://github.com/google/elements-sk) ⚠️ Archived - Collection of custom elements for "a la carte" web development.
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 47 | 🌐 TypeScript | 📅 2026-02-07 - A schema for mutation testing results with the web components to visualize it.
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 27 | 🐛 14 | 🌐 JavaScript | 📅 2026-02-06 - Components for building web applications with Nuxeo using Web Components.
* [Titanium Elements](https://github.com/LeavittSoftware/titanium-elements) ⭐ 19 | 🐛 3 | 🌐 TypeScript | 📅 2026-02-06 - Collection of lightweight web components used by Leavitt Group Enterprises.
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 52 | 🌐 JavaScript | 📅 2026-01-26 - Collection of web components used by TEI Publisher and apps generated by it.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 19 | 🌐 TypeScript | 📅 2026-02-06 - Ser of web components used by Equinor Fusion.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 11 | 🐛 5 | 🌐 JavaScript | 📅 2026-02-05 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,840 | 🐛 651 | 🌐 TypeScript | 📅 2026-02-06 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,721 | 🐛 162 | 🌐 SCSS | 📅 2026-02-02 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,613 | 🐛 86 | 🌐 TypeScript | 📅 2026-02-06 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,719 | 🐛 280 | 🌐 TypeScript | 📅 2026-02-07 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,484 | 🐛 225 | 🌐 TypeScript | 📅 2026-02-06 - Adobe Spectrum design language implementation built with Web Components.
...
* [PatternFly Elements](https://github.com/patternfly/patternfly-elements) ⭐ 385 | 🐛 209 | 🌐 TypeScript | 📅 2026-02-06 - Collection of flexible and lightweight Web Components based on the Unified Design Kit.
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 346 | 🐛 845 | 🌐 TypeScript | 📅 2026-02-07 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 319 | 🐛 79 | 🌐 TypeScript | 📅 2026-02-06 - Web Components implementing Siemens iX design system.
* [Crayons](https://github.com/freshdesk/crayons) ⭐ 236 | 🐛 45 | 🌐 JavaScript | 📅 2026-02-05 - Collection of web components that adheres to the Freshworks Design System.
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 211 | 🐛 61 | 🌐 SCSS | 📅 2026-01-30 - Set of UI components based on Momentum Design.
* [Clarity Core Web Components](https://github.com/vmware-clarity/core/tree/main/projects/core) ⭐ 184 | 🐛 54 | 🌐 TypeScript | 📅 2026-02-02 - Suite of web components from the Clarity Design System.
* [Astro Space UX Design System](https://github.com/RocketCommunicationsInc/astro) ⭐ 149 | 🐛 32 | 🌐 TypeScript | 📅 2026-02-07 - Set of components to build rich space app experiences with established interaction patterns.
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 135 | 🐛 242 | 🌐 HTML | 📅 2026-02-06 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 131 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 129 | 🐛 73 | 🌐 TypeScript | 📅 2026-02-06 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 63 | 🐛 68 | 🌐 TypeScript | 📅 2026-02-06 - Library of Web Components adhering to the Forge Design System.
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 59 | 🐛 71 | 🌐 TypeScript | 📅 2026-02-07 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Omi](https://github.com/Tencent/omi) ⭐ 13,259 | 🐛 69 | 🌐 TypeScript | 📅 2026-01-10 - Next generation web framework in 4kb JavaScript (Web Components + JSX + Proxy + Store + Path Updating).
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,019 | 🐛 165 | 🌐 TypeScript | 📅 2026-02-06 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,613 | 🐛 86 | 🌐 TypeScript | 📅 2026-02-06 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,753 | 🐛 416 | 🌐 JavaScript | 📅 2026-02-06 - blazing fast, enterprise-grade Web Components foundation.
...
* [Lume Element](https://github.com/lume/element) ⭐ 183 | 🐛 12 | 🌐 TypeScript | 📅 2026-02-07 - Write custom elements with reactivity and templating powered by Solid.js signals and effects.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 135 | 🐛 6 | 🌐 TypeScript | 📅 2026-02-05 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [DNA](https://github.com/chialab/dna) ⭐ 59 | 🐛 5 | 🌐 TypeScript | 📅 2026-01-28 - Progressive Web Components library.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,061 | 🐛 129 | 🌐 TypeScript | 📅 2026-01-26 - Library that extends Solid adding Custom Web Components and extensions.
...
* [haunted](https://github.com/matthewp/haunted) ⭐ 2,701 | 🐛 62 | 🌐 TypeScript | 📅 2025-12-24 - React's Hooks API implemented for web components.
* [atomico](https://github.com/atomicojs/atomico) ⭐ 1,260 | 🐛 17 | 🌐 TypeScript | 📅 2025-11-26 - Small library for the creation of interfaces based on web components using functions and hooks.
...
* [nuxt-custom-elements](https://github.com/GrabarzUndPartner/nuxt-custom-elements) ⭐ 83 | 🐛 18 | 🌐 JavaScript | 📅 2026-02-06 - Export your project components as custom elements for integration into external pages.
...
* [ember-custom-elements](https://github.com/Ravenstine/ember-custom-elements) ⭐ 15 | 🐛 17 | 🌐 JavaScript | 📅 2026-02-05 - Render Ember and Glimmer components using custom elements.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,919 | 🐛 1,007 | 🌐 JavaScript | 📅 2026-01-17 - Web component framework to easily create user-first experiences for the web.
* [WebC](https://github.com/11ty/webc) ⭐ 1,405 | 🐛 61 | 🌐 JavaScript | 📅 2025-12-02 - Framework-independent standalone HTML serializer for generating markup for web components.
* [Web Components Compiler](https://github.com/ProjectEvergreen/wcc) ⭐ 120 | 🐛 20 | 🌐 JavaScript | 📅 2026-02-07 - Compiler to make server-side rendering of native web components easier.
...
* [hello-web-components](https://github.com/fernandopasik/hello-web-components) ⭐ 31 | 🐛 6 | 🌐 TypeScript | 📅 2026-02-06 - Simple starter hello world web component written in TypeScript.
...
* [shadow-automation-selenium](https://github.com/sukgu/shadow-automation-selenium) ⭐ 116 | 🐛 9 | 🌐 Java | 📅 2026-02-03 - Shadow DOM automation using Selenium.
* [cypress-lit](https://github.com/simonireilly/cypress-lit) ⭐ 25 | 🐛 12 | 🌐 TypeScript | 📅 2026-02-06 - Test your Lit elements and native web components in Cypress with all the modern browsers.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 36 | 🌐 JavaScript | 📅 2026-02-07 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,767 | 🐛 2,703 | 🌐 HTML | 📅 2026-02-07

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,767 | 🐛 2,703 | 🌐 HTML | 📅 2026-02-07
...
* [`ElementInternals`'s `states` property and the `:state()` pseudo class](https://github.com/w3c/webcomponents/blob/gh-pages/proposals/custom-states-and-state-pseudo-class.md) ⭐ 4,476 | 🐛 203 | 🌐 HTML | 📅 2025-12-09

## Miscellaneous

* [bruck](https://github.com/Heydon/bruck) ⭐ 514 | 🐛 2 | 🌐 JavaScript | 📅 2023-08-25 - Prototyping system built with web components and the Houdini Paint API.
...
* [@webcomponents/custom-elements](https://github.com/webcomponents/polyfills/tree/master/packages/custom-elements) ⭐ 1,180 | 🐛 140 | 🌐 HTML | 📅 2026-01-24 - Custom Elements polyfill by Polymer team.
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,753 | 🐛 416 | 🌐 JavaScript | 📅 2026-02-06 - Shadow DOM polyfill by [LWC](https://lwc.dev).
* [@webcomponents/shadydom](https://github.com/webcomponents/polyfills/tree/master/packages/shadydom) ⭐ 1,180 | 🐛 140 | 🌐 HTML | 📅 2026-01-24 - ShadowDOM v1 shim.
* [@webcomponents/shadycss](https://github.com/webcomponents/polyfills/tree/master/packages/shadycss) ⭐ 1,180 | 🐛 140 | 🌐 HTML | 📅 2026-01-24 - ShadowDOM style encapsulation shim.

#### HTML Templates polyfills

* [@webcomponents/template](https://github.com/webcomponents/polyfills/tree/master/packages/template) ⭐ 1,180 | 🐛 140 | 🌐 HTML | 📅 2026-01-24 - Minimal polyfill for `<template>`.
