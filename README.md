...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,834 | 🐛 2,755 | 🌐 HTML | 📅 2026-03-25
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,834 | 🐛 2,755 | 🌐 HTML | 📅 2026-03-25
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,834 | 🐛 2,755 | 🌐 HTML | 📅 2026-03-25
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,834 | 🐛 2,755 | 🌐 HTML | 📅 2026-03-25
...
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 7,971 | 🐛 114 | 🌐 TypeScript | 📅 2026-03-24 - Web component for rendering interactive 3D models.
...
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 5,978 | 🐛 7 | 🌐 JavaScript | 📅 2026-03-07 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,560 | 🐛 29 | 🌐 TypeScript | 📅 2026-03-23 - Web component for chat with AI capabilities.
...
* [`<midi-player>`](https://github.com/cifkao/html-midi-player) ⭐ 861 | 🐛 21 | 🌐 TypeScript | 📅 2025-07-06 - MIDI file player and visualizer web components.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,451 | 🐛 21 | 🌐 JavaScript | 📅 2026-03-24 quickly into your page using custom elements.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,937 | 🐛 173 | 🌐 JavaScript | 📅 2026-03-24 - Set of highly performant, accessible and flexible Web Components.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 788 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-24 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 557 | 🐛 937 | 🌐 JavaScript | 📅 2026-03-24 - Evolving set of high-quality web components for building business web applications.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 270 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-24 - ELMS:LN produced web components for any project.
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 324 | 🌐 JavaScript | 📅 2026-03-24 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 166 | 🐛 72 | 🌐 TypeScript | 📅 2026-03-25 - Complete library of UI components from Infragistics.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 103 | 🐛 2 | 🌐 JavaScript | 📅 2026-03-24 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 34 | 🌐 JavaScript | 📅 2026-03-24 - Collection of web components for building Brightspace applications.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 17 | 🌐 TypeScript | 📅 2026-03-24 - Ser of web components used by Equinor Fusion.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 12 | 🐛 8 | 🌐 JavaScript | 📅 2026-03-24 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,886 | 🐛 661 | 🌐 TypeScript | 📅 2026-03-24 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,819 | 🐛 161 | 🌐 SCSS | 📅 2026-03-14 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,642 | 🐛 82 | 🌐 TypeScript | 📅 2026-03-24 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,728 | 🐛 293 | 🌐 TypeScript | 📅 2026-03-25 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,494 | 🐛 231 | 🌐 TypeScript | 📅 2026-03-25 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 349 | 🐛 873 | 🌐 TypeScript | 📅 2026-03-25 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 332 | 🐛 88 | 🌐 TypeScript | 📅 2026-03-24 - Web Components implementing Siemens iX design system.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 212 | 🐛 63 | 🌐 SCSS | 📅 2026-03-24 - Set of UI components based on Momentum Design.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 133 | 🐛 228 | 🌐 HTML | 📅 2026-03-25 - Web components for building uniform experiences with the Red Hat brand.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 65 | 🐛 40 | 🌐 TypeScript | 📅 2026-03-24 - Library of Web Components adhering to the Forge Design System.
...
* [Zooplus web components](https://github.com/zooplus/zoo-web-components) ⭐ 50 | 🐛 1 | 🌐 JavaScript | 📅 2026-03-24 - Set of web components that implement Z+ shop style guide.
...
* [Omi](https://github.com/Tencent/omi) ⭐ 13,258 | 🐛 70 | 🌐 TypeScript | 📅 2026-03-17 - Next generation web framework in 4kb JavaScript (Web Components + JSX + Proxy + Store + Path Updating).
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,051 | 🐛 172 | 🌐 TypeScript | 📅 2026-03-24 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,642 | 🐛 82 | 🌐 TypeScript | 📅 2026-03-24 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,760 | 🐛 415 | 🌐 JavaScript | 📅 2026-03-24 - blazing fast, enterprise-grade Web Components foundation.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,367 | 🐛 117 | 🌐 TypeScript | 📅 2026-03-24 - Library that extends Solid adding Custom Web Components and extensions.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,834 | 🐛 2,755 | 🌐 HTML | 📅 2026-03-25

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,834 | 🐛 2,755 | 🌐 HTML | 📅 2026-03-25
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,760 | 🐛 415 | 🌐 JavaScript | 📅 2026-03-24 - Shadow DOM polyfill by [LWC](https://lwc.dev).
