...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,814 | 🐛 2,736 | 🌐 HTML | 📅 2026-03-10
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,814 | 🐛 2,736 | 🌐 HTML | 📅 2026-03-10
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,814 | 🐛 2,736 | 🌐 HTML | 📅 2026-03-10
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,814 | 🐛 2,736 | 🌐 HTML | 📅 2026-03-10
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,932 | 🐛 170 | 🌐 JavaScript | 📅 2026-03-03 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 7,945 | 🐛 115 | 🌐 TypeScript | 📅 2026-03-04 - Web component for rendering interactive 3D models.
* [`<lite-youtube>`](https://github.com/paulirish/lite-youtube-embed) ⭐ 6,296 | 🐛 27 | 🌐 HTML | 📅 2025-11-10 - Lite YouTube embed with a focus on visual performance.
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 5,972 | 🐛 7 | 🌐 JavaScript | 📅 2026-03-07 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,549 | 🐛 27 | 🌐 TypeScript | 📅 2026-03-09 - Web component for chat with AI capabilities.
* [`<vime-player>`](https://github.com/vime-js/vime) ⭐ 2,844 | 🐛 172 | 🌐 TypeScript | 📅 2024-11-17 - Customizable, extensible, accessible and framework agnostic media player.
* [`<rapi-doc>`](https://github.com/mrin9/RapiDoc) ⭐ 1,883 | 🐛 131 | 🌐 JavaScript | 📅 2026-02-11 - Web component for creating documentation from OpenAPI Specification.
...
* [`<dark-mode-toggle>`](https://github.com/GoogleChromeLabs/dark-mode-toggle) ⭐ 1,214 | 🐛 4 | 🌐 JavaScript | 📅 2026-02-14 - Custom element that allows to create a dark mode toggle or switch.
...
* [`<active-table>`](https://github.com/OvidijusParsiunas/active-table) ⭐ 312 | 🐛 27 | 🌐 TypeScript | 📅 2026-02-26 - Editable table web component.
* [`<api-viewer>`](https://github.com/web-padawan/api-viewer-element) ⭐ 283 | 🐛 19 | 🌐 TypeScript | 📅 2026-03-07 - API documentation and live playground for Web Components.
* [`<progressive-image>`](https://github.com/andreruffert/progressive-image-element) ⭐ 274 | 🐛 2 | 🌐 HTML | 📅 2026-03-06 - Custom element to progressively enhance image placeholders.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,442 | 🐛 20 | 🌐 JavaScript | 📅 2026-03-09 quickly into your page using custom elements.
...
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 116 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-08 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
* [`<range-slider>`](https://github.com/andreruffert/range-slider-element) ⭐ 89 | 🐛 4 | 🌐 JavaScript | 📅 2026-03-09 - Accessible range slider custom element with keyboard support.
* [`<fg-modal>`](https://github.com/filamentgroup/fg-modal) ⚠️ Archived - Accessible modal dialog web component.
* [`<pdfjs-viewer-element>`](https://github.com/alekswebnet/pdfjs-viewer-element) ⭐ 65 | 🐛 2 | 🌐 JavaScript | 📅 2026-03-09 - Custom element that embeds PDF.js default viewer.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,919 | 🐛 1,009 | 🌐 JavaScript | 📅 2026-03-04 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
* [Shoelace](https://github.com/shoelace-style/shoelace) ⭐ 13,869 | 🐛 104 | 🌐 TypeScript | 📅 2026-03-05 - A forward-thinking library of web components.
* [Wired Elements](https://github.com/wiredjs/wired-elements) ⭐ 10,759 | 🐛 35 | 🌐 TypeScript | 📅 2023-10-07 - Set of common UI elements with a hand-drawn, sketchy look.
* [github-elements](https://github.com/github/github-elements) ⭐ 2,900 | 🐛 1 | 🌐 JavaScript | 📅 2025-12-08 - GitHub's Web Component collection.
* [LDRS](https://github.com/GriffinJohnston/ldrs) ⭐ 2,150 | 🐛 1 | 🌐 TypeScript | 📅 2025-10-22 - Lightweight, customizable loading animations/spinners.
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,934 | 🐛 170 | 🌐 JavaScript | 📅 2026-03-10 - Set of highly performant, accessible and flexible Web Components.
* [Blaze UI Atoms](https://github.com/BlazeSoftware/atoms) ⭐ 1,559 | 🐛 4 | 🌐 TypeScript | 📅 2023-06-20 - Set of web components powered by Blaze CSS.
* [Lume](https://github.com/lume/lume) ⭐ 1,493 | 🐛 125 | 🌐 TypeScript | 📅 2026-02-09 - Custom elements for 3D graphics. Built with Three.js for WebGL/WebGPU rendering, and Solid.js for reactivity and templating.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 782 | 🐛 4 | 🌐 TypeScript | 📅 2026-03-10 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
* [Playground Elements](https://github.com/PolymerLabs/playground-elements) ⭐ 641 | 🐛 95 | 🌐 TypeScript | 📅 2025-10-02 - Serverless code experiences with web components.
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 556 | 🐛 945 | 🌐 JavaScript | 📅 2026-03-10 - Evolving set of high-quality web components for building business web applications.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 270 | 🐛 2 | 🌐 JavaScript | 📅 2026-03-06 - ELMS:LN produced web components for any project.
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 239 | 🐛 328 | 🌐 JavaScript | 📅 2026-03-09 - Collection of Web Components made by Clever Cloud.
...
* [Curvenote](https://github.com/curvenote/article) ⭐ 194 | 🐛 20 | 🌐 TypeScript | 📅 2025-05-14 - Web components for creating interactive scientific articles.
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 167 | 🐛 69 | 🌐 TypeScript | 📅 2026-03-09 - Complete library of UI components from Infragistics.
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 145 | 🐛 42 | 🌐 TypeScript | 📅 2026-03-09 - Collection of user interface web components for Umbraco CMS.
...
* [Blackstone UI](https://github.com/kjantzer/bui) ⭐ 109 | 🐛 17 | 🌐 JavaScript | 📅 2025-12-08 - Web components for creating interfaces by Blackstone Publishing.
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 102 | 🐛 4 | 🌐 JavaScript | 📅 2026-03-10 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 77 | 🐛 37 | 🌐 JavaScript | 📅 2026-03-09 - Collection of web components for building Brightspace applications.
...
* [One Platform Components](https://github.com/1-Platform/op-components) ⭐ 30 | 🐛 17 | 🌐 TypeScript | 📅 2026-03-05 - Set of web components for Red Hat One Platform.
* [elements-sk](https://github.com/google/elements-sk) ⚠️ Archived - Collection of custom elements for "a la carte" web development.
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 45 | 🌐 TypeScript | 📅 2026-03-09 - A schema for mutation testing results with the web components to visualize it.
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 27 | 🐛 16 | 🌐 JavaScript | 📅 2026-03-09 - Components for building web applications with Nuxeo using Web Components.
* [Titanium Elements](https://github.com/LeavittSoftware/titanium-elements) ⭐ 19 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-09 - Collection of lightweight web components used by Leavitt Group Enterprises.
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 54 | 🌐 JavaScript | 📅 2026-02-24 - Collection of web components used by TEI Publisher and apps generated by it.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 27 | 🌐 TypeScript | 📅 2026-03-09 - Ser of web components used by Equinor Fusion.
* [Furo Webcomponents](https://github.com/eclipse/eclipsefuro-web) ⭐ 12 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-07 - Enterprise ready set of web components which work best with Eclipse Furo.
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 11 | 🐛 6 | 🌐 JavaScript | 📅 2026-03-09 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,871 | 🐛 671 | 🌐 TypeScript | 📅 2026-03-09 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,787 | 🐛 164 | 🌐 SCSS | 📅 2026-03-07 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,629 | 🐛 78 | 🌐 TypeScript | 📅 2026-03-10 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,724 | 🐛 284 | 🌐 TypeScript | 📅 2026-03-10 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,492 | 🐛 215 | 🌐 TypeScript | 📅 2026-03-09 - Adobe Spectrum design language implementation built with Web Components.
...
* [PatternFly Elements](https://github.com/patternfly/patternfly-elements) ⭐ 389 | 🐛 206 | 🌐 TypeScript | 📅 2026-03-08 - Collection of flexible and lightweight Web Components based on the Unified Design Kit.
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 346 | 🐛 870 | 🌐 TypeScript | 📅 2026-03-10 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 325 | 🐛 90 | 🌐 TypeScript | 📅 2026-03-09 - Web Components implementing Siemens iX design system.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 212 | 🐛 62 | 🌐 SCSS | 📅 2026-03-02 - Set of UI components based on Momentum Design.
...
* [Astro Space UX Design System](https://github.com/RocketCommunicationsInc/astro) ⭐ 149 | 🐛 43 | 🌐 TypeScript | 📅 2026-03-06 - Set of components to build rich space app experiences with established interaction patterns.
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 132 | 🐛 232 | 🌐 HTML | 📅 2026-03-09 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 130 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 128 | 🐛 74 | 🌐 TypeScript | 📅 2026-03-09 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 65 | 🐛 46 | 🌐 TypeScript | 📅 2026-03-09 - Library of Web Components adhering to the Forge Design System.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 62 | 🐛 72 | 🌐 TypeScript | 📅 2026-03-10 - Building blocks of the Lyne Design System are based on Web Components.
* [Zooplus web components](https://github.com/zooplus/zoo-web-components) ⭐ 50 | 🐛 5 | 🌐 JavaScript | 📅 2026-03-06 - Set of web components that implement Z+ shop style guide.
...
* [Omi](https://github.com/Tencent/omi) ⭐ 13,261 | 🐛 69 | 🌐 TypeScript | 📅 2026-01-10 - Next generation web framework in 4kb JavaScript (Web Components + JSX + Proxy + Store + Path Updating).
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,038 | 🐛 166 | 🌐 TypeScript | 📅 2026-03-09 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,629 | 🐛 78 | 🌐 TypeScript | 📅 2026-03-10 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,756 | 🐛 416 | 🌐 JavaScript | 📅 2026-03-09 - blazing fast, enterprise-grade Web Components foundation.
...
* [Lume Element](https://github.com/lume/element) ⭐ 184 | 🐛 26 | 🌐 TypeScript | 📅 2026-03-05 - Write custom elements with reactivity and templating powered by Solid.js signals and effects.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 135 | 🐛 6 | 🌐 TypeScript | 📅 2026-03-07 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,367 | 🐛 124 | 🌐 TypeScript | 📅 2026-03-06 - Library that extends Solid adding Custom Web Components and extensions.
* [hybrids](https://github.com/hybridsjs/hybrids) ⭐ 3,169 | 🐛 7 | 🌐 JavaScript | 📅 2026-01-07 - UI library for creating Web Components with simple and functional API.
...
* [atomico](https://github.com/atomicojs/atomico) ⭐ 1,265 | 🐛 17 | 🌐 TypeScript | 📅 2025-11-26 - Small library for the creation of interfaces based on web components using functions and hooks.
...
* [nuxt-custom-elements](https://github.com/GrabarzUndPartner/nuxt-custom-elements) ⭐ 83 | 🐛 18 | 🌐 JavaScript | 📅 2026-03-07 - Export your project components as custom elements for integration into external pages.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,919 | 🐛 1,009 | 🌐 JavaScript | 📅 2026-03-04 - Web component framework to easily create user-first experiences for the web.
...
* [Web Components Compiler](https://github.com/ProjectEvergreen/wcc) ⭐ 121 | 🐛 20 | 🌐 JavaScript | 📅 2026-03-05 - Compiler to make server-side rendering of native web components easier.
...
* [hello-web-components](https://github.com/fernandopasik/hello-web-components) ⭐ 31 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-08 - Simple starter hello world web component written in TypeScript.
...
* [cypress-lit](https://github.com/simonireilly/cypress-lit) ⭐ 25 | 🐛 12 | 🌐 TypeScript | 📅 2026-03-05 - Test your Lit elements and native web components in Cypress with all the modern browsers.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 36 | 🌐 JavaScript | 📅 2026-03-07 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,814 | 🐛 2,736 | 🌐 HTML | 📅 2026-03-10

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,814 | 🐛 2,736 | 🌐 HTML | 📅 2026-03-10
...
* [@webcomponents/custom-elements](https://github.com/webcomponents/polyfills/tree/master/packages/custom-elements) ⭐ 1,180 | 🐛 143 | 🌐 HTML | 📅 2026-02-27 - Custom Elements polyfill by Polymer team.
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,756 | 🐛 416 | 🌐 JavaScript | 📅 2026-03-09 - Shadow DOM polyfill by [LWC](https://lwc.dev).
* [@webcomponents/shadydom](https://github.com/webcomponents/polyfills/tree/master/packages/shadydom) ⭐ 1,180 | 🐛 143 | 🌐 HTML | 📅 2026-02-27 - ShadowDOM v1 shim.
* [@webcomponents/shadycss](https://github.com/webcomponents/polyfills/tree/master/packages/shadycss) ⭐ 1,180 | 🐛 143 | 🌐 HTML | 📅 2026-02-27 - ShadowDOM style encapsulation shim.

#### HTML Templates polyfills

* [@webcomponents/template](https://github.com/webcomponents/polyfills/tree/master/packages/template) ⭐ 1,180 | 🐛 143 | 🌐 HTML | 📅 2026-02-27 - Minimal polyfill for `<template>`.
