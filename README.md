...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,936 | 🐛 2,816 | 🌐 HTML | 📅 2026-05-26
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,936 | 🐛 2,816 | 🌐 HTML | 📅 2026-05-26
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,936 | 🐛 2,816 | 🌐 HTML | 📅 2026-05-26
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,936 | 🐛 2,816 | 🌐 HTML | 📅 2026-05-26
...
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,085 | 🐛 113 | 🌐 TypeScript | 📅 2026-05-22 - Web component for rendering interactive 3D models.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,618 | 🐛 34 | 🌐 TypeScript | 📅 2026-05-25 - Web component for chat with AI capabilities.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,510 | 🐛 23 | 🌐 JavaScript | 📅 2026-05-09 quickly into your page using custom elements.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 564 | 🐛 945 | 🌐 JavaScript | 📅 2026-05-25 - Evolving set of high-quality web components for building business web applications.
...
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 241 | 🐛 331 | 🌐 JavaScript | 📅 2026-05-25 - Collection of Web Components made by Clever Cloud.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 105 | 🐛 5 | 🌐 JavaScript | 📅 2026-05-25 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 47 | 🌐 JavaScript | 📅 2026-05-25 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 39 | 🌐 JavaScript | 📅 2026-05-26 - Components for building web applications with Nuxeo using Web Components.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 38 | 🌐 TypeScript | 📅 2026-05-25 - Ser of web components used by Equinor Fusion.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,023 | 🐛 741 | 🌐 TypeScript | 📅 2026-05-25 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,973 | 🐛 168 | 🌐 SCSS | 📅 2026-05-23 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,652 | 🐛 78 | 🌐 TypeScript | 📅 2026-05-24 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,748 | 🐛 251 | 🌐 TypeScript | 📅 2026-05-26 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,513 | 🐛 252 | 🌐 TypeScript | 📅 2026-05-25 - Adobe Spectrum design language implementation built with Web Components.
...
* [PatternFly Elements](https://github.com/patternfly/patternfly-elements) ⭐ 391 | 🐛 174 | 🌐 TypeScript | 📅 2026-05-25 - Collection of flexible and lightweight Web Components based on the Unified Design Kit.
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 364 | 🐛 904 | 🌐 TypeScript | 📅 2026-05-25 - Shared Web Components for Esri's Calcite design framework.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 64 | 🌐 TypeScript | 📅 2026-05-26 - Building blocks of the Lyne Design System are based on Web Components.
* [NVIDIA Elements](https://github.com/nvidia/elements) ⭐ 8 | 🐛 6 | 🌐 TypeScript | 📅 2026-05-25 - The Design Language and UI Agent Harness for AI/ML Factories, Robotics, and Autonomous Vehicles.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,094 | 🐛 183 | 🌐 TypeScript | 📅 2026-05-23 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,652 | 🐛 78 | 🌐 TypeScript | 📅 2026-05-24 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,570 | 🐛 27 | 🌐 TypeScript | 📅 2026-05-26 - Library that extends Solid adding Custom Web Components and extensions.
...
* [Web Components Compiler](https://github.com/ProjectEvergreen/wcc) ⭐ 124 | 🐛 27 | 🌐 JavaScript | 📅 2026-05-25 - Compiler to make server-side rendering of native web components easier.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,936 | 🐛 2,816 | 🌐 HTML | 📅 2026-05-26

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,936 | 🐛 2,816 | 🌐 HTML | 📅 2026-05-26
