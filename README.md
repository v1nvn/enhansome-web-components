...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,915 | 🐛 2,767 | 🌐 HTML | 📅 2026-05-04
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,915 | 🐛 2,767 | 🌐 HTML | 📅 2026-05-04
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,915 | 🐛 2,767 | 🌐 HTML | 📅 2026-05-04
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,915 | 🐛 2,767 | 🌐 HTML | 📅 2026-05-04
...
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,045 | 🐛 112 | 🌐 TypeScript | 📅 2026-04-17 - Web component for rendering interactive 3D models.
* [`<lite-youtube>`](https://github.com/paulirish/lite-youtube-embed) ⭐ 6,313 | 🐛 28 | 🌐 HTML | 📅 2025-11-10 - Lite YouTube embed with a focus on visual performance.
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 5,988 | 🐛 8 | 🌐 JavaScript | 📅 2026-04-19 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,601 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-22 - Web component for chat with AI capabilities.
...
* [`<emoji-picker>`](https://github.com/nolanlawson/emoji-picker-element) ⭐ 1,734 | 🐛 36 | 🌐 JavaScript | 📅 2026-04-16 - Lightweight emoji picker, distributed as a web component.
...
* [`<dark-mode-toggle>`](https://github.com/GoogleChromeLabs/dark-mode-toggle) ⭐ 1,219 | 🐛 7 | 🌐 JavaScript | 📅 2026-04-15 - Custom element that allows to create a dark mode toggle or switch.
* [`<midi-player>`](https://github.com/cifkao/html-midi-player) ⭐ 872 | 🐛 21 | 🌐 TypeScript | 📅 2025-07-06 - MIDI file player and visualizer web components.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,487 | 🐛 22 | 🌐 JavaScript | 📅 2026-04-28 quickly into your page using custom elements.
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 140 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-02 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,904 | 🐛 1,006 | 🌐 JavaScript | 📅 2026-04-27 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,942 | 🐛 176 | 🌐 JavaScript | 📅 2026-04-23 - Set of highly performant, accessible and flexible Web Components.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 562 | 🐛 947 | 🌐 JavaScript | 📅 2026-05-04 - Evolving set of high-quality web components for building business web applications.
...
* [Wokwi Elements](https://github.com/wokwi/wokwi-elements) ⭐ 240 | 🐛 24 | 🌐 TypeScript | 📅 2026-04-07 - Web Components for Arduino and various electronic parts.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 103 | 🐛 8 | 🌐 JavaScript | 📅 2026-05-01 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 58 | 🌐 JavaScript | 📅 2026-05-01 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 36 | 🌐 JavaScript | 📅 2026-05-04 - Components for building web applications with Nuxeo using Web Components.
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 47 | 🌐 TypeScript | 📅 2026-05-03 - A schema for mutation testing results with the web components to visualize it.
...
* [Tradeshift Elements](https://github.com/Tradeshift/elements) ⭐ 18 | 🐛 60 | 🌐 JavaScript | 📅 2026-05-04 - Reusable Tradeshift UI Components as Web Components.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,961 | 🐛 680 | 🌐 TypeScript | 📅 2026-05-01 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,920 | 🐛 164 | 🌐 SCSS | 📅 2026-04-30 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,644 | 🐛 71 | 🌐 TypeScript | 📅 2026-05-02 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,738 | 🐛 263 | 🌐 TypeScript | 📅 2026-05-04 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,506 | 🐛 240 | 🌐 TypeScript | 📅 2026-05-03 - Adobe Spectrum design language implementation built with Web Components.
...
* [PatternFly Elements](https://github.com/patternfly/patternfly-elements) ⭐ 391 | 🐛 156 | 🌐 TypeScript | 📅 2026-05-03 - Collection of flexible and lightweight Web Components based on the Unified Design Kit.
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 356 | 🐛 885 | 🌐 TypeScript | 📅 2026-05-04 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 339 | 🐛 85 | 🌐 TypeScript | 📅 2026-05-04 - Web Components implementing Siemens iX design system.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 212 | 🐛 63 | 🌐 SCSS | 📅 2026-05-01 - Set of UI components based on Momentum Design.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 136 | 🐛 191 | 🌐 HTML | 📅 2026-05-01 - Web components for building uniform experiences with the Red Hat brand.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 67 | 🐛 42 | 🌐 TypeScript | 📅 2026-05-01 - Library of Web Components adhering to the Forge Design System.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 67 | 🌐 TypeScript | 📅 2026-05-04 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,083 | 🐛 179 | 🌐 TypeScript | 📅 2026-05-04 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,644 | 🐛 71 | 🌐 TypeScript | 📅 2026-05-02 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,764 | 🐛 412 | 🌐 JavaScript | 📅 2026-05-01 - blazing fast, enterprise-grade Web Components foundation.
...
* [DNA](https://github.com/chialab/dna) ⭐ 61 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-03 - Progressive Web Components library.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,478 | 🐛 59 | 🌐 TypeScript | 📅 2026-04-30 - Library that extends Solid adding Custom Web Components and extensions.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,904 | 🐛 1,006 | 🌐 JavaScript | 📅 2026-04-27 - Web component framework to easily create user-first experiences for the web.
...
* [Web Components Compiler](https://github.com/ProjectEvergreen/wcc) ⭐ 123 | 🐛 26 | 🌐 JavaScript | 📅 2026-05-02 - Compiler to make server-side rendering of native web components easier.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 37 | 🌐 JavaScript | 📅 2026-05-01 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,915 | 🐛 2,767 | 🌐 HTML | 📅 2026-05-04

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,915 | 🐛 2,767 | 🌐 HTML | 📅 2026-05-04
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,764 | 🐛 412 | 🌐 JavaScript | 📅 2026-05-01 - Shadow DOM polyfill by [LWC](https://lwc.dev).
