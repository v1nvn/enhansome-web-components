...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,855 | 🐛 2,762 | 🌐 HTML | 📅 2026-04-02
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,855 | 🐛 2,762 | 🌐 HTML | 📅 2026-04-02
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,855 | 🐛 2,762 | 🌐 HTML | 📅 2026-04-02
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,855 | 🐛 2,762 | 🌐 HTML | 📅 2026-04-02
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,927 | 🐛 181 | 🌐 JavaScript | 📅 2026-03-28 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 7,983 | 🐛 111 | 🌐 TypeScript | 📅 2026-04-01 - Web component for rendering interactive 3D models.
* [`<lite-youtube>`](https://github.com/paulirish/lite-youtube-embed) ⭐ 6,303 | 🐛 28 | 🌐 HTML | 📅 2025-11-10 - Lite YouTube embed with a focus on visual performance.
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 5,983 | 🐛 7 | 🌐 JavaScript | 📅 2026-03-07 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,569 | 🐛 28 | 🌐 TypeScript | 📅 2026-03-28 - Web component for chat with AI capabilities.
...
* [`<rapi-doc>`](https://github.com/mrin9/RapiDoc) ⭐ 1,886 | 🐛 133 | 🌐 JavaScript | 📅 2026-02-11 - Web component for creating documentation from OpenAPI Specification.
* [`<emoji-picker>`](https://github.com/nolanlawson/emoji-picker-element) ⭐ 1,723 | 🐛 33 | 🌐 JavaScript | 📅 2026-03-05 - Lightweight emoji picker, distributed as a web component.
...
* [`<dark-mode-toggle>`](https://github.com/GoogleChromeLabs/dark-mode-toggle) ⭐ 1,218 | 🐛 6 | 🌐 JavaScript | 📅 2026-03-25 - Custom element that allows to create a dark mode toggle or switch.
...
* [`<shader-doodle>`](https://github.com/halvves/shader-doodle) ⭐ 581 | 🐛 6 | 🌐 JavaScript | 📅 2023-03-04 - Web component for writing and rendering shaders.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,454 | 🐛 17 | 🌐 JavaScript | 📅 2026-03-31 quickly into your page using custom elements.
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 133 | 🐛 4 | 🌐 TypeScript | 📅 2026-04-01 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [`<pdfjs-viewer-element>`](https://github.com/alekswebnet/pdfjs-viewer-element) ⭐ 68 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-23 - Custom element that embeds PDF.js default viewer.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,918 | 🐛 1,008 | 🌐 JavaScript | 📅 2026-03-30 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,937 | 🐛 175 | 🌐 JavaScript | 📅 2026-03-29 - Set of highly performant, accessible and flexible Web Components.
...
* [Lume](https://github.com/lume/lume) ⭐ 1,498 | 🐛 126 | 🌐 TypeScript | 📅 2026-04-02 - Custom elements for 3D graphics. Built with Three.js for WebGL/WebGPU rendering, and Solid.js for reactivity and templating.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 557 | 🐛 944 | 🌐 JavaScript | 📅 2026-04-01 - Evolving set of high-quality web components for building business web applications.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 270 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-01 - ELMS:LN produced web components for any project.
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 324 | 🌐 JavaScript | 📅 2026-04-01 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 166 | 🐛 69 | 🌐 TypeScript | 📅 2026-04-01 - Complete library of UI components from Infragistics.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 77 | 🐛 44 | 🌐 JavaScript | 📅 2026-04-01 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 30 | 🌐 JavaScript | 📅 2026-03-31 - Components for building web applications with Nuxeo using Web Components.
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 45 | 🌐 TypeScript | 📅 2026-03-30 - A schema for mutation testing results with the web components to visualize it.
...
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 54 | 🌐 JavaScript | 📅 2026-03-31 - Collection of web components used by TEI Publisher and apps generated by it.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 15 | 🌐 TypeScript | 📅 2026-03-31 - Ser of web components used by Equinor Fusion.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 12 | 🐛 8 | 🌐 JavaScript | 📅 2026-04-01 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,907 | 🐛 668 | 🌐 TypeScript | 📅 2026-04-01 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,828 | 🐛 163 | 🌐 SCSS | 📅 2026-03-29 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,637 | 🐛 86 | 🌐 TypeScript | 📅 2026-04-02 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,729 | 🐛 291 | 🌐 TypeScript | 📅 2026-04-02 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,498 | 🐛 237 | 🌐 TypeScript | 📅 2026-04-02 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 350 | 🐛 885 | 🌐 TypeScript | 📅 2026-04-02 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 333 | 🐛 71 | 🌐 TypeScript | 📅 2026-04-01 - Web Components implementing Siemens iX design system.
* [Crayons](https://github.com/freshdesk/crayons) ⭐ 238 | 🐛 45 | 🌐 JavaScript | 📅 2026-04-01 - Collection of web components that adheres to the Freshworks Design System.
...
* [Astro Space UX Design System](https://github.com/RocketCommunicationsInc/astro) ⭐ 149 | 🐛 50 | 🌐 TypeScript | 📅 2026-03-28 - Set of components to build rich space app experiences with established interaction patterns.
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 133 | 🐛 222 | 🌐 HTML | 📅 2026-04-01 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 130 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 129 | 🐛 73 | 🌐 TypeScript | 📅 2026-04-01 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 66 | 🐛 37 | 🌐 TypeScript | 📅 2026-04-01 - Library of Web Components adhering to the Forge Design System.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 81 | 🌐 TypeScript | 📅 2026-04-02 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,054 | 🐛 173 | 🌐 TypeScript | 📅 2026-04-01 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,637 | 🐛 86 | 🌐 TypeScript | 📅 2026-04-02 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,761 | 🐛 419 | 🌐 JavaScript | 📅 2026-04-01 - blazing fast, enterprise-grade Web Components foundation.
...
* [Tonic](https://github.com/optoolco/tonic) ⭐ 890 | 🐛 16 | 🌐 JavaScript | 📅 2026-02-06 - Minimalist, stable, audit friendly component framework.
* [Panel](https://github.com/mixpanel/panel) ⭐ 276 | 🐛 12 | 🌐 JavaScript | 📅 2026-03-24 - Web Components + Virtual DOM: web standards for powerful UIs.
* [Lume Element](https://github.com/lume/element) ⭐ 185 | 🐛 27 | 🌐 TypeScript | 📅 2026-03-26 - Write custom elements with reactivity and templating powered by Solid.js signals and effects.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 134 | 🐛 6 | 🌐 TypeScript | 📅 2026-04-01 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,355 | 🐛 119 | 🌐 TypeScript | 📅 2026-03-31 - Library that extends Solid adding Custom Web Components and extensions.
...
* [haunted](https://github.com/matthewp/haunted) ⭐ 2,709 | 🐛 62 | 🌐 TypeScript | 📅 2026-04-01 - React's Hooks API implemented for web components.
* [atomico](https://github.com/atomicojs/atomico) ⭐ 1,267 | 🐛 17 | 🌐 TypeScript | 📅 2025-11-26 - Small library for the creation of interfaces based on web components using functions and hooks.
...
* [nuxt-custom-elements](https://github.com/GrabarzUndPartner/nuxt-custom-elements) ⭐ 83 | 🐛 18 | 🌐 JavaScript | 📅 2026-04-02 - Export your project components as custom elements for integration into external pages.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,918 | 🐛 1,008 | 🌐 JavaScript | 📅 2026-03-30 - Web component framework to easily create user-first experiences for the web.
...
* [hello-web-components](https://github.com/fernandopasik/hello-web-components) ⭐ 31 | 🐛 6 | 🌐 TypeScript | 📅 2026-04-01 - Simple starter hello world web component written in TypeScript.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 37 | 🌐 JavaScript | 📅 2026-04-01 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,855 | 🐛 2,762 | 🌐 HTML | 📅 2026-04-02

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,855 | 🐛 2,762 | 🌐 HTML | 📅 2026-04-02
...
* [@webcomponents/custom-elements](https://github.com/webcomponents/polyfills/tree/master/packages/custom-elements) ⭐ 1,184 | 🐛 148 | 🌐 HTML | 📅 2026-03-28 - Custom Elements polyfill by Polymer team.
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,761 | 🐛 419 | 🌐 JavaScript | 📅 2026-04-01 - Shadow DOM polyfill by [LWC](https://lwc.dev).
* [@webcomponents/shadydom](https://github.com/webcomponents/polyfills/tree/master/packages/shadydom) ⭐ 1,184 | 🐛 148 | 🌐 HTML | 📅 2026-03-28 - ShadowDOM v1 shim.
* [@webcomponents/shadycss](https://github.com/webcomponents/polyfills/tree/master/packages/shadycss) ⭐ 1,184 | 🐛 148 | 🌐 HTML | 📅 2026-03-28 - ShadowDOM style encapsulation shim.

#### HTML Templates polyfills

* [@webcomponents/template](https://github.com/webcomponents/polyfills/tree/master/packages/template) ⭐ 1,184 | 🐛 148 | 🌐 HTML | 📅 2026-03-28 - Minimal polyfill for `<template>`.
