...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,889 | 🐛 2,783 | 🌐 HTML | 📅 2026-04-18
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,889 | 🐛 2,783 | 🌐 HTML | 📅 2026-04-18
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,889 | 🐛 2,783 | 🌐 HTML | 📅 2026-04-18
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,889 | 🐛 2,783 | 🌐 HTML | 📅 2026-04-18
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,935 | 🐛 184 | 🌐 JavaScript | 📅 2026-04-16 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,013 | 🐛 111 | 🌐 TypeScript | 📅 2026-04-17 - Web component for rendering interactive 3D models.
* [`<lite-youtube>`](https://github.com/paulirish/lite-youtube-embed) ⭐ 6,307 | 🐛 28 | 🌐 HTML | 📅 2025-11-10 - Lite YouTube embed with a focus on visual performance.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,585 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-17 - Web component for chat with AI capabilities.
...
* [`<shader-doodle>`](https://github.com/halvves/shader-doodle) ⭐ 584 | 🐛 6 | 🌐 JavaScript | 📅 2023-03-04 - Web component for writing and rendering shaders.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,473 | 🐛 20 | 🌐 JavaScript | 📅 2026-04-13 quickly into your page using custom elements.
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 136 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-17 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [Wired Elements](https://github.com/wiredjs/wired-elements) ⭐ 10,775 | 🐛 36 | 🌐 TypeScript | 📅 2023-10-07 - Set of common UI elements with a hand-drawn, sketchy look.
...
* [Lume](https://github.com/lume/lume) ⭐ 1,498 | 🐛 127 | 🌐 TypeScript | 📅 2026-04-09 - Custom elements for 3D graphics. Built with Three.js for WebGL/WebGPU rendering, and Solid.js for reactivity and templating.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 562 | 🐛 964 | 🌐 JavaScript | 📅 2026-04-17 - Evolving set of high-quality web components for building business web applications.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 271 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-17 - ELMS:LN produced web components for any project.
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 328 | 🌐 JavaScript | 📅 2026-04-17 - Collection of Web Components made by Clever Cloud.
* [Wokwi Elements](https://github.com/wokwi/wokwi-elements) ⭐ 237 | 🐛 24 | 🌐 TypeScript | 📅 2026-04-07 - Web Components for Arduino and various electronic parts.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 167 | 🐛 68 | 🌐 TypeScript | 📅 2026-04-17 - Complete library of UI components from Infragistics.
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 147 | 🐛 53 | 🌐 TypeScript | 📅 2026-04-17 - Collection of user interface web components for Umbraco CMS.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 103 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-17 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 55 | 🌐 JavaScript | 📅 2026-04-17 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 24 | 🌐 JavaScript | 📅 2026-04-18 - Components for building web applications with Nuxeo using Web Components.
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 46 | 🌐 TypeScript | 📅 2026-04-18 - A schema for mutation testing results with the web components to visualize it.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 16 | 🌐 TypeScript | 📅 2026-04-17 - Ser of web components used by Equinor Fusion.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,935 | 🐛 683 | 🌐 TypeScript | 📅 2026-04-17 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,877 | 🐛 164 | 🌐 SCSS | 📅 2026-04-17 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,641 | 🐛 86 | 🌐 TypeScript | 📅 2026-04-18 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,732 | 🐛 278 | 🌐 TypeScript | 📅 2026-04-18 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,503 | 🐛 242 | 🌐 TypeScript | 📅 2026-04-17 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 352 | 🐛 887 | 🌐 TypeScript | 📅 2026-04-18 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 336 | 🐛 79 | 🌐 TypeScript | 📅 2026-04-17 - Web Components implementing Siemens iX design system.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 134 | 🐛 158 | 🌐 HTML | 📅 2026-04-17 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 130 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 129 | 🐛 75 | 🌐 TypeScript | 📅 2026-04-17 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 78 | 🌐 TypeScript | 📅 2026-04-18 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,071 | 🐛 176 | 🌐 TypeScript | 📅 2026-04-15 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,641 | 🐛 86 | 🌐 TypeScript | 📅 2026-04-18 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,764 | 🐛 421 | 🌐 JavaScript | 📅 2026-04-17 - blazing fast, enterprise-grade Web Components foundation.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,421 | 🐛 85 | 🌐 TypeScript | 📅 2026-04-17 - Library that extends Solid adding Custom Web Components and extensions.
...
* [haunted](https://github.com/matthewp/haunted) ⭐ 2,713 | 🐛 62 | 🌐 TypeScript | 📅 2026-04-17 - React's Hooks API implemented for web components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,889 | 🐛 2,783 | 🌐 HTML | 📅 2026-04-18

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,889 | 🐛 2,783 | 🌐 HTML | 📅 2026-04-18
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,764 | 🐛 421 | 🌐 JavaScript | 📅 2026-04-17 - Shadow DOM polyfill by [LWC](https://lwc.dev).
