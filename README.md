...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,925 | 🐛 2,787 | 🌐 HTML | 📅 2026-05-15
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,925 | 🐛 2,787 | 🌐 HTML | 📅 2026-05-15
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,925 | 🐛 2,787 | 🌐 HTML | 📅 2026-05-15
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,925 | 🐛 2,787 | 🌐 HTML | 📅 2026-05-15
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,935 | 🐛 171 | 🌐 JavaScript | 📅 2026-05-09 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,070 | 🐛 112 | 🌐 TypeScript | 📅 2026-04-17 - Web component for rendering interactive 3D models.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,607 | 🐛 33 | 🌐 TypeScript | 📅 2026-05-14 - Web component for chat with AI capabilities.
...
* [`<emoji-picker>`](https://github.com/nolanlawson/emoji-picker-element) ⭐ 1,736 | 🐛 38 | 🌐 JavaScript | 📅 2026-05-13 - Lightweight emoji picker, distributed as a web component.
...
* [`<progressive-image>`](https://github.com/andreruffert/progressive-image-element) ⭐ 273 | 🐛 2 | 🌐 HTML | 📅 2026-05-13 - Custom element to progressively enhance image placeholders.
* [`<json-viewer>`](https://github.com/alenaksu/json-viewer) ⭐ 238 | 🐛 8 | 🌐 TypeScript | 📅 2025-04-03 - Web component to visualize JSON data in a tree view.
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,497 | 🐛 23 | 🌐 JavaScript | 📅 2026-05-09 quickly into your page using custom elements.
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 146 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-14 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [`<range-slider>`](https://github.com/andreruffert/range-slider-element) ⭐ 92 | 🐛 6 | 🌐 JavaScript | 📅 2026-05-11 - Accessible range slider custom element with keyboard support.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,903 | 🐛 1,009 | 🌐 JavaScript | 📅 2026-05-07 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,942 | 🐛 181 | 🌐 JavaScript | 📅 2026-05-13 - Set of highly performant, accessible and flexible Web Components.
...
* [Microsoft Graph Toolkit](https://github.com/microsoftgraph/microsoft-graph-toolkit) ⭐ 1,055 | 🐛 186 | 🌐 TypeScript | 📅 2026-02-28 - Collection of web components for the Microsoft Graph.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 564 | 🐛 942 | 🌐 JavaScript | 📅 2026-05-14 - Evolving set of high-quality web components for building business web applications.
...
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 241 | 🐛 326 | 🌐 JavaScript | 📅 2026-05-13 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 167 | 🐛 71 | 🌐 TypeScript | 📅 2026-05-14 - Complete library of UI components from Infragistics.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 103 | 🐛 4 | 🌐 JavaScript | 📅 2026-05-13 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 48 | 🌐 JavaScript | 📅 2026-05-14 - Collection of web components for building Brightspace applications.
...
* [One Platform Components](https://github.com/1-Platform/op-components) ⭐ 32 | 🐛 17 | 🌐 TypeScript | 📅 2026-05-12 - Set of web components for Red Hat One Platform.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 35 | 🌐 JavaScript | 📅 2026-05-15 - Components for building web applications with Nuxeo using Web Components.
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 45 | 🌐 TypeScript | 📅 2026-05-12 - A schema for mutation testing results with the web components to visualize it.
* [Titanium Elements](https://github.com/LeavittSoftware/titanium-elements) ⭐ 19 | 🐛 3 | 🌐 TypeScript | 📅 2026-05-13 - Collection of lightweight web components used by Leavitt Group Enterprises.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,987 | 🐛 743 | 🌐 TypeScript | 📅 2026-05-14 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,946 | 🐛 167 | 🌐 SCSS | 📅 2026-05-14 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,647 | 🐛 78 | 🌐 TypeScript | 📅 2026-05-14 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,742 | 🐛 258 | 🌐 TypeScript | 📅 2026-05-15 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,511 | 🐛 251 | 🌐 TypeScript | 📅 2026-05-15 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 361 | 🐛 905 | 🌐 TypeScript | 📅 2026-05-15 - Shared Web Components for Esri's Calcite design framework.
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 343 | 🐛 75 | 🌐 TypeScript | 📅 2026-05-13 - Web Components implementing Siemens iX design system.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 137 | 🐛 194 | 🌐 HTML | 📅 2026-05-14 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 130 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 129 | 🐛 70 | 🌐 TypeScript | 📅 2026-05-11 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 69 | 🌐 TypeScript | 📅 2026-05-15 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,087 | 🐛 179 | 🌐 TypeScript | 📅 2026-05-14 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,647 | 🐛 78 | 🌐 TypeScript | 📅 2026-05-14 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,765 | 🐛 417 | 🌐 JavaScript | 📅 2026-05-14 - blazing fast, enterprise-grade Web Components foundation.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,519 | 🐛 32 | 🌐 TypeScript | 📅 2026-05-15 - Library that extends Solid adding Custom Web Components and extensions.
...
* [haunted](https://github.com/matthewp/haunted) ⭐ 2,713 | 🐛 64 | 🌐 TypeScript | 📅 2026-05-14 - React's Hooks API implemented for web components.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,903 | 🐛 1,009 | 🌐 JavaScript | 📅 2026-05-07 - Web component framework to easily create user-first experiences for the web.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 36 | 🌐 JavaScript | 📅 2026-05-12 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,925 | 🐛 2,787 | 🌐 HTML | 📅 2026-05-15

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,925 | 🐛 2,787 | 🌐 HTML | 📅 2026-05-15
...
* [@webcomponents/custom-elements](https://github.com/webcomponents/polyfills/tree/master/packages/custom-elements) ⭐ 1,186 | 🐛 149 | 🌐 HTML | 📅 2026-05-06 - Custom Elements polyfill by Polymer team.
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,765 | 🐛 417 | 🌐 JavaScript | 📅 2026-05-14 - Shadow DOM polyfill by [LWC](https://lwc.dev).
* [@webcomponents/shadydom](https://github.com/webcomponents/polyfills/tree/master/packages/shadydom) ⭐ 1,186 | 🐛 149 | 🌐 HTML | 📅 2026-05-06 - ShadowDOM v1 shim.
* [@webcomponents/shadycss](https://github.com/webcomponents/polyfills/tree/master/packages/shadycss) ⭐ 1,186 | 🐛 149 | 🌐 HTML | 📅 2026-05-06 - ShadowDOM style encapsulation shim.

#### HTML Templates polyfills

* [@webcomponents/template](https://github.com/webcomponents/polyfills/tree/master/packages/template) ⭐ 1,186 | 🐛 149 | 🌐 HTML | 📅 2026-05-06 - Minimal polyfill for `<template>`.
