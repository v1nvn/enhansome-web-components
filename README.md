...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,923 | 🐛 2,768 | 🌐 HTML | 📅 2026-05-10
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,923 | 🐛 2,768 | 🌐 HTML | 📅 2026-05-10
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,923 | 🐛 2,768 | 🌐 HTML | 📅 2026-05-10
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,923 | 🐛 2,768 | 🌐 HTML | 📅 2026-05-10
...
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,052 | 🐛 112 | 🌐 TypeScript | 📅 2026-04-17 - Web component for rendering interactive 3D models.
* [`<lite-youtube>`](https://github.com/paulirish/lite-youtube-embed) ⭐ 6,317 | 🐛 28 | 🌐 HTML | 📅 2025-11-10 - Lite YouTube embed with a focus on visual performance.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,602 | 🐛 33 | 🌐 TypeScript | 📅 2026-05-08 - Web component for chat with AI capabilities.
...
* [`<emoji-picker>`](https://github.com/nolanlawson/emoji-picker-element) ⭐ 1,735 | 🐛 37 | 🌐 JavaScript | 📅 2026-05-08 - Lightweight emoji picker, distributed as a web component.
...
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 143 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-02 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [Wired Elements](https://github.com/wiredjs/wired-elements) ⭐ 10,776 | 🐛 36 | 🌐 TypeScript | 📅 2023-10-07 - Set of common UI elements with a hand-drawn, sketchy look.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 564 | 🐛 944 | 🌐 JavaScript | 📅 2026-05-09 - Evolving set of high-quality web components for building business web applications.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 166 | 🐛 66 | 🌐 TypeScript | 📅 2026-05-08 - Complete library of UI components from Infragistics.
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 148 | 🐛 52 | 🌐 TypeScript | 📅 2026-05-08 - Collection of user interface web components for Umbraco CMS.
* [Nightingale](https://github.com/ebi-webcomponents/nightingale) ⭐ 142 | 🐛 26 | 🌐 TypeScript | 📅 2026-04-29 - Data visualisation web components for the life sciences.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 103 | 🐛 4 | 🌐 JavaScript | 📅 2026-05-09 - General use Web Components for websites and applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 38 | 🌐 JavaScript | 📅 2026-05-09 - Components for building web applications with Nuxeo using Web Components.
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 46 | 🌐 TypeScript | 📅 2026-05-10 - A schema for mutation testing results with the web components to visualize it.
...
* [Tradeshift Elements](https://github.com/Tradeshift/elements) ⭐ 18 | 🐛 57 | 🌐 JavaScript | 📅 2026-05-04 - Reusable Tradeshift UI Components as Web Components.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,968 | 🐛 737 | 🌐 TypeScript | 📅 2026-05-08 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,934 | 🐛 165 | 🌐 SCSS | 📅 2026-05-07 - Material Design implemented as Web Components.
...
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,741 | 🐛 270 | 🌐 TypeScript | 📅 2026-05-10 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
...
* [PatternFly Elements](https://github.com/patternfly/patternfly-elements) ⭐ 391 | 🐛 169 | 🌐 TypeScript | 📅 2026-05-09 - Collection of flexible and lightweight Web Components based on the Unified Design Kit.
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 360 | 🐛 906 | 🌐 TypeScript | 📅 2026-05-09 - Shared Web Components for Esri's Calcite design framework.
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 342 | 🐛 76 | 🌐 TypeScript | 📅 2026-05-08 - Web Components implementing Siemens iX design system.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 61 | 🌐 TypeScript | 📅 2026-05-10 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,084 | 🐛 182 | 🌐 TypeScript | 📅 2026-05-09 - Compiler for generating Web Components.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 134 | 🐛 6 | 🌐 TypeScript | 📅 2026-05-08 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,500 | 🐛 63 | 🌐 TypeScript | 📅 2026-05-07 - Library that extends Solid adding Custom Web Components and extensions.
...
* [nuxt-custom-elements](https://github.com/GrabarzUndPartner/nuxt-custom-elements) ⭐ 83 | 🐛 19 | 🌐 JavaScript | 📅 2026-05-08 - Export your project components as custom elements for integration into external pages.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,923 | 🐛 2,768 | 🌐 HTML | 📅 2026-05-10

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,923 | 🐛 2,768 | 🌐 HTML | 📅 2026-05-10
