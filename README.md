...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,931 | 🐛 2,781 | 🌐 HTML | 📅 2026-06-13
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,931 | 🐛 2,781 | 🌐 HTML | 📅 2026-06-13
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,931 | 🐛 2,781 | 🌐 HTML | 📅 2026-06-13
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,931 | 🐛 2,781 | 🌐 HTML | 📅 2026-06-13
...
* [web-components-examples](https://github.com/mdn/web-components-examples) ⭐ 3,361 | 🐛 4 | 🌐 JavaScript | 📅 2026-01-13 - Series of web components examples, related to the MDN web components documentation.
* [howto-components](https://github.com/GoogleChromeLabs/howto-components) ⭐ 877 | 🐛 52 | 🌐 JavaScript | 📅 2026-05-28 - Collection of web components that implement common web UI patterns.
* [generic-components](https://github.com/thepassle/generic-components) ⭐ 572 | 🐛 11 | 🌐 JavaScript | 📅 2022-07-21 - Collection of generic web components with a focus on accessibility, and ease of use.
* [Nude UI](https://github.com/LeaVerou/nudeui) ⭐ 234 | 🐛 7 | 🌐 JavaScript | 📅 2025-04-23 - Collection of accessible, customizable, ultra-light web components.
* [vanilla-retro-js](https://github.com/martine-dowden/vanilla-retro-js) ⭐ 17 | 🐛 1 | 🌐 JavaScript | 📅 2026-04-15 - Vanilla JS UI component library of HTML deprecated tags.
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,965 | 🐛 176 | 🌐 JavaScript | 📅 2026-06-13 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,123 | 🐛 119 | 🌐 TypeScript | 📅 2026-06-11 - Web component for rendering interactive 3D models.
* [`<lite-youtube>`](https://github.com/paulirish/lite-youtube-embed) ⭐ 6,324 | 🐛 28 | 🌐 HTML | 📅 2025-11-10 - Lite YouTube embed with a focus on visual performance.
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 6,016 | 🐛 8 | 🌐 JavaScript | 📅 2026-04-19 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,638 | 🐛 35 | 🌐 TypeScript | 📅 2026-06-13 - Web component for chat with AI capabilities.
* [`<vime-player>`](https://github.com/vime-js/vime) ⭐ 2,841 | 🐛 171 | 🌐 TypeScript | 📅 2024-11-17 - Customizable, extensible, accessible and framework agnostic media player.
* [`<rapi-doc>`](https://github.com/mrin9/RapiDoc) ⭐ 1,890 | 🐛 135 | 🌐 JavaScript | 📅 2026-02-11 - Web component for creating documentation from OpenAPI Specification.
* [`<emoji-picker>`](https://github.com/nolanlawson/emoji-picker-element) ⭐ 1,734 | 🐛 39 | 🌐 JavaScript | 📅 2026-06-08 - Lightweight emoji picker, distributed as a web component.
* [`<qr-code>`](https://github.com/bitjson/qr-code) ⭐ 1,379 | 🐛 14 | 🌐 TypeScript | 📅 2023-02-28 – Web component for rendering customizable, animate-able, SVG-based QR codes.
* [`<dark-mode-toggle>`](https://github.com/GoogleChromeLabs/dark-mode-toggle) ⭐ 1,223 | 🐛 8 | 🌐 JavaScript | 📅 2026-05-23 - Custom element that allows to create a dark mode toggle or switch.
* [`<midi-player>`](https://github.com/cifkao/html-midi-player) ⭐ 883 | 🐛 21 | 🌐 TypeScript | 📅 2025-07-06 - MIDI file player and visualizer web components.
* [`<phantom-ui>`](https://github.com/Aejkatappaja/phantom-ui) ⭐ 644 | 🐛 2 | 🌐 TypeScript | 📅 2026-06-10 - Skeleton loader that measures your real DOM to render matching shimmer placeholders.
* [`<shader-doodle>`](https://github.com/halvves/shader-doodle) ⭐ 588 | 🐛 3 | 🌐 JavaScript | 📅 2026-05-06 - Web component for writing and rendering shaders.
* [`<active-table>`](https://github.com/OvidijusParsiunas/active-table) ⭐ 320 | 🐛 28 | 🌐 TypeScript | 📅 2026-02-26 - Editable table web component.
* [`<api-viewer>`](https://github.com/web-padawan/api-viewer-element) ⭐ 283 | 🐛 21 | 🌐 TypeScript | 📅 2026-06-09 - API documentation and live playground for Web Components.
* [`<progressive-image>`](https://github.com/andreruffert/progressive-image-element) ⭐ 271 | 🐛 2 | 🌐 HTML | 📅 2026-06-01 - Custom element to progressively enhance image placeholders.
* [`<json-viewer>`](https://github.com/alenaksu/json-viewer) ⭐ 239 | 🐛 8 | 🌐 TypeScript | 📅 2025-04-03 - Web component to visualize JSON data in a tree view.
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,531 | 🐛 19 | 🌐 JavaScript | 📅 2026-06-10 quickly into your page using custom elements.
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 161 | 🐛 1 | 🌐 TypeScript | 📅 2026-06-12 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [`<range-slider>`](https://github.com/andreruffert/range-slider-element) ⭐ 92 | 🐛 3 | 🌐 JavaScript | 📅 2026-06-08 - Accessible range slider custom element with keyboard support.
* [`<fg-modal>`](https://github.com/filamentgroup/fg-modal) ⚠️ Archived - Accessible modal dialog web component.
* [`<pdfjs-viewer-element>`](https://github.com/alekswebnet/pdfjs-viewer-element) ⭐ 71 | 🐛 1 | 🌐 JavaScript | 📅 2026-04-10 - Custom element that embeds PDF.js default viewer.
...
* [`<theme-switch>`](https://github.com/mahozad/theme-switch) ⭐ 29 | 🐛 0 | 🌐 JavaScript | 📅 2024-03-14 - Animated toggle button to switch between light, dark, and system theme.

### Component Libraries

* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,905 | 🐛 1,018 | 🌐 JavaScript | 📅 2026-05-20 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
* [Shoelace](https://github.com/shoelace-style/shoelace) ⚠️ Archived - A forward-thinking library of web components.
* [Wired Elements](https://github.com/wiredjs/wired-elements) ⭐ 10,798 | 🐛 36 | 🌐 TypeScript | 📅 2023-10-07 - Set of common UI elements with a hand-drawn, sketchy look.
* [github-elements](https://github.com/github/github-elements) ⭐ 2,907 | 🐛 1 | 🌐 JavaScript | 📅 2025-12-08 - GitHub's Web Component collection.
* [LDRS](https://github.com/GriffinJohnston/ldrs) ⭐ 2,178 | 🐛 1 | 🌐 TypeScript | 📅 2025-10-22 - Lightweight, customizable loading animations/spinners.
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,948 | 🐛 183 | 🌐 JavaScript | 📅 2026-06-11 - Set of highly performant, accessible and flexible Web Components.
...
* [Lume](https://github.com/lume/lume) ⭐ 1,505 | 🐛 127 | 🌐 TypeScript | 📅 2026-05-05 - Custom elements for 3D graphics. Built with Three.js for WebGL/WebGPU rendering, and Solid.js for reactivity and templating.
* [Microsoft Graph Toolkit](https://github.com/microsoftgraph/microsoft-graph-toolkit) ⭐ 1,057 | 🐛 186 | 🌐 TypeScript | 📅 2026-05-20 - Collection of web components for the Microsoft Graph.
* [Elix](https://github.com/elix/elix) ⭐ 837 | 🐛 12 | 🌐 JavaScript | 📅 2023-03-01 - High-quality, customizable web components for common user interface patterns.
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 815 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-02 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
* [Playground Elements](https://github.com/PolymerLabs/playground-elements) ⭐ 647 | 🐛 95 | 🌐 TypeScript | 📅 2025-10-02 - Serverless code experiences with web components.
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 565 | 🐛 940 | 🌐 JavaScript | 📅 2026-06-12 - Evolving set of high-quality web components for building business web applications.
* [Smart Web Components](https://github.com/HTMLElements/smart-webcomponents) ⭐ 478 | 🐛 12 | 🌐 CSS | 📅 2026-06-10 - Web components for business applications.
* [Apollo Elements](https://github.com/apollo-elements/apollo-elements) ⭐ 422 | 🐛 12 | 🌐 TypeScript | 📅 2026-06-13 - Custom elements for using Apollo GraphQL with various web components libraries.
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 273 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-12 - ELMS:LN produced web components for any project.
* [Wokwi Elements](https://github.com/wokwi/wokwi-elements) ⭐ 252 | 🐛 25 | 🌐 TypeScript | 📅 2026-06-08 - Web Components for Arduino and various electronic parts.
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 241 | 🐛 326 | 🌐 JavaScript | 📅 2026-06-12 - Collection of Web Components made by Clever Cloud.
* [Curvenote](https://github.com/curvenote/article) ⭐ 197 | 🐛 20 | 🌐 TypeScript | 📅 2025-05-14 - Web components for creating interactive scientific articles.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 167 | 🐛 65 | 🌐 TypeScript | 📅 2026-06-12 - Complete library of UI components from Infragistics.
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 148 | 🐛 56 | 🌐 TypeScript | 📅 2026-06-08 - Collection of user interface web components for Umbraco CMS.
* [Nightingale](https://github.com/ebi-webcomponents/nightingale) ⭐ 144 | 🐛 27 | 🌐 TypeScript | 📅 2026-04-29 - Data visualisation web components for the life sciences.
...
* [Blackstone UI](https://github.com/kjantzer/bui) ⭐ 111 | 🐛 17 | 🌐 JavaScript | 📅 2026-04-08 - Web components for creating interfaces by Blackstone Publishing.
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 105 | 🐛 3 | 🌐 JavaScript | 📅 2026-06-12 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 46 | 🌐 JavaScript | 📅 2026-06-12 - Collection of web components for building Brightspace applications.
* [Medblocks UI](https://github.com/medblocks/medblocks-ui) ⭐ 70 | 🐛 11 | 🌐 TypeScript | 📅 2025-05-29 - Web Components for rapid development of openEHR and FHIR systems.
...
* [One Platform Components](https://github.com/1-Platform/op-components) ⭐ 33 | 🐛 17 | 🌐 TypeScript | 📅 2026-06-11 - Set of web components for Red Hat One Platform.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 43 | 🌐 JavaScript | 📅 2026-06-13 - Components for building web applications with Nuxeo using Web Components.
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 45 | 🌐 TypeScript | 📅 2026-06-13 - A schema for mutation testing results with the web components to visualize it.
* [Titanium Elements](https://github.com/LeavittSoftware/titanium-elements) ⭐ 20 | 🐛 2 | 🌐 TypeScript | 📅 2026-06-03 - Collection of lightweight web components used by Leavitt Group Enterprises.
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 55 | 🌐 JavaScript | 📅 2026-06-08 - Collection of web components used by TEI Publisher and apps generated by it.
* [Tradeshift Elements](https://github.com/Tradeshift/elements) ⭐ 18 | 🐛 58 | 🌐 JavaScript | 📅 2026-06-01 - Reusable Tradeshift UI Components as Web Components.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 59 | 🌐 TypeScript | 📅 2026-06-11 - Ser of web components used by Equinor Fusion.
* [Furo Webcomponents](https://github.com/eclipse/eclipsefuro-web) ⭐ 12 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-12 - Enterprise ready set of web components which work best with Eclipse Furo.
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 11 | 🐛 9 | 🌐 JavaScript | 📅 2026-06-11 - Web components library for Sme.UP.
...
* [Burnish Components](https://github.com/danfking/burnish/tree/main/packages/components) ⭐ 2 | 🐛 7 | 🌐 TypeScript | 📅 2026-06-04 - Web components for rendering MCP tool-call output as UI.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,049 | 🐛 736 | 🌐 TypeScript | 📅 2026-06-12 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 11,017 | 🐛 170 | 🌐 SCSS | 📅 2026-06-10 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,657 | 🐛 87 | 🌐 TypeScript | 📅 2026-06-12 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,754 | 🐛 239 | 🌐 TypeScript | 📅 2026-06-13 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,518 | 🐛 250 | 🌐 TypeScript | 📅 2026-06-12 - Adobe Spectrum design language implementation built with Web Components.
...
* [PatternFly Elements](https://github.com/patternfly/patternfly-elements) ⭐ 391 | 🐛 172 | 🌐 TypeScript | 📅 2026-06-12 - Collection of flexible and lightweight Web Components based on the Unified Design Kit.
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 365 | 🐛 903 | 🌐 TypeScript | 📅 2026-06-13 - Shared Web Components for Esri's Calcite design framework.
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 349 | 🐛 87 | 🌐 TypeScript | 📅 2026-06-12 - Web Components implementing Siemens iX design system.
...
* [Crayons](https://github.com/freshdesk/crayons) ⭐ 247 | 🐛 47 | 🌐 JavaScript | 📅 2026-05-27 - Collection of web components that adheres to the Freshworks Design System.
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 211 | 🐛 64 | 🌐 SCSS | 📅 2026-06-12 - Set of UI components based on Momentum Design.
...
* [Astro Space UX Design System](https://github.com/RocketCommunicationsInc/astro) ⭐ 150 | 🐛 67 | 🌐 TypeScript | 📅 2026-06-11 - Set of components to build rich space app experiences with established interaction patterns.
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 138 | 🐛 194 | 🌐 HTML | 📅 2026-06-12 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 130 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 130 | 🐛 76 | 🌐 TypeScript | 📅 2026-06-12 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
* [Liquid](https://github.com/emdgroup-liquid/liquid) ⭐ 85 | 🐛 24 | 🌐 TypeScript | 📅 2026-05-21 - UI component library based on the Liquid Design System.
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 68 | 🐛 54 | 🌐 TypeScript | 📅 2026-06-12 - Library of Web Components adhering to the Forge Design System.
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 65 | 🐛 56 | 🌐 TypeScript | 📅 2026-06-13 - Building blocks of the Lyne Design System are based on Web Components.
...
* [NVIDIA Elements](https://github.com/nvidia/elements) ⭐ 14 | 🐛 3 | 🌐 TypeScript | 📅 2026-06-13 - The Design Language and UI Agent Harness for AI/ML Factories, Robotics, and Autonomous Vehicles.
...
* [Omi](https://github.com/Tencent/omi) ⭐ 13,258 | 🐛 70 | 🌐 TypeScript | 📅 2026-03-27 - Next generation web framework in 4kb JavaScript (Web Components + JSX + Proxy + Store + Path Updating).
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,098 | 🐛 186 | 🌐 TypeScript | 📅 2026-06-12 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,657 | 🐛 87 | 🌐 TypeScript | 📅 2026-06-12 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,767 | 🐛 410 | 🌐 JavaScript | 📅 2026-06-10 - blazing fast, enterprise-grade Web Components foundation.
...
* [Tonic](https://github.com/optoolco/tonic) ⭐ 885 | 🐛 12 | 🌐 JavaScript | 📅 2026-05-08 - Minimalist, stable, audit friendly component framework.
* [Panel](https://github.com/mixpanel/panel) ⭐ 273 | 🐛 20 | 🌐 JavaScript | 📅 2026-06-05 - Web Components + Virtual DOM: web standards for powerful UIs.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 134 | 🐛 6 | 🌐 TypeScript | 📅 2026-06-10 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [DNA](https://github.com/chialab/dna) ⭐ 60 | 🐛 3 | 🌐 TypeScript | 📅 2026-06-01 - Progressive Web Components library.
* [element-js](https://github.com/webtides/element-js) ⭐ 30 | 🐛 23 | 🌐 JavaScript | 📅 2026-04-21 - Simple and lightweight base classes for web components with a beautiful API.
* [Forge Core](https://github.com/tyler-technologies-oss/forge-core) ⭐ 6 | 🐛 11 | 🌐 TypeScript | 📅 2026-01-22 - Building blocks and utilities that are used when building Forge Web Components.
* [Lit](https://lit.dev) - Simple library for building fast, lightweight web components.

### Functional

* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,614 | 🐛 57 | 🌐 TypeScript | 📅 2026-06-13 - Library that extends Solid adding Custom Web Components and extensions.
* [hybrids](https://github.com/hybridsjs/hybrids) ⭐ 3,176 | 🐛 13 | 🌐 JavaScript | 📅 2026-06-12 - UI library for creating Web Components with simple and functional API.
* [haunted](https://github.com/matthewp/haunted) ⭐ 2,719 | 🐛 62 | 🌐 TypeScript | 📅 2026-05-28 - React's Hooks API implemented for web components.
* [atomico](https://github.com/atomicojs/atomico) ⭐ 1,273 | 🐛 18 | 🌐 TypeScript | 📅 2026-06-05 - Small library for the creation of interfaces based on web components using functions and hooks.
...
* [react-shadow](https://github.com/Wildhoney/ReactShadow) ⭐ 1,381 | 🐛 40 | 🌐 JavaScript | 📅 2025-01-09 - Utilise Shadow DOM in React with all the benefits of style encapsulation.
* [remount](https://github.com/rstacruz/remount) ⭐ 721 | 🐛 11 | 🌐 JavaScript | 📅 2023-03-08 - Mount React components to the DOM using custom elements.
* [preact-custom-element](https://github.com/preactjs/preact-custom-element) ⭐ 402 | 🐛 14 | 🌐 JavaScript | 📅 2026-04-21 - Generate/register a custom element from a preact component.
...
* [nuxt-custom-elements](https://github.com/GrabarzUndPartner/nuxt-custom-elements) ⭐ 83 | 🐛 15 | 🌐 JavaScript | 📅 2026-06-11 - Export your project components as custom elements for integration into external pages.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,905 | 🐛 1,018 | 🌐 JavaScript | 📅 2026-05-20 - Web component framework to easily create user-first experiences for the web.
* [WebC](https://github.com/11ty/webc) ⭐ 1,406 | 🐛 65 | 🌐 JavaScript | 📅 2025-12-02 - Framework-independent standalone HTML serializer for generating markup for web components.
* [Web Components Compiler](https://github.com/ProjectEvergreen/wcc) ⭐ 125 | 🐛 25 | 🌐 JavaScript | 📅 2026-06-11 - Compiler to make server-side rendering of native web components easier.
...
* [custom-element-boilerplate](https://github.com/github/custom-element-boilerplate) ⭐ 177 | 🐛 1 | 🌐 TypeScript | 📅 2025-10-30 - Boilerplate for creating a custom element.
...
* [hello-web-components](https://github.com/fernandopasik/hello-web-components) ⭐ 32 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-15 - Simple starter hello world web component written in TypeScript.
* [Create Open Web Components](https://open-wc.org/docs/development/generator/) - Web component project scaffolding.

### Testing Solutions

* [query-selector-shadow-dom](https://github.com/webdriverio/query-selector-shadow-dom) ⭐ 262 | 🐛 23 | 🌐 JavaScript | 📅 2024-03-27 - querySelector that can pierce Shadow DOM roots, useful for automated testing.
* [shadow-automation-selenium](https://github.com/sukgu/shadow-automation-selenium) ⭐ 116 | 🐛 13 | 🌐 Java | 📅 2026-02-23 - Shadow DOM automation using Selenium.
* [cypress-lit](https://github.com/simonireilly/cypress-lit) ⭐ 25 | 🐛 13 | 🌐 TypeScript | 📅 2026-06-12 - Test your Lit elements and native web components in Cypress with all the modern browsers.
...
* [web-component-analyzer](https://github.com/runem/web-component-analyzer) ⭐ 518 | 🐛 96 | 🌐 TypeScript | 📅 2023-11-24 - CLI that analyzes web components and emits documentation / diagnostics.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 36 | 🌐 JavaScript | 📅 2026-06-12 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,931 | 🐛 2,781 | 🌐 HTML | 📅 2026-06-13

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,931 | 🐛 2,781 | 🌐 HTML | 📅 2026-06-13
...
* [`ElementInternals`'s `states` property and the `:state()` pseudo class](https://github.com/w3c/webcomponents/blob/gh-pages/proposals/custom-states-and-state-pseudo-class.md) ⭐ 4,491 | 🐛 205 | 🌐 HTML | 📅 2025-12-09

## Miscellaneous

* [bruck](https://github.com/Heydon/bruck) ⭐ 516 | 🐛 2 | 🌐 JavaScript | 📅 2023-08-25 - Prototyping system built with web components and the Houdini Paint API.
...
* [@webcomponents/custom-elements](https://github.com/webcomponents/polyfills/tree/master/packages/custom-elements) ⭐ 1,188 | 🐛 150 | 🌐 HTML | 📅 2026-06-05 - Custom Elements polyfill by Polymer team.
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,767 | 🐛 410 | 🌐 JavaScript | 📅 2026-06-10 - Shadow DOM polyfill by [LWC](https://lwc.dev).
* [@webcomponents/shadydom](https://github.com/webcomponents/polyfills/tree/master/packages/shadydom) ⭐ 1,188 | 🐛 150 | 🌐 HTML | 📅 2026-06-05 - ShadowDOM v1 shim.
* [@webcomponents/shadycss](https://github.com/webcomponents/polyfills/tree/master/packages/shadycss) ⭐ 1,188 | 🐛 150 | 🌐 HTML | 📅 2026-06-05 - ShadowDOM style encapsulation shim.

#### HTML Templates polyfills

* [@webcomponents/template](https://github.com/webcomponents/polyfills/tree/master/packages/template) ⭐ 1,188 | 🐛 150 | 🌐 HTML | 📅 2026-06-05 - Minimal polyfill for `<template>`.
...
* [HTML as Custom Elements](https://github.com/domenic/html-as-custom-elements) ⭐ 262 | 🐛 14 | 🌐 CSS | 📅 2015-09-03
