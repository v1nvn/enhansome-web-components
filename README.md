...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,902 | 🐛 2,790 | 🌐 HTML | 📅 2026-04-27
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,902 | 🐛 2,790 | 🌐 HTML | 📅 2026-04-27
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,902 | 🐛 2,790 | 🌐 HTML | 📅 2026-04-27
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,902 | 🐛 2,790 | 🌐 HTML | 📅 2026-04-27
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,940 | 🐛 184 | 🌐 JavaScript | 📅 2026-04-25 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,027 | 🐛 112 | 🌐 TypeScript | 📅 2026-04-17 - Web component for rendering interactive 3D models.
* [`<lite-youtube>`](https://github.com/paulirish/lite-youtube-embed) ⭐ 6,311 | 🐛 29 | 🌐 HTML | 📅 2025-11-10 - Lite YouTube embed with a focus on visual performance.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,590 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-22 - Web component for chat with AI capabilities.
...
* [`<api-viewer>`](https://github.com/web-padawan/api-viewer-element) ⭐ 283 | 🐛 20 | 🌐 TypeScript | 📅 2026-04-24 - API documentation and live playground for Web Components.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,482 | 🐛 20 | 🌐 JavaScript | 📅 2026-04-25 quickly into your page using custom elements.
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 137 | 🐛 5 | 🌐 TypeScript | 📅 2026-04-21 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,910 | 🐛 1,007 | 🌐 JavaScript | 📅 2026-04-15 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
...
* [LDRS](https://github.com/GriffinJohnston/ldrs) ⭐ 2,172 | 🐛 1 | 🌐 TypeScript | 📅 2025-10-22 - Lightweight, customizable loading animations/spinners.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 801 | 🐛 7 | 🌐 TypeScript | 📅 2026-04-26 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 562 | 🐛 952 | 🌐 JavaScript | 📅 2026-04-24 - Evolving set of high-quality web components for building business web applications.
* [Smart Web Components](https://github.com/HTMLElements/smart-webcomponents) ⭐ 474 | 🐛 6 | 🌐 CSS | 📅 2026-02-03 - Web components for business applications.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 271 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-27 - ELMS:LN produced web components for any project.
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 241 | 🐛 328 | 🌐 JavaScript | 📅 2026-04-24 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 166 | 🐛 69 | 🌐 TypeScript | 📅 2026-04-24 - Complete library of UI components from Infragistics.
...
* [Nightingale](https://github.com/ebi-webcomponents/nightingale) ⭐ 143 | 🐛 27 | 🌐 TypeScript | 📅 2026-04-24 - Data visualisation web components for the life sciences.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 58 | 🌐 JavaScript | 📅 2026-04-24 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 34 | 🌐 JavaScript | 📅 2026-04-27 - Components for building web applications with Nuxeo using Web Components.
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 49 | 🌐 TypeScript | 📅 2026-04-27 - A schema for mutation testing results with the web components to visualize it.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 16 | 🌐 TypeScript | 📅 2026-04-24 - Ser of web components used by Equinor Fusion.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,948 | 🐛 691 | 🌐 TypeScript | 📅 2026-04-25 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,904 | 🐛 163 | 🌐 SCSS | 📅 2026-04-24 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,646 | 🐛 75 | 🌐 TypeScript | 📅 2026-04-27 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,735 | 🐛 273 | 🌐 TypeScript | 📅 2026-04-27 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,506 | 🐛 244 | 🌐 TypeScript | 📅 2026-04-25 - Adobe Spectrum design language implementation built with Web Components.
...
* [PatternFly Elements](https://github.com/patternfly/patternfly-elements) ⭐ 390 | 🐛 197 | 🌐 TypeScript | 📅 2026-04-26 - Collection of flexible and lightweight Web Components based on the Unified Design Kit.
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 353 | 🐛 890 | 🌐 TypeScript | 📅 2026-04-27 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 339 | 🐛 83 | 🌐 TypeScript | 📅 2026-04-27 - Web Components implementing Siemens iX design system.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 212 | 🐛 65 | 🌐 SCSS | 📅 2026-04-24 - Set of UI components based on Momentum Design.
...
* [Astro Space UX Design System](https://github.com/RocketCommunicationsInc/astro) ⭐ 150 | 🐛 58 | 🌐 TypeScript | 📅 2026-04-24 - Set of components to build rich space app experiences with established interaction patterns.
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 134 | 🐛 169 | 🌐 HTML | 📅 2026-04-24 - Web components for building uniform experiences with the Red Hat brand.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 67 | 🐛 42 | 🌐 TypeScript | 📅 2026-04-24 - Library of Web Components adhering to the Forge Design System.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 73 | 🌐 TypeScript | 📅 2026-04-27 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,080 | 🐛 177 | 🌐 TypeScript | 📅 2026-04-25 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,646 | 🐛 75 | 🌐 TypeScript | 📅 2026-04-27 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,764 | 🐛 420 | 🌐 JavaScript | 📅 2026-04-24 - blazing fast, enterprise-grade Web Components foundation.
...
* [Tonic](https://github.com/optoolco/tonic) ⭐ 887 | 🐛 16 | 🌐 JavaScript | 📅 2026-02-06 - Minimalist, stable, audit friendly component framework.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,464 | 🐛 82 | 🌐 TypeScript | 📅 2026-04-25 - Library that extends Solid adding Custom Web Components and extensions.
...
* [atomico](https://github.com/atomicojs/atomico) ⭐ 1,267 | 🐛 17 | 🌐 TypeScript | 📅 2026-04-20 - Small library for the creation of interfaces based on web components using functions and hooks.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,910 | 🐛 1,007 | 🌐 JavaScript | 📅 2026-04-15 - Web component framework to easily create user-first experiences for the web.
* [WebC](https://github.com/11ty/webc) ⭐ 1,408 | 🐛 65 | 🌐 JavaScript | 📅 2025-12-02 - Framework-independent standalone HTML serializer for generating markup for web components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,902 | 🐛 2,790 | 🌐 HTML | 📅 2026-04-27

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,902 | 🐛 2,790 | 🌐 HTML | 📅 2026-04-27
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,764 | 🐛 420 | 🌐 JavaScript | 📅 2026-04-24 - Shadow DOM polyfill by [LWC](https://lwc.dev).
