...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,768 | 🐛 2,703 | 🌐 HTML | 📅 2026-02-09
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,768 | 🐛 2,703 | 🌐 HTML | 📅 2026-02-09
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,768 | 🐛 2,703 | 🌐 HTML | 📅 2026-02-09
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,768 | 🐛 2,703 | 🌐 HTML | 📅 2026-02-09
...
* [web-components-examples](https://github.com/mdn/web-components-examples) ⭐ 3,356 | 🐛 4 | 🌐 JavaScript | 📅 2026-01-13 - Series of web components examples, related to the MDN web components documentation.
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,903 | 🐛 173 | 🌐 JavaScript | 📅 2026-01-09 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 7,893 | 🐛 115 | 🌐 TypeScript | 📅 2026-02-03 - Web component for rendering interactive 3D models.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,521 | 🐛 21 | 🌐 TypeScript | 📅 2026-02-05 - Web component for chat with AI capabilities.
...
* [`<rapi-doc>`](https://github.com/mrin9/RapiDoc) ⭐ 1,879 | 🐛 130 | 🌐 JavaScript | 📅 2026-02-07 - Web component for creating documentation from OpenAPI Specification.
...
* [`<midi-player>`](https://github.com/cifkao/html-midi-player) ⭐ 851 | 🐛 19 | 🌐 TypeScript | 📅 2025-07-06 - MIDI file player and visualizer web components.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,406 | 🐛 17 | 🌐 JavaScript | 📅 2026-02-03 quickly into your page using custom elements.
...
* [Shoelace](https://github.com/shoelace-style/shoelace) ⭐ 13,847 | 🐛 102 | 🌐 TypeScript | 📅 2025-10-29 - A forward-thinking library of web components.
* [Wired Elements](https://github.com/wiredjs/wired-elements) ⭐ 10,751 | 🐛 35 | 🌐 TypeScript | 📅 2023-10-07 - Set of common UI elements with a hand-drawn, sketchy look.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,930 | 🐛 159 | 🌐 JavaScript | 📅 2026-02-08 - Set of highly performant, accessible and flexible Web Components.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,842 | 🐛 651 | 🌐 TypeScript | 📅 2026-02-07 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,725 | 🐛 162 | 🌐 SCSS | 📅 2026-02-02 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,614 | 🐛 89 | 🌐 TypeScript | 📅 2026-02-09 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,719 | 🐛 281 | 🌐 TypeScript | 📅 2026-02-09 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 346 | 🐛 845 | 🌐 TypeScript | 📅 2026-02-09 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 319 | 🐛 80 | 🌐 TypeScript | 📅 2026-02-08 - Web Components implementing Siemens iX design system.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 135 | 🐛 241 | 🌐 HTML | 📅 2026-02-08 - Web components for building uniform experiences with the Red Hat brand.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 59 | 🐛 71 | 🌐 TypeScript | 📅 2026-02-09 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,020 | 🐛 163 | 🌐 TypeScript | 📅 2026-02-08 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,614 | 🐛 89 | 🌐 TypeScript | 📅 2026-02-09 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,067 | 🐛 130 | 🌐 TypeScript | 📅 2026-01-26 - Library that extends Solid adding Custom Web Components and extensions.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,768 | 🐛 2,703 | 🌐 HTML | 📅 2026-02-09

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,768 | 🐛 2,703 | 🌐 HTML | 📅 2026-02-09
