...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,930 | 🐛 2,773 | 🌐 HTML | 📅 2026-06-12
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,930 | 🐛 2,773 | 🌐 HTML | 📅 2026-06-12
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,930 | 🐛 2,773 | 🌐 HTML | 📅 2026-06-12
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,930 | 🐛 2,773 | 🌐 HTML | 📅 2026-06-12
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,964 | 🐛 175 | 🌐 JavaScript | 📅 2026-06-09 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,121 | 🐛 117 | 🌐 TypeScript | 📅 2026-06-11 - Web component for rendering interactive 3D models.
* [`<lite-youtube>`](https://github.com/paulirish/lite-youtube-embed) ⭐ 6,323 | 🐛 28 | 🌐 HTML | 📅 2025-11-10 - Lite YouTube embed with a focus on visual performance.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,637 | 🐛 35 | 🌐 TypeScript | 📅 2026-06-10 - Web component for chat with AI capabilities.
...
* [`<dark-mode-toggle>`](https://github.com/GoogleChromeLabs/dark-mode-toggle) ⭐ 1,222 | 🐛 8 | 🌐 JavaScript | 📅 2026-05-23 - Custom element that allows to create a dark mode toggle or switch.
* [`<midi-player>`](https://github.com/cifkao/html-midi-player) ⭐ 882 | 🐛 21 | 🌐 TypeScript | 📅 2025-07-06 - MIDI file player and visualizer web components.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,528 | 🐛 19 | 🌐 JavaScript | 📅 2026-06-10 quickly into your page using custom elements.
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 161 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-12 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,904 | 🐛 1,018 | 🌐 JavaScript | 📅 2026-05-20 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
...
* [github-elements](https://github.com/github/github-elements) ⭐ 2,908 | 🐛 1 | 🌐 JavaScript | 📅 2025-12-08 - GitHub's Web Component collection.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 814 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-02 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 565 | 🐛 941 | 🌐 JavaScript | 📅 2026-06-11 - Evolving set of high-quality web components for building business web applications.
...
* [Apollo Elements](https://github.com/apollo-elements/apollo-elements) ⭐ 422 | 🐛 11 | 🌐 TypeScript | 📅 2026-06-10 - Custom elements for using Apollo GraphQL with various web components libraries.
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 273 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-11 - ELMS:LN produced web components for any project.
...
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 241 | 🐛 326 | 🌐 JavaScript | 📅 2026-06-11 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 167 | 🐛 65 | 🌐 TypeScript | 📅 2026-06-11 - Complete library of UI components from Infragistics.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 105 | 🐛 3 | 🌐 JavaScript | 📅 2026-06-11 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 46 | 🌐 JavaScript | 📅 2026-06-11 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 43 | 🌐 JavaScript | 📅 2026-06-12 - Components for building web applications with Nuxeo using Web Components.
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 45 | 🌐 TypeScript | 📅 2026-06-10 - A schema for mutation testing results with the web components to visualize it.
...
* [Furo Webcomponents](https://github.com/eclipse/eclipsefuro-web) ⭐ 12 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-08 - Enterprise ready set of web components which work best with Eclipse Furo.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,046 | 🐛 735 | 🌐 TypeScript | 📅 2026-06-12 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 11,015 | 🐛 170 | 🌐 SCSS | 📅 2026-06-10 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,656 | 🐛 96 | 🌐 TypeScript | 📅 2026-06-12 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,754 | 🐛 236 | 🌐 TypeScript | 📅 2026-06-12 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,518 | 🐛 253 | 🌐 TypeScript | 📅 2026-06-12 - Adobe Spectrum design language implementation built with Web Components.
...
* [PatternFly Elements](https://github.com/patternfly/patternfly-elements) ⭐ 391 | 🐛 172 | 🌐 TypeScript | 📅 2026-06-11 - Collection of flexible and lightweight Web Components based on the Unified Design Kit.
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 365 | 🐛 899 | 🌐 TypeScript | 📅 2026-06-12 - Shared Web Components for Esri's Calcite design framework.
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 348 | 🐛 88 | 🌐 TypeScript | 📅 2026-06-12 - Web Components implementing Siemens iX design system.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 211 | 🐛 65 | 🌐 SCSS | 📅 2026-06-11 - Set of UI components based on Momentum Design.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 138 | 🐛 193 | 🌐 HTML | 📅 2026-06-11 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 130 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 130 | 🐛 73 | 🌐 TypeScript | 📅 2026-06-11 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 68 | 🐛 52 | 🌐 TypeScript | 📅 2026-06-11 - Library of Web Components adhering to the Forge Design System.
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 65 | 🐛 55 | 🌐 TypeScript | 📅 2026-06-12 - Building blocks of the Lyne Design System are based on Web Components.
...
* [NVIDIA Elements](https://github.com/nvidia/elements) ⭐ 14 | 🐛 4 | 🌐 TypeScript | 📅 2026-06-12 - The Design Language and UI Agent Harness for AI/ML Factories, Robotics, and Autonomous Vehicles.
...
* [Omi](https://github.com/Tencent/omi) ⭐ 13,257 | 🐛 70 | 🌐 TypeScript | 📅 2026-03-27 - Next generation web framework in 4kb JavaScript (Web Components + JSX + Proxy + Store + Path Updating).
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,098 | 🐛 187 | 🌐 TypeScript | 📅 2026-06-08 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,656 | 🐛 96 | 🌐 TypeScript | 📅 2026-06-12 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,766 | 🐛 410 | 🌐 JavaScript | 📅 2026-06-10 - blazing fast, enterprise-grade Web Components foundation.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,609 | 🐛 48 | 🌐 TypeScript | 📅 2026-06-11 - Library that extends Solid adding Custom Web Components and extensions.
* [hybrids](https://github.com/hybridsjs/hybrids) ⭐ 3,175 | 🐛 12 | 🌐 JavaScript | 📅 2026-05-21 - UI library for creating Web Components with simple and functional API.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,904 | 🐛 1,018 | 🌐 JavaScript | 📅 2026-05-20 - Web component framework to easily create user-first experiences for the web.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 36 | 🌐 JavaScript | 📅 2026-06-11 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,930 | 🐛 2,773 | 🌐 HTML | 📅 2026-06-12

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,930 | 🐛 2,773 | 🌐 HTML | 📅 2026-06-12
...
* [`ElementInternals`'s `states` property and the `:state()` pseudo class](https://github.com/w3c/webcomponents/blob/gh-pages/proposals/custom-states-and-state-pseudo-class.md) ⭐ 4,490 | 🐛 205 | 🌐 HTML | 📅 2025-12-09
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,766 | 🐛 410 | 🌐 JavaScript | 📅 2026-06-10 - Shadow DOM polyfill by [LWC](https://lwc.dev).
