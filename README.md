...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,874 | 🐛 2,777 | 🌐 HTML | 📅 2026-04-10
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,874 | 🐛 2,777 | 🌐 HTML | 📅 2026-04-10
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,874 | 🐛 2,777 | 🌐 HTML | 📅 2026-04-10
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,874 | 🐛 2,777 | 🌐 HTML | 📅 2026-04-10
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,932 | 🐛 183 | 🌐 JavaScript | 📅 2026-04-04 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 7,991 | 🐛 111 | 🌐 TypeScript | 📅 2026-04-07 - Web component for rendering interactive 3D models.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,579 | 🐛 29 | 🌐 TypeScript | 📅 2026-04-07 - Web component for chat with AI capabilities.
...
* [`<emoji-picker>`](https://github.com/nolanlawson/emoji-picker-element) ⭐ 1,723 | 🐛 35 | 🌐 JavaScript | 📅 2026-04-09 - Lightweight emoji picker, distributed as a web component.
...
* [`<midi-player>`](https://github.com/cifkao/html-midi-player) ⭐ 866 | 🐛 21 | 🌐 TypeScript | 📅 2025-07-06 - MIDI file player and visualizer web components.
...
* [`<api-viewer>`](https://github.com/web-padawan/api-viewer-element) ⭐ 283 | 🐛 20 | 🌐 TypeScript | 📅 2026-04-10 - API documentation and live playground for Web Components.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,458 | 🐛 21 | 🌐 JavaScript | 📅 2026-04-08 quickly into your page using custom elements.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,916 | 🐛 1,008 | 🌐 JavaScript | 📅 2026-04-09 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
...
* [Microsoft Graph Toolkit](https://github.com/microsoftgraph/microsoft-graph-toolkit) ⭐ 1,049 | 🐛 186 | 🌐 TypeScript | 📅 2026-02-28 - Collection of web components for the Microsoft Graph.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 792 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-27 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 560 | 🐛 943 | 🌐 JavaScript | 📅 2026-04-10 - Evolving set of high-quality web components for building business web applications.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 271 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-09 - ELMS:LN produced web components for any project.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 103 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-09 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 77 | 🐛 46 | 🌐 JavaScript | 📅 2026-04-09 - Collection of web components for building Brightspace applications.
...
* [TrendChart Elements](https://github.com/WebLogin/trendchart-elements) ⭐ 63 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-08 - Components to generate simple, light and responsive charts.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 27 | 🌐 JavaScript | 📅 2026-04-09 - Components for building web applications with Nuxeo using Web Components.
...
* [Titanium Elements](https://github.com/LeavittSoftware/titanium-elements) ⭐ 19 | 🐛 5 | 🌐 TypeScript | 📅 2026-04-09 - Collection of lightweight web components used by Leavitt Group Enterprises.
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 57 | 🌐 JavaScript | 📅 2026-04-10 - Collection of web components used by TEI Publisher and apps generated by it.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 18 | 🌐 TypeScript | 📅 2026-04-09 - Ser of web components used by Equinor Fusion.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 12 | 🐛 8 | 🌐 JavaScript | 📅 2026-04-09 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,919 | 🐛 673 | 🌐 TypeScript | 📅 2026-04-09 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,856 | 🐛 164 | 🌐 SCSS | 📅 2026-04-10 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,640 | 🐛 88 | 🌐 TypeScript | 📅 2026-04-10 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,730 | 🐛 286 | 🌐 TypeScript | 📅 2026-04-10 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,501 | 🐛 251 | 🌐 TypeScript | 📅 2026-04-09 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 351 | 🐛 876 | 🌐 TypeScript | 📅 2026-04-10 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 332 | 🐛 78 | 🌐 TypeScript | 📅 2026-04-09 - Web Components implementing Siemens iX design system.
...
* [Astro Space UX Design System](https://github.com/RocketCommunicationsInc/astro) ⭐ 149 | 🐛 52 | 🌐 TypeScript | 📅 2026-04-10 - Set of components to build rich space app experiences with established interaction patterns.
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 133 | 🐛 171 | 🌐 HTML | 📅 2026-04-09 - Web components for building uniform experiences with the Red Hat brand.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 66 | 🐛 38 | 🌐 TypeScript | 📅 2026-04-09 - Library of Web Components adhering to the Forge Design System.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 81 | 🌐 TypeScript | 📅 2026-04-10 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Omi](https://github.com/Tencent/omi) ⭐ 13,256 | 🐛 70 | 🌐 TypeScript | 📅 2026-03-27 - Next generation web framework in 4kb JavaScript (Web Components + JSX + Proxy + Store + Path Updating).
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,052 | 🐛 175 | 🌐 TypeScript | 📅 2026-04-09 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,640 | 🐛 88 | 🌐 TypeScript | 📅 2026-04-10 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,761 | 🐛 419 | 🌐 JavaScript | 📅 2026-04-09 - blazing fast, enterprise-grade Web Components foundation.
...
* [Lume Element](https://github.com/lume/element) ⭐ 185 | 🐛 30 | 🌐 TypeScript | 📅 2026-04-09 - Write custom elements with reactivity and templating powered by Solid.js signals and effects.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 134 | 🐛 8 | 🌐 TypeScript | 📅 2026-04-08 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,386 | 🐛 118 | 🌐 TypeScript | 📅 2026-04-06 - Library that extends Solid adding Custom Web Components and extensions.
* [hybrids](https://github.com/hybridsjs/hybrids) ⭐ 3,170 | 🐛 11 | 🌐 JavaScript | 📅 2026-01-07 - UI library for creating Web Components with simple and functional API.
...
* [react-shadow](https://github.com/Wildhoney/ReactShadow) ⭐ 1,379 | 🐛 40 | 🌐 JavaScript | 📅 2025-01-09 - Utilise Shadow DOM in React with all the benefits of style encapsulation.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,916 | 🐛 1,008 | 🌐 JavaScript | 📅 2026-04-09 - Web component framework to easily create user-first experiences for the web.
...
* [hello-web-components](https://github.com/fernandopasik/hello-web-components) ⭐ 31 | 🐛 5 | 🌐 TypeScript | 📅 2026-04-10 - Simple starter hello world web component written in TypeScript.
...
* [cypress-lit](https://github.com/simonireilly/cypress-lit) ⭐ 25 | 🐛 13 | 🌐 TypeScript | 📅 2026-04-09 - Test your Lit elements and native web components in Cypress with all the modern browsers.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,874 | 🐛 2,777 | 🌐 HTML | 📅 2026-04-10

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,874 | 🐛 2,777 | 🌐 HTML | 📅 2026-04-10
...
* [@webcomponents/custom-elements](https://github.com/webcomponents/polyfills/tree/master/packages/custom-elements) ⭐ 1,185 | 🐛 148 | 🌐 HTML | 📅 2026-04-09 - Custom Elements polyfill by Polymer team.
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,761 | 🐛 419 | 🌐 JavaScript | 📅 2026-04-09 - Shadow DOM polyfill by [LWC](https://lwc.dev).
* [@webcomponents/shadydom](https://github.com/webcomponents/polyfills/tree/master/packages/shadydom) ⭐ 1,185 | 🐛 148 | 🌐 HTML | 📅 2026-04-09 - ShadowDOM v1 shim.
* [@webcomponents/shadycss](https://github.com/webcomponents/polyfills/tree/master/packages/shadycss) ⭐ 1,185 | 🐛 148 | 🌐 HTML | 📅 2026-04-09 - ShadowDOM style encapsulation shim.

#### HTML Templates polyfills

* [@webcomponents/template](https://github.com/webcomponents/polyfills/tree/master/packages/template) ⭐ 1,185 | 🐛 148 | 🌐 HTML | 📅 2026-04-09 - Minimal polyfill for `<template>`.
