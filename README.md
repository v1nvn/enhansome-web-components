...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,834 | 🐛 2,741 | 🌐 HTML | 📅 2026-03-19
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,834 | 🐛 2,741 | 🌐 HTML | 📅 2026-03-19
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,834 | 🐛 2,741 | 🌐 HTML | 📅 2026-03-19
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,834 | 🐛 2,741 | 🌐 HTML | 📅 2026-03-19
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,933 | 🐛 172 | 🌐 JavaScript | 📅 2026-03-11 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 7,960 | 🐛 114 | 🌐 TypeScript | 📅 2026-03-13 - Web component for rendering interactive 3D models.
* [`<lite-youtube>`](https://github.com/paulirish/lite-youtube-embed) ⭐ 6,299 | 🐛 28 | 🌐 HTML | 📅 2025-11-10 - Lite YouTube embed with a focus on visual performance.
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 5,977 | 🐛 7 | 🌐 JavaScript | 📅 2026-03-07 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,558 | 🐛 28 | 🌐 TypeScript | 📅 2026-03-17 - Web component for chat with AI capabilities.
...
* [`<rapi-doc>`](https://github.com/mrin9/RapiDoc) ⭐ 1,884 | 🐛 132 | 🌐 JavaScript | 📅 2026-02-11 - Web component for creating documentation from OpenAPI Specification.
...
* [`<dark-mode-toggle>`](https://github.com/GoogleChromeLabs/dark-mode-toggle) ⭐ 1,216 | 🐛 4 | 🌐 JavaScript | 📅 2026-02-14 - Custom element that allows to create a dark mode toggle or switch.
...
* [`<active-table>`](https://github.com/OvidijusParsiunas/active-table) ⭐ 313 | 🐛 27 | 🌐 TypeScript | 📅 2026-02-26 - Editable table web component.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,447 | 🐛 21 | 🌐 JavaScript | 📅 2026-03-18 quickly into your page using custom elements.
...
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 122 | 🐛 4 | 🌐 TypeScript | 📅 2026-03-18 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,921 | 🐛 1,008 | 🌐 JavaScript | 📅 2026-03-04 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
* [Shoelace](https://github.com/shoelace-style/shoelace) ⭐ 13,875 | 🐛 105 | 🌐 TypeScript | 📅 2026-03-05 - A forward-thinking library of web components.
* [Wired Elements](https://github.com/wiredjs/wired-elements) ⭐ 10,765 | 🐛 35 | 🌐 TypeScript | 📅 2023-10-07 - Set of common UI elements with a hand-drawn, sketchy look.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,936 | 🐛 172 | 🌐 JavaScript | 📅 2026-03-18 - Set of highly performant, accessible and flexible Web Components.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 785 | 🐛 11 | 🌐 TypeScript | 📅 2026-03-16 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 556 | 🐛 938 | 🌐 JavaScript | 📅 2026-03-18 - Evolving set of high-quality web components for building business web applications.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 270 | 🐛 1 | 🌐 JavaScript | 📅 2026-03-18 - ELMS:LN produced web components for any project.
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 327 | 🌐 JavaScript | 📅 2026-03-18 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 166 | 🐛 68 | 🌐 TypeScript | 📅 2026-03-17 - Complete library of UI components from Infragistics.
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 145 | 🐛 46 | 🌐 TypeScript | 📅 2026-03-17 - Collection of user interface web components for Umbraco CMS.
...
* [Blackstone UI](https://github.com/kjantzer/bui) ⭐ 109 | 🐛 17 | 🌐 JavaScript | 📅 2026-03-12 - Web components for creating interfaces by Blackstone Publishing.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 38 | 🌐 JavaScript | 📅 2026-03-18 - Collection of web components for building Brightspace applications.
...
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 45 | 🌐 TypeScript | 📅 2026-03-17 - A schema for mutation testing results with the web components to visualize it.
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 27 | 🐛 27 | 🌐 JavaScript | 📅 2026-03-18 - Components for building web applications with Nuxeo using Web Components.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 13 | 🌐 TypeScript | 📅 2026-03-16 - Ser of web components used by Equinor Fusion.
* [Furo Webcomponents](https://github.com/eclipse/eclipsefuro-web) ⭐ 12 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-18 - Enterprise ready set of web components which work best with Eclipse Furo.
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 12 | 🐛 7 | 🌐 JavaScript | 📅 2026-03-16 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,879 | 🐛 669 | 🌐 TypeScript | 📅 2026-03-18 - Library of Web Components that supports Microsoft's Fluent design language.
...
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,640 | 🐛 80 | 🌐 TypeScript | 📅 2026-03-19 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,728 | 🐛 281 | 🌐 TypeScript | 📅 2026-03-19 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,494 | 🐛 227 | 🌐 TypeScript | 📅 2026-03-18 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 349 | 🐛 875 | 🌐 TypeScript | 📅 2026-03-19 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 331 | 🐛 95 | 🌐 TypeScript | 📅 2026-03-18 - Web Components implementing Siemens iX design system.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 212 | 🐛 64 | 🌐 SCSS | 📅 2026-03-18 - Set of UI components based on Momentum Design.
...
* [Astro Space UX Design System](https://github.com/RocketCommunicationsInc/astro) ⭐ 149 | 🐛 46 | 🌐 TypeScript | 📅 2026-03-14 - Set of components to build rich space app experiences with established interaction patterns.
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 132 | 🐛 225 | 🌐 HTML | 📅 2026-03-18 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 130 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 128 | 🐛 75 | 🌐 TypeScript | 📅 2026-03-19 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 65 | 🐛 40 | 🌐 TypeScript | 📅 2026-03-18 - Library of Web Components adhering to the Forge Design System.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 62 | 🐛 76 | 🌐 TypeScript | 📅 2026-03-18 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,044 | 🐛 172 | 🌐 TypeScript | 📅 2026-03-19 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,640 | 🐛 80 | 🌐 TypeScript | 📅 2026-03-19 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,758 | 🐛 418 | 🌐 JavaScript | 📅 2026-03-18 - blazing fast, enterprise-grade Web Components foundation.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 135 | 🐛 7 | 🌐 TypeScript | 📅 2026-03-18 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,336 | 🐛 131 | 🌐 TypeScript | 📅 2026-03-17 - Library that extends Solid adding Custom Web Components and extensions.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,921 | 🐛 1,008 | 🌐 JavaScript | 📅 2026-03-04 - Web component framework to easily create user-first experiences for the web.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 36 | 🌐 JavaScript | 📅 2026-03-15 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,834 | 🐛 2,741 | 🌐 HTML | 📅 2026-03-19

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,834 | 🐛 2,741 | 🌐 HTML | 📅 2026-03-19
...
* [@webcomponents/custom-elements](https://github.com/webcomponents/polyfills/tree/master/packages/custom-elements) ⭐ 1,183 | 🐛 145 | 🌐 HTML | 📅 2026-03-17 - Custom Elements polyfill by Polymer team.
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,758 | 🐛 418 | 🌐 JavaScript | 📅 2026-03-18 - Shadow DOM polyfill by [LWC](https://lwc.dev).
* [@webcomponents/shadydom](https://github.com/webcomponents/polyfills/tree/master/packages/shadydom) ⭐ 1,183 | 🐛 145 | 🌐 HTML | 📅 2026-03-17 - ShadowDOM v1 shim.
* [@webcomponents/shadycss](https://github.com/webcomponents/polyfills/tree/master/packages/shadycss) ⭐ 1,183 | 🐛 145 | 🌐 HTML | 📅 2026-03-17 - ShadowDOM style encapsulation shim.

#### HTML Templates polyfills

* [@webcomponents/template](https://github.com/webcomponents/polyfills/tree/master/packages/template) ⭐ 1,183 | 🐛 145 | 🌐 HTML | 📅 2026-03-17 - Minimal polyfill for `<template>`.
