...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,829 | 🐛 2,743 | 🌐 HTML | 📅 2026-03-21
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,829 | 🐛 2,743 | 🌐 HTML | 📅 2026-03-21
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,829 | 🐛 2,743 | 🌐 HTML | 📅 2026-03-21
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,829 | 🐛 2,743 | 🌐 HTML | 📅 2026-03-21
...
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 7,963 | 🐛 114 | 🌐 TypeScript | 📅 2026-03-19 - Web component for rendering interactive 3D models.
* [`<lite-youtube>`](https://github.com/paulirish/lite-youtube-embed) ⭐ 6,299 | 🐛 27 | 🌐 HTML | 📅 2025-11-10 - Lite YouTube embed with a focus on visual performance.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,560 | 🐛 28 | 🌐 TypeScript | 📅 2026-03-20 - Web component for chat with AI capabilities.
...
* [`<dark-mode-toggle>`](https://github.com/GoogleChromeLabs/dark-mode-toggle) ⭐ 1,217 | 🐛 4 | 🌐 JavaScript | 📅 2026-02-14 - Custom element that allows to create a dark mode toggle or switch.
...
* [`<api-viewer>`](https://github.com/web-padawan/api-viewer-element) ⭐ 283 | 🐛 19 | 🌐 TypeScript | 📅 2026-03-16 - API documentation and live playground for Web Components.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,451 | 🐛 22 | 🌐 JavaScript | 📅 2026-03-20 quickly into your page using custom elements.
...
* [`<pdfjs-viewer-element>`](https://github.com/alekswebnet/pdfjs-viewer-element) ⭐ 66 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-19 - Custom element that embeds PDF.js default viewer.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,922 | 🐛 1,008 | 🌐 JavaScript | 📅 2026-03-04 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
* [Shoelace](https://github.com/shoelace-style/shoelace) ⭐ 13,877 | 🐛 105 | 🌐 TypeScript | 📅 2026-03-05 - A forward-thinking library of web components.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,936 | 🐛 170 | 🌐 JavaScript | 📅 2026-03-19 - Set of highly performant, accessible and flexible Web Components.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 786 | 🐛 5 | 🌐 TypeScript | 📅 2026-03-21 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 556 | 🐛 943 | 🌐 JavaScript | 📅 2026-03-20 - Evolving set of high-quality web components for building business web applications.
...
* [Apollo Elements](https://github.com/apollo-elements/apollo-elements) ⭐ 421 | 🐛 4 | 🌐 TypeScript | 📅 2026-03-06 - Custom elements for using Apollo GraphQL with various web components libraries.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 103 | 🐛 2 | 🌐 JavaScript | 📅 2026-03-18 - General use Web Components for websites and applications.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 12 | 🐛 7 | 🌐 JavaScript | 📅 2026-03-20 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,881 | 🐛 671 | 🌐 TypeScript | 📅 2026-03-20 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,811 | 🐛 161 | 🌐 SCSS | 📅 2026-03-14 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,640 | 🐛 84 | 🌐 TypeScript | 📅 2026-03-21 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,728 | 🐛 289 | 🌐 TypeScript | 📅 2026-03-21 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
...
* [Astro Space UX Design System](https://github.com/RocketCommunicationsInc/astro) ⭐ 149 | 🐛 47 | 🌐 TypeScript | 📅 2026-03-20 - Set of components to build rich space app experiences with established interaction patterns.
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 132 | 🐛 227 | 🌐 HTML | 📅 2026-03-20 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 130 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 128 | 🐛 76 | 🌐 TypeScript | 📅 2026-03-20 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,048 | 🐛 172 | 🌐 TypeScript | 📅 2026-03-20 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,640 | 🐛 84 | 🌐 TypeScript | 📅 2026-03-21 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,760 | 🐛 421 | 🌐 JavaScript | 📅 2026-03-20 - blazing fast, enterprise-grade Web Components foundation.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,358 | 🐛 124 | 🌐 TypeScript | 📅 2026-03-20 - Library that extends Solid adding Custom Web Components and extensions.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,922 | 🐛 1,008 | 🌐 JavaScript | 📅 2026-03-04 - Web component framework to easily create user-first experiences for the web.
...
* [hello-web-components](https://github.com/fernandopasik/hello-web-components) ⭐ 31 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-18 - Simple starter hello world web component written in TypeScript.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,829 | 🐛 2,743 | 🌐 HTML | 📅 2026-03-21

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,829 | 🐛 2,743 | 🌐 HTML | 📅 2026-03-21
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,760 | 🐛 421 | 🌐 JavaScript | 📅 2026-03-20 - Shadow DOM polyfill by [LWC](https://lwc.dev).
