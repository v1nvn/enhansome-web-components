...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,938 | 🐛 2,769 | 🌐 HTML | 📅 2026-05-30
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,938 | 🐛 2,769 | 🌐 HTML | 📅 2026-05-30
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,938 | 🐛 2,769 | 🌐 HTML | 📅 2026-05-30
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,938 | 🐛 2,769 | 🌐 HTML | 📅 2026-05-30
...
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,099 | 🐛 114 | 🌐 TypeScript | 📅 2026-05-29 - Web component for rendering interactive 3D models.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,619 | 🐛 34 | 🌐 TypeScript | 📅 2026-05-29 - Web component for chat with AI capabilities.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,516 | 🐛 19 | 🌐 JavaScript | 📅 2026-05-29 quickly into your page using custom elements.
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 152 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-29 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 565 | 🐛 942 | 🌐 JavaScript | 📅 2026-05-29 - Evolving set of high-quality web components for building business web applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 41 | 🌐 JavaScript | 📅 2026-05-30 - Components for building web applications with Nuxeo using Web Components.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,027 | 🐛 740 | 🌐 TypeScript | 📅 2026-05-29 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,981 | 🐛 169 | 🌐 SCSS | 📅 2026-05-29 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,653 | 🐛 92 | 🌐 TypeScript | 📅 2026-05-29 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,748 | 🐛 248 | 🌐 TypeScript | 📅 2026-05-30 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,515 | 🐛 251 | 🌐 TypeScript | 📅 2026-05-29 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 365 | 🐛 906 | 🌐 TypeScript | 📅 2026-05-30 - Shared Web Components for Esri's Calcite design framework.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 64 | 🌐 TypeScript | 📅 2026-05-30 - Building blocks of the Lyne Design System are based on Web Components.
...
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,653 | 🐛 92 | 🌐 TypeScript | 📅 2026-05-29 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,561 | 🐛 31 | 🌐 TypeScript | 📅 2026-05-29 - Library that extends Solid adding Custom Web Components and extensions.
...
* [Web Components Compiler](https://github.com/ProjectEvergreen/wcc) ⭐ 125 | 🐛 27 | 🌐 JavaScript | 📅 2026-05-28 - Compiler to make server-side rendering of native web components easier.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,938 | 🐛 2,769 | 🌐 HTML | 📅 2026-05-30

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,938 | 🐛 2,769 | 🌐 HTML | 📅 2026-05-30
