...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,812 | 🐛 2,736 | 🌐 HTML | 📅 2026-03-09
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,812 | 🐛 2,736 | 🌐 HTML | 📅 2026-03-09
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,812 | 🐛 2,736 | 🌐 HTML | 📅 2026-03-09
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,812 | 🐛 2,736 | 🌐 HTML | 📅 2026-03-09
...
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 7,942 | 🐛 115 | 🌐 TypeScript | 📅 2026-03-04 - Web component for rendering interactive 3D models.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,548 | 🐛 27 | 🌐 TypeScript | 📅 2026-03-08 - Web component for chat with AI capabilities.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,440 | 🐛 20 | 🌐 JavaScript | 📅 2026-03-09 quickly into your page using custom elements.
...
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 114 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-08 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
* [`<range-slider>`](https://github.com/andreruffert/range-slider-element) ⭐ 89 | 🐛 3 | 🌐 JavaScript | 📅 2026-03-09 - Accessible range slider custom element with keyboard support.
* [`<fg-modal>`](https://github.com/filamentgroup/fg-modal) ⚠️ Archived - Accessible modal dialog web component.
* [`<pdfjs-viewer-element>`](https://github.com/alekswebnet/pdfjs-viewer-element) ⭐ 65 | 🐛 2 | 🌐 JavaScript | 📅 2026-03-08 - Custom element that embeds PDF.js default viewer.
...
* [Shoelace](https://github.com/shoelace-style/shoelace) ⭐ 13,867 | 🐛 104 | 🌐 TypeScript | 📅 2026-03-05 - A forward-thinking library of web components.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,934 | 🐛 169 | 🌐 JavaScript | 📅 2026-03-06 - Set of highly performant, accessible and flexible Web Components.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 780 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-09 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 555 | 🐛 940 | 🌐 JavaScript | 📅 2026-03-08 - Evolving set of high-quality web components for building business web applications.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 167 | 🐛 68 | 🌐 TypeScript | 📅 2026-03-06 - Complete library of UI components from Infragistics.
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 145 | 🐛 45 | 🌐 TypeScript | 📅 2026-03-09 - Collection of user interface web components for Umbraco CMS.
...
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 46 | 🌐 TypeScript | 📅 2026-03-09 - A schema for mutation testing results with the web components to visualize it.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,873 | 🐛 664 | 🌐 TypeScript | 📅 2026-03-06 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,785 | 🐛 164 | 🌐 SCSS | 📅 2026-03-07 - Material Design implemented as Web Components.
...
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,723 | 🐛 281 | 🌐 TypeScript | 📅 2026-03-09 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 346 | 🐛 868 | 🌐 TypeScript | 📅 2026-03-09 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 325 | 🐛 94 | 🌐 TypeScript | 📅 2026-03-06 - Web Components implementing Siemens iX design system.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 62 | 🐛 73 | 🌐 TypeScript | 📅 2026-03-09 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,036 | 🐛 166 | 🌐 TypeScript | 📅 2026-03-08 - Compiler for generating Web Components.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,307 | 🐛 121 | 🌐 TypeScript | 📅 2026-03-06 - Library that extends Solid adding Custom Web Components and extensions.
...
* [haunted](https://github.com/matthewp/haunted) ⭐ 2,706 | 🐛 61 | 🌐 TypeScript | 📅 2026-03-06 - React's Hooks API implemented for web components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,812 | 🐛 2,736 | 🌐 HTML | 📅 2026-03-09

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,812 | 🐛 2,736 | 🌐 HTML | 📅 2026-03-09
