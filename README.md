...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,932 | 🐛 2,798 | 🌐 HTML | 📅 2026-05-24
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,932 | 🐛 2,798 | 🌐 HTML | 📅 2026-05-24
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,932 | 🐛 2,798 | 🌐 HTML | 📅 2026-05-24
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,932 | 🐛 2,798 | 🌐 HTML | 📅 2026-05-24
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,944 | 🐛 174 | 🌐 JavaScript | 📅 2026-05-23 - Rich text editor custom element for everyday writing.
...
* [Wired Elements](https://github.com/wiredjs/wired-elements) ⭐ 10,785 | 🐛 36 | 🌐 TypeScript | 📅 2023-10-07 - Set of common UI elements with a hand-drawn, sketchy look.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 564 | 🐛 949 | 🌐 JavaScript | 📅 2026-05-23 - Evolving set of high-quality web components for building business web applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 37 | 🌐 JavaScript | 📅 2026-05-24 - Components for building web applications with Nuxeo using Web Components.
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 47 | 🌐 TypeScript | 📅 2026-05-23 - A schema for mutation testing results with the web components to visualize it.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,021 | 🐛 737 | 🌐 TypeScript | 📅 2026-05-23 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,967 | 🐛 167 | 🌐 SCSS | 📅 2026-05-23 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,650 | 🐛 78 | 🌐 TypeScript | 📅 2026-05-24 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,748 | 🐛 249 | 🌐 TypeScript | 📅 2026-05-24 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 363 | 🐛 901 | 🌐 TypeScript | 📅 2026-05-23 - Shared Web Components for Esri's Calcite design framework.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 138 | 🐛 191 | 🌐 HTML | 📅 2026-05-23 - Web components for building uniform experiences with the Red Hat brand.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 66 | 🌐 TypeScript | 📅 2026-05-23 - Building blocks of the Lyne Design System are based on Web Components.
...
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,650 | 🐛 78 | 🌐 TypeScript | 📅 2026-05-24 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,564 | 🐛 24 | 🌐 TypeScript | 📅 2026-05-23 - Library that extends Solid adding Custom Web Components and extensions.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,932 | 🐛 2,798 | 🌐 HTML | 📅 2026-05-24

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,932 | 🐛 2,798 | 🌐 HTML | 📅 2026-05-24
