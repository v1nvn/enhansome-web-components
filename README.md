...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,928 | 🐛 2,775 | 🌐 HTML | 📅 2026-06-11
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,928 | 🐛 2,775 | 🌐 HTML | 📅 2026-06-11
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,928 | 🐛 2,775 | 🌐 HTML | 📅 2026-06-11
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,928 | 🐛 2,775 | 🌐 HTML | 📅 2026-06-11
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,962 | 🐛 175 | 🌐 JavaScript | 📅 2026-06-09 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,120 | 🐛 118 | 🌐 TypeScript | 📅 2026-06-05 - Web component for rendering interactive 3D models.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,634 | 🐛 36 | 🌐 TypeScript | 📅 2026-06-10 - Web component for chat with AI capabilities.
...
* [`<qr-code>`](https://github.com/bitjson/qr-code) ⭐ 1,378 | 🐛 14 | 🌐 TypeScript | 📅 2023-02-28 – Web component for rendering customizable, animate-able, SVG-based QR codes.
...
* [`<midi-player>`](https://github.com/cifkao/html-midi-player) ⭐ 881 | 🐛 21 | 🌐 TypeScript | 📅 2025-07-06 - MIDI file player and visualizer web components.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,525 | 🐛 19 | 🌐 JavaScript | 📅 2026-06-10 quickly into your page using custom elements.
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 160 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-09 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [`<pdfjs-viewer-element>`](https://github.com/alekswebnet/pdfjs-viewer-element) ⭐ 70 | 🐛 1 | 🌐 JavaScript | 📅 2026-04-10 - Custom element that embeds PDF.js default viewer.
...
* [LDRS](https://github.com/GriffinJohnston/ldrs) ⭐ 2,179 | 🐛 1 | 🌐 TypeScript | 📅 2025-10-22 - Lightweight, customizable loading animations/spinners.
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,949 | 🐛 183 | 🌐 JavaScript | 📅 2026-06-10 - Set of highly performant, accessible and flexible Web Components.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 565 | 🐛 943 | 🌐 JavaScript | 📅 2026-06-10 - Evolving set of high-quality web components for building business web applications.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 273 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-10 - ELMS:LN produced web components for any project.
* [Wokwi Elements](https://github.com/wokwi/wokwi-elements) ⭐ 251 | 🐛 25 | 🌐 TypeScript | 📅 2026-06-08 - Web Components for Arduino and various electronic parts.
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 241 | 🐛 329 | 🌐 JavaScript | 📅 2026-06-10 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 167 | 🐛 65 | 🌐 TypeScript | 📅 2026-06-10 - Complete library of UI components from Infragistics.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 105 | 🐛 3 | 🌐 JavaScript | 📅 2026-06-09 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 44 | 🌐 JavaScript | 📅 2026-06-11 - Collection of web components for building Brightspace applications.
...
* [One Platform Components](https://github.com/1-Platform/op-components) ⭐ 33 | 🐛 17 | 🌐 TypeScript | 📅 2026-06-01 - Set of web components for Red Hat One Platform.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 45 | 🌐 JavaScript | 📅 2026-06-11 - Components for building web applications with Nuxeo using Web Components.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 58 | 🌐 TypeScript | 📅 2026-06-08 - Ser of web components used by Equinor Fusion.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 11 | 🐛 9 | 🌐 JavaScript | 📅 2026-06-09 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,046 | 🐛 738 | 🌐 TypeScript | 📅 2026-06-11 - Library of Web Components that supports Microsoft's Fluent design language.
...
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,654 | 🐛 106 | 🌐 TypeScript | 📅 2026-06-10 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,754 | 🐛 240 | 🌐 TypeScript | 📅 2026-06-11 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,518 | 🐛 257 | 🌐 TypeScript | 📅 2026-06-11 - Adobe Spectrum design language implementation built with Web Components.
...
* [PatternFly Elements](https://github.com/patternfly/patternfly-elements) ⭐ 391 | 🐛 172 | 🌐 TypeScript | 📅 2026-06-08 - Collection of flexible and lightweight Web Components based on the Unified Design Kit.
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 365 | 🐛 897 | 🌐 TypeScript | 📅 2026-06-11 - Shared Web Components for Esri's Calcite design framework.
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 347 | 🐛 90 | 🌐 TypeScript | 📅 2026-06-11 - Web Components implementing Siemens iX design system.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 211 | 🐛 67 | 🌐 SCSS | 📅 2026-06-09 - Set of UI components based on Momentum Design.
...
* [Astro Space UX Design System](https://github.com/RocketCommunicationsInc/astro) ⭐ 150 | 🐛 67 | 🌐 TypeScript | 📅 2026-05-18 - Set of components to build rich space app experiences with established interaction patterns.
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 138 | 🐛 197 | 🌐 HTML | 📅 2026-06-11 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 130 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 130 | 🐛 73 | 🌐 TypeScript | 📅 2026-06-09 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 65 | 🐛 56 | 🌐 TypeScript | 📅 2026-06-11 - Building blocks of the Lyne Design System are based on Web Components.
...
* [NVIDIA Elements](https://github.com/nvidia/elements) ⭐ 14 | 🐛 2 | 🌐 TypeScript | 📅 2026-06-10 - The Design Language and UI Agent Harness for AI/ML Factories, Robotics, and Autonomous Vehicles.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,096 | 🐛 187 | 🌐 TypeScript | 📅 2026-06-08 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,654 | 🐛 106 | 🌐 TypeScript | 📅 2026-06-10 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,618 | 🐛 46 | 🌐 TypeScript | 📅 2026-06-11 - Library that extends Solid adding Custom Web Components and extensions.
* [hybrids](https://github.com/hybridsjs/hybrids) ⭐ 3,175 | 🐛 11 | 🌐 JavaScript | 📅 2026-05-21 - UI library for creating Web Components with simple and functional API.
* [haunted](https://github.com/matthewp/haunted) ⭐ 2,718 | 🐛 62 | 🌐 TypeScript | 📅 2026-05-28 - React's Hooks API implemented for web components.
* [atomico](https://github.com/atomicojs/atomico) ⭐ 1,272 | 🐛 18 | 🌐 TypeScript | 📅 2026-06-05 - Small library for the creation of interfaces based on web components using functions and hooks.
...
* [Web Components Compiler](https://github.com/ProjectEvergreen/wcc) ⭐ 125 | 🐛 24 | 🌐 JavaScript | 📅 2026-06-02 - Compiler to make server-side rendering of native web components easier.
...
* [cypress-lit](https://github.com/simonireilly/cypress-lit) ⭐ 25 | 🐛 13 | 🌐 TypeScript | 📅 2026-06-09 - Test your Lit elements and native web components in Cypress with all the modern browsers.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 36 | 🌐 JavaScript | 📅 2026-06-01 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,928 | 🐛 2,775 | 🌐 HTML | 📅 2026-06-11

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,928 | 🐛 2,775 | 🌐 HTML | 📅 2026-06-11
