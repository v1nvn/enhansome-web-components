...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,884 | 🐛 2,790 | 🌐 HTML | 📅 2026-04-15
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,884 | 🐛 2,790 | 🌐 HTML | 📅 2026-04-15
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,884 | 🐛 2,790 | 🌐 HTML | 📅 2026-04-15
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,884 | 🐛 2,790 | 🌐 HTML | 📅 2026-04-15
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,932 | 🐛 184 | 🌐 JavaScript | 📅 2026-04-11 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,000 | 🐛 110 | 🌐 TypeScript | 📅 2026-04-07 - Web component for rendering interactive 3D models.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,583 | 🐛 30 | 🌐 TypeScript | 📅 2026-04-14 - Web component for chat with AI capabilities.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,470 | 🐛 20 | 🌐 JavaScript | 📅 2026-04-13 quickly into your page using custom elements.
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 135 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-09 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [Elix](https://github.com/elix/elix) ⭐ 834 | 🐛 12 | 🌐 JavaScript | 📅 2023-03-01 - High-quality, customizable web components for common user interface patterns.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 561 | 🐛 939 | 🌐 JavaScript | 📅 2026-04-14 - Evolving set of high-quality web components for building business web applications.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 271 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-14 - ELMS:LN produced web components for any project.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 166 | 🐛 67 | 🌐 TypeScript | 📅 2026-04-14 - Complete library of UI components from Infragistics.
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 147 | 🐛 51 | 🌐 TypeScript | 📅 2026-04-14 - Collection of user interface web components for Umbraco CMS.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 51 | 🌐 JavaScript | 📅 2026-04-15 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 30 | 🌐 JavaScript | 📅 2026-04-14 - Components for building web applications with Nuxeo using Web Components.
...
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 47 | 🌐 JavaScript | 📅 2026-04-14 - Collection of web components used by TEI Publisher and apps generated by it.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 12 | 🐛 8 | 🌐 JavaScript | 📅 2026-04-14 - Web components library for Sme.UP.
...
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,868 | 🐛 164 | 🌐 SCSS | 📅 2026-04-14 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,641 | 🐛 89 | 🌐 TypeScript | 📅 2026-04-15 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,731 | 🐛 278 | 🌐 TypeScript | 📅 2026-04-15 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 351 | 🐛 875 | 🌐 TypeScript | 📅 2026-04-15 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 334 | 🐛 80 | 🌐 TypeScript | 📅 2026-04-14 - Web Components implementing Siemens iX design system.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 133 | 🐛 171 | 🌐 HTML | 📅 2026-04-14 - Web components for building uniform experiences with the Red Hat brand.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 76 | 🌐 TypeScript | 📅 2026-04-14 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,063 | 🐛 175 | 🌐 TypeScript | 📅 2026-04-14 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,641 | 🐛 89 | 🌐 TypeScript | 📅 2026-04-15 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,762 | 🐛 419 | 🌐 JavaScript | 📅 2026-04-13 - blazing fast, enterprise-grade Web Components foundation.
...
* [element-js](https://github.com/webtides/element-js) ⭐ 31 | 🐛 23 | 🌐 JavaScript | 📅 2026-04-14 - Simple and lightweight base classes for web components with a beautiful API.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,402 | 🐛 91 | 🌐 TypeScript | 📅 2026-04-15 - Library that extends Solid adding Custom Web Components and extensions.
...
* [atomico](https://github.com/atomicojs/atomico) ⭐ 1,266 | 🐛 17 | 🌐 TypeScript | 📅 2026-04-13 - Small library for the creation of interfaces based on web components using functions and hooks.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,884 | 🐛 2,790 | 🌐 HTML | 📅 2026-04-15

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,884 | 🐛 2,790 | 🌐 HTML | 📅 2026-04-15
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,762 | 🐛 419 | 🌐 JavaScript | 📅 2026-04-13 - Shadow DOM polyfill by [LWC](https://lwc.dev).
