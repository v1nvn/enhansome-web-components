...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,926 | 🐛 2,771 | 🌐 HTML | 📅 2026-05-12
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,926 | 🐛 2,771 | 🌐 HTML | 📅 2026-05-12
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,926 | 🐛 2,771 | 🌐 HTML | 📅 2026-05-12
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,926 | 🐛 2,771 | 🌐 HTML | 📅 2026-05-12
...
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,061 | 🐛 112 | 🌐 TypeScript | 📅 2026-04-17 - Web component for rendering interactive 3D models.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,603 | 🐛 33 | 🌐 TypeScript | 📅 2026-05-11 - Web component for chat with AI capabilities.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,494 | 🐛 23 | 🌐 JavaScript | 📅 2026-05-09 quickly into your page using custom elements.
...
* [Wired Elements](https://github.com/wiredjs/wired-elements) ⭐ 10,779 | 🐛 36 | 🌐 TypeScript | 📅 2023-10-07 - Set of common UI elements with a hand-drawn, sketchy look.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,942 | 🐛 181 | 🌐 JavaScript | 📅 2026-05-11 - Set of highly performant, accessible and flexible Web Components.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 804 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-02 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 272 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-11 - ELMS:LN produced web components for any project.
...
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 241 | 🐛 330 | 🌐 JavaScript | 📅 2026-05-11 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 167 | 🐛 66 | 🌐 TypeScript | 📅 2026-05-11 - Complete library of UI components from Infragistics.
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 148 | 🐛 56 | 🌐 TypeScript | 📅 2026-05-11 - Collection of user interface web components for Umbraco CMS.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 62 | 🌐 JavaScript | 📅 2026-05-11 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 39 | 🌐 JavaScript | 📅 2026-05-11 - Components for building web applications with Nuxeo using Web Components.
...
* [Tradeshift Elements](https://github.com/Tradeshift/elements) ⭐ 18 | 🐛 57 | 🌐 JavaScript | 📅 2026-05-11 - Reusable Tradeshift UI Components as Web Components.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 29 | 🌐 TypeScript | 📅 2026-05-11 - Ser of web components used by Equinor Fusion.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,971 | 🐛 742 | 🌐 TypeScript | 📅 2026-05-12 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,939 | 🐛 165 | 🌐 SCSS | 📅 2026-05-07 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,646 | 🐛 74 | 🌐 TypeScript | 📅 2026-05-09 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,740 | 🐛 268 | 🌐 TypeScript | 📅 2026-05-12 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,510 | 🐛 251 | 🌐 TypeScript | 📅 2026-05-12 - Adobe Spectrum design language implementation built with Web Components.
...
* [PatternFly Elements](https://github.com/patternfly/patternfly-elements) ⭐ 391 | 🐛 168 | 🌐 TypeScript | 📅 2026-05-12 - Collection of flexible and lightweight Web Components based on the Unified Design Kit.
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 360 | 🐛 906 | 🌐 TypeScript | 📅 2026-05-12 - Shared Web Components for Esri's Calcite design framework.
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 342 | 🐛 76 | 🌐 TypeScript | 📅 2026-05-12 - Web Components implementing Siemens iX design system.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 136 | 🐛 188 | 🌐 HTML | 📅 2026-05-11 - Web components for building uniform experiences with the Red Hat brand.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 68 | 🐛 44 | 🌐 TypeScript | 📅 2026-05-11 - Library of Web Components adhering to the Forge Design System.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 65 | 🌐 TypeScript | 📅 2026-05-12 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,084 | 🐛 184 | 🌐 TypeScript | 📅 2026-05-11 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,646 | 🐛 74 | 🌐 TypeScript | 📅 2026-05-09 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 134 | 🐛 7 | 🌐 TypeScript | 📅 2026-05-12 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,507 | 🐛 57 | 🌐 TypeScript | 📅 2026-05-12 - Library that extends Solid adding Custom Web Components and extensions.
...
* [nuxt-custom-elements](https://github.com/GrabarzUndPartner/nuxt-custom-elements) ⭐ 83 | 🐛 19 | 🌐 JavaScript | 📅 2026-05-12 - Export your project components as custom elements for integration into external pages.
...
* [cypress-lit](https://github.com/simonireilly/cypress-lit) ⭐ 25 | 🐛 13 | 🌐 TypeScript | 📅 2026-05-11 - Test your Lit elements and native web components in Cypress with all the modern browsers.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,926 | 🐛 2,771 | 🌐 HTML | 📅 2026-05-12

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,926 | 🐛 2,771 | 🌐 HTML | 📅 2026-05-12
