...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,879 | 🐛 2,791 | 🌐 HTML | 📅 2026-04-11
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,879 | 🐛 2,791 | 🌐 HTML | 📅 2026-04-11
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,879 | 🐛 2,791 | 🌐 HTML | 📅 2026-04-11
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,879 | 🐛 2,791 | 🌐 HTML | 📅 2026-04-11
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,932 | 🐛 184 | 🌐 JavaScript | 📅 2026-04-10 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 7,990 | 🐛 110 | 🌐 TypeScript | 📅 2026-04-07 - Web component for rendering interactive 3D models.
...
* [`<emoji-picker>`](https://github.com/nolanlawson/emoji-picker-element) ⭐ 1,723 | 🐛 36 | 🌐 JavaScript | 📅 2026-04-10 - Lightweight emoji picker, distributed as a web component.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 560 | 🐛 939 | 🌐 JavaScript | 📅 2026-04-10 - Evolving set of high-quality web components for building business web applications.
...
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 48 | 🌐 TypeScript | 📅 2026-04-11 - A schema for mutation testing results with the web components to visualize it.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,922 | 🐛 675 | 🌐 TypeScript | 📅 2026-04-10 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,855 | 🐛 162 | 🌐 SCSS | 📅 2026-04-10 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,639 | 🐛 89 | 🌐 TypeScript | 📅 2026-04-11 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,730 | 🐛 286 | 🌐 TypeScript | 📅 2026-04-11 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 351 | 🐛 873 | 🌐 TypeScript | 📅 2026-04-11 - Shared Web Components for Esri's Calcite design framework.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 81 | 🌐 TypeScript | 📅 2026-04-11 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,050 | 🐛 176 | 🌐 TypeScript | 📅 2026-04-10 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,639 | 🐛 89 | 🌐 TypeScript | 📅 2026-04-11 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,761 | 🐛 420 | 🌐 JavaScript | 📅 2026-04-10 - blazing fast, enterprise-grade Web Components foundation.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,385 | 🐛 115 | 🌐 TypeScript | 📅 2026-04-10 - Library that extends Solid adding Custom Web Components and extensions.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,879 | 🐛 2,791 | 🌐 HTML | 📅 2026-04-11

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,879 | 🐛 2,791 | 🌐 HTML | 📅 2026-04-11
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,761 | 🐛 420 | 🌐 JavaScript | 📅 2026-04-10 - Shadow DOM polyfill by [LWC](https://lwc.dev).
