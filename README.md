...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,921 | 🐛 2,772 | 🌐 HTML | 📅 2026-05-09
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,921 | 🐛 2,772 | 🌐 HTML | 📅 2026-05-09
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,921 | 🐛 2,772 | 🌐 HTML | 📅 2026-05-09
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,921 | 🐛 2,772 | 🌐 HTML | 📅 2026-05-09
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,937 | 🐛 185 | 🌐 JavaScript | 📅 2026-05-09 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,050 | 🐛 112 | 🌐 TypeScript | 📅 2026-04-17 - Web component for rendering interactive 3D models.
* [`<lite-youtube>`](https://github.com/paulirish/lite-youtube-embed) ⭐ 6,315 | 🐛 28 | 🌐 HTML | 📅 2025-11-10 - Lite YouTube embed with a focus on visual performance.
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 6,008 | 🐛 8 | 🌐 JavaScript | 📅 2026-04-19 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,601 | 🐛 33 | 🌐 TypeScript | 📅 2026-05-08 - Web component for chat with AI capabilities.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,493 | 🐛 21 | 🌐 JavaScript | 📅 2026-05-08 quickly into your page using custom elements.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,941 | 🐛 182 | 🌐 JavaScript | 📅 2026-05-08 - Set of highly performant, accessible and flexible Web Components.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 802 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-02 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
...
* [Smart Web Components](https://github.com/HTMLElements/smart-webcomponents) ⭐ 476 | 🐛 7 | 🌐 CSS | 📅 2026-04-28 - Web components for business applications.
...
* [Wokwi Elements](https://github.com/wokwi/wokwi-elements) ⭐ 243 | 🐛 25 | 🌐 TypeScript | 📅 2026-05-08 - Web Components for Arduino and various electronic parts.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 103 | 🐛 4 | 🌐 JavaScript | 📅 2026-05-08 - General use Web Components for websites and applications.
...
* [Joomla UI custom elements](https://github.com/joomla-projects/custom-elements) ⭐ 31 | 🐛 22 | 🌐 JavaScript | 📅 2026-05-08 - Compilation of Joomla 4 Custom Elements.
* [elements-sk](https://github.com/google/elements-sk) ⚠️ Archived - Collection of custom elements for "a la carte" web development.
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 37 | 🌐 JavaScript | 📅 2026-05-08 - Components for building web applications with Nuxeo using Web Components.
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 45 | 🌐 TypeScript | 📅 2026-05-09 - A schema for mutation testing results with the web components to visualize it.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 13 | 🐛 9 | 🌐 JavaScript | 📅 2026-05-08 - Web components library for Sme.UP.
...
* [Burnish Components](https://github.com/danfking/burnish/tree/main/packages/components) ⭐ 2 | 🐛 7 | 🌐 TypeScript | 📅 2026-05-08 - Web components for rendering MCP tool-call output as UI.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,966 | 🐛 737 | 🌐 TypeScript | 📅 2026-05-08 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,931 | 🐛 165 | 🌐 SCSS | 📅 2026-05-07 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,645 | 🐛 74 | 🌐 TypeScript | 📅 2026-05-09 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,739 | 🐛 270 | 🌐 TypeScript | 📅 2026-05-09 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 360 | 🐛 905 | 🌐 TypeScript | 📅 2026-05-08 - Shared Web Components for Esri's Calcite design framework.
...
* [Astro Space UX Design System](https://github.com/RocketCommunicationsInc/astro) ⭐ 150 | 🐛 63 | 🌐 TypeScript | 📅 2026-05-08 - Set of components to build rich space app experiences with established interaction patterns.
...
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 129 | 🐛 71 | 🌐 TypeScript | 📅 2026-05-09 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 61 | 🌐 TypeScript | 📅 2026-05-08 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,084 | 🐛 181 | 🌐 TypeScript | 📅 2026-05-09 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,645 | 🐛 74 | 🌐 TypeScript | 📅 2026-05-09 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,764 | 🐛 415 | 🌐 JavaScript | 📅 2026-05-09 - blazing fast, enterprise-grade Web Components foundation.
...
* [Panel](https://github.com/mixpanel/panel) ⭐ 274 | 🐛 13 | 🌐 JavaScript | 📅 2026-05-06 - Web Components + Virtual DOM: web standards for powerful UIs.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,496 | 🐛 62 | 🌐 TypeScript | 📅 2026-05-07 - Library that extends Solid adding Custom Web Components and extensions.
...
* [hello-web-components](https://github.com/fernandopasik/hello-web-components) ⭐ 32 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-08 - Simple starter hello world web component written in TypeScript.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,921 | 🐛 2,772 | 🌐 HTML | 📅 2026-05-09

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,921 | 🐛 2,772 | 🌐 HTML | 📅 2026-05-09
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,764 | 🐛 415 | 🌐 JavaScript | 📅 2026-05-09 - Shadow DOM polyfill by [LWC](https://lwc.dev).
