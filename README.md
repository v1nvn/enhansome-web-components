...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,859 | 🐛 2,760 | 🌐 HTML | 📅 2026-04-04
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,859 | 🐛 2,760 | 🌐 HTML | 📅 2026-04-04
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,859 | 🐛 2,760 | 🌐 HTML | 📅 2026-04-04
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,859 | 🐛 2,760 | 🌐 HTML | 📅 2026-04-04
...
* [web-components-examples](https://github.com/mdn/web-components-examples) ⭐ 3,363 | 🐛 4 | 🌐 JavaScript | 📅 2026-01-13 - Series of web components examples, related to the MDN web components documentation.
...
* [generic-components](https://github.com/thepassle/generic-components) ⭐ 574 | 🐛 11 | 🌐 JavaScript | 📅 2022-07-21 - Collection of generic web components with a focus on accessibility, and ease of use.
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,929 | 🐛 183 | 🌐 JavaScript | 📅 2026-04-02 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 7,986 | 🐛 113 | 🌐 TypeScript | 📅 2026-04-03 - Web component for rendering interactive 3D models.
* [`<lite-youtube>`](https://github.com/paulirish/lite-youtube-embed) ⭐ 6,304 | 🐛 28 | 🌐 HTML | 📅 2025-11-10 - Lite YouTube embed with a focus on visual performance.
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 5,984 | 🐛 7 | 🌐 JavaScript | 📅 2026-03-07 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,573 | 🐛 28 | 🌐 TypeScript | 📅 2026-04-03 - Web component for chat with AI capabilities.
* [`<vime-player>`](https://github.com/vime-js/vime) ⭐ 2,839 | 🐛 172 | 🌐 TypeScript | 📅 2024-11-17 - Customizable, extensible, accessible and framework agnostic media player.
* [`<rapi-doc>`](https://github.com/mrin9/RapiDoc) ⭐ 1,885 | 🐛 133 | 🌐 JavaScript | 📅 2026-02-11 - Web component for creating documentation from OpenAPI Specification.
* [`<emoji-picker>`](https://github.com/nolanlawson/emoji-picker-element) ⭐ 1,722 | 🐛 34 | 🌐 JavaScript | 📅 2026-04-02 - Lightweight emoji picker, distributed as a web component.
* [`<qr-code>`](https://github.com/bitjson/qr-code) ⭐ 1,374 | 🐛 14 | 🌐 TypeScript | 📅 2023-02-28 – Web component for rendering customizable, animate-able, SVG-based QR codes.
* [`<dark-mode-toggle>`](https://github.com/GoogleChromeLabs/dark-mode-toggle) ⭐ 1,218 | 🐛 6 | 🌐 JavaScript | 📅 2026-04-02 - Custom element that allows to create a dark mode toggle or switch.
* [`<midi-player>`](https://github.com/cifkao/html-midi-player) ⭐ 864 | 🐛 21 | 🌐 TypeScript | 📅 2025-07-06 - MIDI file player and visualizer web components.
...
* [`<active-table>`](https://github.com/OvidijusParsiunas/active-table) ⭐ 315 | 🐛 28 | 🌐 TypeScript | 📅 2026-02-26 - Editable table web component.
* [`<api-viewer>`](https://github.com/web-padawan/api-viewer-element) ⭐ 283 | 🐛 19 | 🌐 TypeScript | 📅 2026-03-28 - API documentation and live playground for Web Components.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,455 | 🐛 17 | 🌐 JavaScript | 📅 2026-03-31 quickly into your page using custom elements.
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 133 | 🐛 5 | 🌐 TypeScript | 📅 2026-04-01 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [`<pdfjs-viewer-element>`](https://github.com/alekswebnet/pdfjs-viewer-element) ⭐ 68 | 🐛 1 | 🌐 JavaScript | 📅 2026-03-23 - Custom element that embeds PDF.js default viewer.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,916 | 🐛 1,008 | 🌐 JavaScript | 📅 2026-03-30 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
* [Shoelace](https://github.com/shoelace-style/shoelace) ⚠️ Archived - A forward-thinking library of web components.
* [Wired Elements](https://github.com/wiredjs/wired-elements) ⭐ 10,771 | 🐛 36 | 🌐 TypeScript | 📅 2023-10-07 - Set of common UI elements with a hand-drawn, sketchy look.
* [github-elements](https://github.com/github/github-elements) ⭐ 2,903 | 🐛 1 | 🌐 JavaScript | 📅 2025-12-08 - GitHub's Web Component collection.
* [LDRS](https://github.com/GriffinJohnston/ldrs) ⭐ 2,163 | 🐛 1 | 🌐 TypeScript | 📅 2025-10-22 - Lightweight, customizable loading animations/spinners.
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,938 | 🐛 175 | 🌐 JavaScript | 📅 2026-03-29 - Set of highly performant, accessible and flexible Web Components.
...
* [Lume](https://github.com/lume/lume) ⭐ 1,497 | 🐛 127 | 🌐 TypeScript | 📅 2026-04-02 - Custom elements for 3D graphics. Built with Three.js for WebGL/WebGPU rendering, and Solid.js for reactivity and templating.
* [Microsoft Graph Toolkit](https://github.com/microsoftgraph/microsoft-graph-toolkit) ⭐ 1,047 | 🐛 186 | 🌐 TypeScript | 📅 2026-02-28 - Collection of web components for the Microsoft Graph.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 790 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-27 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
* [Playground Elements](https://github.com/PolymerLabs/playground-elements) ⭐ 645 | 🐛 95 | 🌐 TypeScript | 📅 2025-10-02 - Serverless code experiences with web components.
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 557 | 🐛 942 | 🌐 JavaScript | 📅 2026-04-03 - Evolving set of high-quality web components for building business web applications.
...
* [Apollo Elements](https://github.com/apollo-elements/apollo-elements) ⭐ 421 | 🐛 7 | 🌐 TypeScript | 📅 2026-03-27 - Custom elements for using Apollo GraphQL with various web components libraries.
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 270 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-03 - ELMS:LN produced web components for any project.
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 326 | 🌐 JavaScript | 📅 2026-04-03 - Collection of Web Components made by Clever Cloud.
* [Wokwi Elements](https://github.com/wokwi/wokwi-elements) ⭐ 231 | 🐛 24 | 🌐 TypeScript | 📅 2026-03-26 - Web Components for Arduino and various electronic parts.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 166 | 🐛 65 | 🌐 TypeScript | 📅 2026-04-03 - Complete library of UI components from Infragistics.
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 147 | 🐛 49 | 🌐 TypeScript | 📅 2026-03-30 - Collection of user interface web components for Umbraco CMS.
* [Nightingale](https://github.com/ebi-webcomponents/nightingale) ⭐ 142 | 🐛 26 | 🌐 TypeScript | 📅 2026-03-30 - Data visualisation web components for the life sciences.
...
* [AXA Pattern Library](https://github.com/axa-ch-webhub-cloud/pattern-library) ⭐ 129 | 🐛 27 | 🌐 JavaScript | 📅 2023-12-04 - AXA CH UI components library built with Web Components.
* [Blackstone UI](https://github.com/kjantzer/bui) ⭐ 109 | 🐛 17 | 🌐 JavaScript | 📅 2026-03-19 - Web components for creating interfaces by Blackstone Publishing.
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 103 | 🐛 4 | 🌐 JavaScript | 📅 2026-03-31 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 77 | 🐛 45 | 🌐 JavaScript | 📅 2026-04-03 - Collection of web components for building Brightspace applications.
...
* [Joomla UI custom elements](https://github.com/joomla-projects/custom-elements) ⭐ 31 | 🐛 19 | 🌐 JavaScript | 📅 2026-03-29 - Compilation of Joomla 4 Custom Elements.
* [One Platform Components](https://github.com/1-Platform/op-components) ⭐ 30 | 🐛 17 | 🌐 TypeScript | 📅 2026-04-01 - Set of web components for Red Hat One Platform.
* [elements-sk](https://github.com/google/elements-sk) ⚠️ Archived - Collection of custom elements for "a la carte" web development.
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 35 | 🌐 JavaScript | 📅 2026-04-03 - Components for building web applications with Nuxeo using Web Components.
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 47 | 🌐 TypeScript | 📅 2026-04-04 - A schema for mutation testing results with the web components to visualize it.
* [Titanium Elements](https://github.com/LeavittSoftware/titanium-elements) ⭐ 19 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-30 - Collection of lightweight web components used by Leavitt Group Enterprises.
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 55 | 🌐 JavaScript | 📅 2026-04-02 - Collection of web components used by TEI Publisher and apps generated by it.
* [Tradeshift Elements](https://github.com/Tradeshift/elements) ⭐ 18 | 🐛 57 | 🌐 JavaScript | 📅 2026-03-09 - Reusable Tradeshift UI Components as Web Components.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 16 | 🌐 TypeScript | 📅 2026-04-02 - Ser of web components used by Equinor Fusion.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 12 | 🐛 8 | 🌐 JavaScript | 📅 2026-04-03 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,910 | 🐛 669 | 🌐 TypeScript | 📅 2026-04-02 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,837 | 🐛 159 | 🌐 SCSS | 📅 2026-04-02 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,639 | 🐛 100 | 🌐 TypeScript | 📅 2026-04-04 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,730 | 🐛 287 | 🌐 TypeScript | 📅 2026-04-04 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,499 | 🐛 239 | 🌐 TypeScript | 📅 2026-04-03 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 350 | 🐛 884 | 🌐 TypeScript | 📅 2026-04-04 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 333 | 🐛 75 | 🌐 TypeScript | 📅 2026-04-03 - Web Components implementing Siemens iX design system.
* [Crayons](https://github.com/freshdesk/crayons) ⭐ 239 | 🐛 45 | 🌐 JavaScript | 📅 2026-04-01 - Collection of web components that adheres to the Freshworks Design System.
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 212 | 🐛 63 | 🌐 SCSS | 📅 2026-03-25 - Set of UI components based on Momentum Design.
...
* [Astro Space UX Design System](https://github.com/RocketCommunicationsInc/astro) ⭐ 149 | 🐛 51 | 🌐 TypeScript | 📅 2026-04-03 - Set of components to build rich space app experiences with established interaction patterns.
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 133 | 🐛 204 | 🌐 HTML | 📅 2026-04-03 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 130 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 129 | 🐛 71 | 🌐 TypeScript | 📅 2026-04-02 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 66 | 🐛 37 | 🌐 TypeScript | 📅 2026-04-03 - Library of Web Components adhering to the Forge Design System.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 81 | 🌐 TypeScript | 📅 2026-04-04 - Building blocks of the Lyne Design System are based on Web Components.
* [Zooplus web components](https://github.com/zooplus/zoo-web-components) ⭐ 50 | 🐛 2 | 🌐 JavaScript | 📅 2026-03-25 - Set of web components that implement Z+ shop style guide.
...
* [Omi](https://github.com/Tencent/omi) ⭐ 13,260 | 🐛 70 | 🌐 TypeScript | 📅 2026-03-27 - Next generation web framework in 4kb JavaScript (Web Components + JSX + Proxy + Store + Path Updating).
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,053 | 🐛 173 | 🌐 TypeScript | 📅 2026-04-03 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,639 | 🐛 100 | 🌐 TypeScript | 📅 2026-04-04 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,761 | 🐛 419 | 🌐 JavaScript | 📅 2026-04-02 - blazing fast, enterprise-grade Web Components foundation.
...
* [Panel](https://github.com/mixpanel/panel) ⭐ 275 | 🐛 12 | 🌐 JavaScript | 📅 2026-03-24 - Web Components + Virtual DOM: web standards for powerful UIs.
* [Lume Element](https://github.com/lume/element) ⭐ 185 | 🐛 28 | 🌐 TypeScript | 📅 2026-04-02 - Write custom elements with reactivity and templating powered by Solid.js signals and effects.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 134 | 🐛 6 | 🌐 TypeScript | 📅 2026-04-03 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [DNA](https://github.com/chialab/dna) ⭐ 60 | 🐛 8 | 🌐 TypeScript | 📅 2026-03-23 - Progressive Web Components library.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,349 | 🐛 118 | 🌐 TypeScript | 📅 2026-04-04 - Library that extends Solid adding Custom Web Components and extensions.
* [hybrids](https://github.com/hybridsjs/hybrids) ⭐ 3,172 | 🐛 8 | 🌐 JavaScript | 📅 2026-01-07 - UI library for creating Web Components with simple and functional API.
* [haunted](https://github.com/matthewp/haunted) ⭐ 2,710 | 🐛 62 | 🌐 TypeScript | 📅 2026-04-01 - React's Hooks API implemented for web components.
* [atomico](https://github.com/atomicojs/atomico) ⭐ 1,266 | 🐛 17 | 🌐 TypeScript | 📅 2025-11-26 - Small library for the creation of interfaces based on web components using functions and hooks.
...
* [nuxt-custom-elements](https://github.com/GrabarzUndPartner/nuxt-custom-elements) ⭐ 83 | 🐛 18 | 🌐 JavaScript | 📅 2026-04-03 - Export your project components as custom elements for integration into external pages.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,916 | 🐛 1,008 | 🌐 JavaScript | 📅 2026-03-30 - Web component framework to easily create user-first experiences for the web.
* [WebC](https://github.com/11ty/webc) ⭐ 1,410 | 🐛 65 | 🌐 JavaScript | 📅 2025-12-02 - Framework-independent standalone HTML serializer for generating markup for web components.
* [Web Components Compiler](https://github.com/ProjectEvergreen/wcc) ⭐ 122 | 🐛 22 | 🌐 JavaScript | 📅 2026-03-28 - Compiler to make server-side rendering of native web components easier.
...
* [custom-element-boilerplate](https://github.com/github/custom-element-boilerplate) ⭐ 178 | 🐛 1 | 🌐 TypeScript | 📅 2025-10-30 - Boilerplate for creating a custom element.
...
* [hello-web-components](https://github.com/fernandopasik/hello-web-components) ⭐ 31 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-03 - Simple starter hello world web component written in TypeScript.
...
* [cypress-lit](https://github.com/simonireilly/cypress-lit) ⭐ 25 | 🐛 13 | 🌐 TypeScript | 📅 2026-04-01 - Test your Lit elements and native web components in Cypress with all the modern browsers.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 37 | 🌐 JavaScript | 📅 2026-04-03 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,859 | 🐛 2,760 | 🌐 HTML | 📅 2026-04-04

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,859 | 🐛 2,760 | 🌐 HTML | 📅 2026-04-04
...
* [`ElementInternals`'s `states` property and the `:state()` pseudo class](https://github.com/w3c/webcomponents/blob/gh-pages/proposals/custom-states-and-state-pseudo-class.md) ⭐ 4,482 | 🐛 203 | 🌐 HTML | 📅 2025-12-09
...
* [@webcomponents/custom-elements](https://github.com/webcomponents/polyfills/tree/master/packages/custom-elements) ⭐ 1,184 | 🐛 148 | 🌐 HTML | 📅 2026-04-02 - Custom Elements polyfill by Polymer team.
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,761 | 🐛 419 | 🌐 JavaScript | 📅 2026-04-02 - Shadow DOM polyfill by [LWC](https://lwc.dev).
* [@webcomponents/shadydom](https://github.com/webcomponents/polyfills/tree/master/packages/shadydom) ⭐ 1,184 | 🐛 148 | 🌐 HTML | 📅 2026-04-02 - ShadowDOM v1 shim.
* [@webcomponents/shadycss](https://github.com/webcomponents/polyfills/tree/master/packages/shadycss) ⭐ 1,184 | 🐛 148 | 🌐 HTML | 📅 2026-04-02 - ShadowDOM style encapsulation shim.

#### HTML Templates polyfills

* [@webcomponents/template](https://github.com/webcomponents/polyfills/tree/master/packages/template) ⭐ 1,184 | 🐛 148 | 🌐 HTML | 📅 2026-04-02 - Minimal polyfill for `<template>`.
