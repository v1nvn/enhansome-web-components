...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,927 | 🐛 2,782 | 🌐 HTML | 📅 2026-06-10
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,927 | 🐛 2,782 | 🌐 HTML | 📅 2026-06-10
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,927 | 🐛 2,782 | 🌐 HTML | 📅 2026-06-10
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,927 | 🐛 2,782 | 🌐 HTML | 📅 2026-06-10
...
* [Nude UI](https://github.com/LeaVerou/nudeui) ⭐ 234 | 🐛 6 | 🌐 JavaScript | 📅 2025-04-23 - Collection of accessible, customizable, ultra-light web components.
...
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,119 | 🐛 118 | 🌐 TypeScript | 📅 2026-06-05 - Web component for rendering interactive 3D models.
...
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 6,015 | 🐛 8 | 🌐 JavaScript | 📅 2026-04-19 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,633 | 🐛 36 | 🌐 TypeScript | 📅 2026-06-09 - Web component for chat with AI capabilities.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,524 | 🐛 19 | 🌐 JavaScript | 📅 2026-06-10 quickly into your page using custom elements.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,903 | 🐛 1,018 | 🌐 JavaScript | 📅 2026-05-20 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
* [Shoelace](https://github.com/shoelace-style/shoelace) ⚠️ Archived - A forward-thinking library of web components.
* [Wired Elements](https://github.com/wiredjs/wired-elements) ⭐ 10,796 | 🐛 36 | 🌐 TypeScript | 📅 2023-10-07 - Set of common UI elements with a hand-drawn, sketchy look.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,949 | 🐛 184 | 🌐 JavaScript | 📅 2026-06-09 - Set of highly performant, accessible and flexible Web Components.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 813 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-02 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 565 | 🐛 943 | 🌐 JavaScript | 📅 2026-06-09 - Evolving set of high-quality web components for building business web applications.
...
* [Apollo Elements](https://github.com/apollo-elements/apollo-elements) ⭐ 422 | 🐛 17 | 🌐 TypeScript | 📅 2026-06-09 - Custom elements for using Apollo GraphQL with various web components libraries.
...
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 241 | 🐛 327 | 🌐 JavaScript | 📅 2026-06-09 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 167 | 🐛 64 | 🌐 TypeScript | 📅 2026-06-09 - Complete library of UI components from Infragistics.
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 148 | 🐛 55 | 🌐 TypeScript | 📅 2026-06-08 - Collection of user interface web components for Umbraco CMS.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 43 | 🌐 JavaScript | 📅 2026-06-09 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 43 | 🌐 JavaScript | 📅 2026-06-10 - Components for building web applications with Nuxeo using Web Components.
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 27 | 🐛 45 | 🌐 TypeScript | 📅 2026-06-07 - A schema for mutation testing results with the web components to visualize it.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,046 | 🐛 737 | 🌐 TypeScript | 📅 2026-06-10 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 11,015 | 🐛 171 | 🌐 SCSS | 📅 2026-06-10 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,654 | 🐛 108 | 🌐 TypeScript | 📅 2026-06-10 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,753 | 🐛 239 | 🌐 TypeScript | 📅 2026-06-10 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,519 | 🐛 253 | 🌐 TypeScript | 📅 2026-06-10 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 365 | 🐛 902 | 🌐 TypeScript | 📅 2026-06-10 - Shared Web Components for Esri's Calcite design framework.
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 347 | 🐛 89 | 🌐 TypeScript | 📅 2026-06-09 - Web Components implementing Siemens iX design system.
* [NuML | NUDE Elements](https://github.com/tenphi/numl) ⭐ 339 | 🐛 24 | 🌐 JavaScript | 📅 2026-04-01 - HTML Framework and Design System based on Web Components and runtime CSS generation.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 212 | 🐛 67 | 🌐 SCSS | 📅 2026-06-09 - Set of UI components based on Momentum Design.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 139 | 🐛 196 | 🌐 HTML | 📅 2026-06-09 - Web components for building uniform experiences with the Red Hat brand.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 68 | 🐛 54 | 🌐 TypeScript | 📅 2026-06-09 - Library of Web Components adhering to the Forge Design System.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 55 | 🌐 TypeScript | 📅 2026-06-10 - Building blocks of the Lyne Design System are based on Web Components.
* [NVIDIA Elements](https://github.com/nvidia/elements) ⭐ 14 | 🐛 6 | 🌐 TypeScript | 📅 2026-06-09 - The Design Language and UI Agent Harness for AI/ML Factories, Robotics, and Autonomous Vehicles.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,097 | 🐛 187 | 🌐 TypeScript | 📅 2026-06-08 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,654 | 🐛 108 | 🌐 TypeScript | 📅 2026-06-10 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,768 | 🐛 410 | 🌐 JavaScript | 📅 2026-06-09 - blazing fast, enterprise-grade Web Components foundation.
...
* [Panel](https://github.com/mixpanel/panel) ⭐ 274 | 🐛 20 | 🌐 JavaScript | 📅 2026-06-05 - Web Components + Virtual DOM: web standards for powerful UIs.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 135 | 🐛 6 | 🌐 TypeScript | 📅 2026-06-09 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [DNA](https://github.com/chialab/dna) ⭐ 61 | 🐛 3 | 🌐 TypeScript | 📅 2026-06-01 - Progressive Web Components library.
* [element-js](https://github.com/webtides/element-js) ⭐ 31 | 🐛 23 | 🌐 JavaScript | 📅 2026-04-21 - Simple and lightweight base classes for web components with a beautiful API.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,618 | 🐛 45 | 🌐 TypeScript | 📅 2026-06-09 - Library that extends Solid adding Custom Web Components and extensions.
* [hybrids](https://github.com/hybridsjs/hybrids) ⭐ 3,176 | 🐛 11 | 🌐 JavaScript | 📅 2026-05-21 - UI library for creating Web Components with simple and functional API.
* [haunted](https://github.com/matthewp/haunted) ⭐ 2,717 | 🐛 62 | 🌐 TypeScript | 📅 2026-05-28 - React's Hooks API implemented for web components.
...
* [nuxt-custom-elements](https://github.com/GrabarzUndPartner/nuxt-custom-elements) ⭐ 83 | 🐛 15 | 🌐 JavaScript | 📅 2026-06-09 - Export your project components as custom elements for integration into external pages.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,903 | 🐛 1,018 | 🌐 JavaScript | 📅 2026-05-20 - Web component framework to easily create user-first experiences for the web.
* [WebC](https://github.com/11ty/webc) ⭐ 1,405 | 🐛 65 | 🌐 JavaScript | 📅 2025-12-02 - Framework-independent standalone HTML serializer for generating markup for web components.
...
* [query-selector-shadow-dom](https://github.com/webdriverio/query-selector-shadow-dom) ⭐ 261 | 🐛 23 | 🌐 JavaScript | 📅 2024-03-27 - querySelector that can pierce Shadow DOM roots, useful for automated testing.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,927 | 🐛 2,782 | 🌐 HTML | 📅 2026-06-10

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,927 | 🐛 2,782 | 🌐 HTML | 📅 2026-06-10
...
* [`ElementInternals`'s `states` property and the `:state()` pseudo class](https://github.com/w3c/webcomponents/blob/gh-pages/proposals/custom-states-and-state-pseudo-class.md) ⭐ 4,490 | 🐛 204 | 🌐 HTML | 📅 2025-12-09
...
* [@webcomponents/custom-elements](https://github.com/webcomponents/polyfills/tree/master/packages/custom-elements) ⭐ 1,187 | 🐛 150 | 🌐 HTML | 📅 2026-06-05 - Custom Elements polyfill by Polymer team.
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,768 | 🐛 410 | 🌐 JavaScript | 📅 2026-06-09 - Shadow DOM polyfill by [LWC](https://lwc.dev).
* [@webcomponents/shadydom](https://github.com/webcomponents/polyfills/tree/master/packages/shadydom) ⭐ 1,187 | 🐛 150 | 🌐 HTML | 📅 2026-06-05 - ShadowDOM v1 shim.
* [@webcomponents/shadycss](https://github.com/webcomponents/polyfills/tree/master/packages/shadycss) ⭐ 1,187 | 🐛 150 | 🌐 HTML | 📅 2026-06-05 - ShadowDOM style encapsulation shim.

#### HTML Templates polyfills

* [@webcomponents/template](https://github.com/webcomponents/polyfills/tree/master/packages/template) ⭐ 1,187 | 🐛 150 | 🌐 HTML | 📅 2026-06-05 - Minimal polyfill for `<template>`.
