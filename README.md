...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,911 | 🐛 2,772 | 🌐 HTML | 📅 2026-05-01
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,911 | 🐛 2,772 | 🌐 HTML | 📅 2026-05-01
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,911 | 🐛 2,772 | 🌐 HTML | 📅 2026-05-01
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,911 | 🐛 2,772 | 🌐 HTML | 📅 2026-05-01
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,942 | 🐛 183 | 🌐 JavaScript | 📅 2026-04-25 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,040 | 🐛 112 | 🌐 TypeScript | 📅 2026-04-17 - Web component for rendering interactive 3D models.
...
* [`<shader-doodle>`](https://github.com/halvves/shader-doodle) ⭐ 587 | 🐛 2 | 🌐 JavaScript | 📅 2026-04-30 - Web component for writing and rendering shaders.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,484 | 🐛 22 | 🌐 JavaScript | 📅 2026-04-28 quickly into your page using custom elements.
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 139 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-28 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,904 | 🐛 1,007 | 🌐 JavaScript | 📅 2026-04-27 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,940 | 🐛 176 | 🌐 JavaScript | 📅 2026-04-23 - Set of highly performant, accessible and flexible Web Components.
...
* [AgnosticUI](https://github.com/AgnosticUI/agnosticui) ⭐ 802 | 🐛 3 | 🌐 TypeScript | 📅 2026-04-30 - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 562 | 🐛 946 | 🌐 JavaScript | 📅 2026-04-30 - Evolving set of high-quality web components for building business web applications.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 271 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-30 - ELMS:LN produced web components for any project.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 166 | 🐛 68 | 🌐 TypeScript | 📅 2026-04-30 - Complete library of UI components from Infragistics.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 58 | 🌐 JavaScript | 📅 2026-04-30 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 35 | 🌐 JavaScript | 📅 2026-05-01 - Components for building web applications with Nuxeo using Web Components.
...
* [Tradeshift Elements](https://github.com/Tradeshift/elements) ⭐ 18 | 🐛 59 | 🌐 JavaScript | 📅 2026-05-01 - Reusable Tradeshift UI Components as Web Components.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 28 | 🌐 TypeScript | 📅 2026-04-30 - Ser of web components used by Equinor Fusion.
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 13 | 🐛 9 | 🌐 JavaScript | 📅 2026-04-30 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 19,956 | 🐛 686 | 🌐 TypeScript | 📅 2026-05-01 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,912 | 🐛 164 | 🌐 SCSS | 📅 2026-04-30 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,643 | 🐛 71 | 🌐 TypeScript | 📅 2026-05-01 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,737 | 🐛 265 | 🌐 TypeScript | 📅 2026-05-01 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,506 | 🐛 241 | 🌐 TypeScript | 📅 2026-05-01 - Adobe Spectrum design language implementation built with Web Components.
...
* [PatternFly Elements](https://github.com/patternfly/patternfly-elements) ⭐ 390 | 🐛 158 | 🌐 TypeScript | 📅 2026-04-30 - Collection of flexible and lightweight Web Components based on the Unified Design Kit.
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 354 | 🐛 885 | 🌐 TypeScript | 📅 2026-05-01 - Shared Web Components for Esri's Calcite design framework.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 339 | 🐛 82 | 🌐 TypeScript | 📅 2026-04-30 - Web Components implementing Siemens iX design system.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 212 | 🐛 64 | 🌐 SCSS | 📅 2026-04-30 - Set of UI components based on Momentum Design.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 135 | 🐛 191 | 🌐 HTML | 📅 2026-04-30 - Web components for building uniform experiences with the Red Hat brand.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 67 | 🐛 42 | 🌐 TypeScript | 📅 2026-04-30 - Library of Web Components adhering to the Forge Design System.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 69 | 🌐 TypeScript | 📅 2026-04-30 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,084 | 🐛 178 | 🌐 TypeScript | 📅 2026-04-30 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,643 | 🐛 71 | 🌐 TypeScript | 📅 2026-05-01 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,764 | 🐛 417 | 🌐 JavaScript | 📅 2026-04-30 - blazing fast, enterprise-grade Web Components foundation.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 134 | 🐛 6 | 🌐 TypeScript | 📅 2026-04-30 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,469 | 🐛 57 | 🌐 TypeScript | 📅 2026-04-30 - Library that extends Solid adding Custom Web Components and extensions.
...
* [atomico](https://github.com/atomicojs/atomico) ⭐ 1,269 | 🐛 17 | 🌐 TypeScript | 📅 2026-04-20 - Small library for the creation of interfaces based on web components using functions and hooks.
...
* [nuxt-custom-elements](https://github.com/GrabarzUndPartner/nuxt-custom-elements) ⭐ 83 | 🐛 18 | 🌐 JavaScript | 📅 2026-04-30 - Export your project components as custom elements for integration into external pages.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,904 | 🐛 1,007 | 🌐 JavaScript | 📅 2026-04-27 - Web component framework to easily create user-first experiences for the web.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 37 | 🌐 JavaScript | 📅 2026-04-30 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,911 | 🐛 2,772 | 🌐 HTML | 📅 2026-05-01

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,911 | 🐛 2,772 | 🌐 HTML | 📅 2026-05-01
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,764 | 🐛 417 | 🌐 JavaScript | 📅 2026-04-30 - Shadow DOM polyfill by [LWC](https://lwc.dev).
