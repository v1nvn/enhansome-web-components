...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 5,932 | 🐛 2,773 | 🌐 HTML | 📅 2026-05-19
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 5,932 | 🐛 2,773 | 🌐 HTML | 📅 2026-05-19
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 5,932 | 🐛 2,773 | 🌐 HTML | 📅 2026-05-19
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 5,932 | 🐛 2,773 | 🌐 HTML | 📅 2026-05-19
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 19,941 | 🐛 173 | 🌐 JavaScript | 📅 2026-05-16 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,079 | 🐛 112 | 🌐 TypeScript | 📅 2026-04-17 - Web component for rendering interactive 3D models.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,613 | 🐛 33 | 🌐 TypeScript | 📅 2026-05-18 - Web component for chat with AI capabilities.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,501 | 🐛 25 | 🌐 JavaScript | 📅 2026-05-09 quickly into your page using custom elements.
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 150 | 🐛 4 | 🌐 TypeScript | 📅 2026-05-18 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,943 | 🐛 182 | 🌐 JavaScript | 📅 2026-05-18 - Set of highly performant, accessible and flexible Web Components.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 564 | 🐛 944 | 🌐 JavaScript | 📅 2026-05-18 - Evolving set of high-quality web components for building business web applications.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 167 | 🐛 71 | 🌐 TypeScript | 📅 2026-05-18 - Complete library of UI components from Infragistics.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 78 | 🐛 50 | 🌐 JavaScript | 📅 2026-05-18 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 37 | 🌐 JavaScript | 📅 2026-05-19 - Components for building web applications with Nuxeo using Web Components.
...
* [Titanium Elements](https://github.com/LeavittSoftware/titanium-elements) ⭐ 19 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-18 - Collection of lightweight web components used by Leavitt Group Enterprises.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 35 | 🌐 TypeScript | 📅 2026-05-18 - Ser of web components used by Equinor Fusion.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,005 | 🐛 746 | 🌐 TypeScript | 📅 2026-05-19 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 10,956 | 🐛 167 | 🌐 SCSS | 📅 2026-05-15 - Material Design implemented as Web Components.
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,651 | 🐛 80 | 🌐 TypeScript | 📅 2026-05-19 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,742 | 🐛 260 | 🌐 TypeScript | 📅 2026-05-19 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,511 | 🐛 251 | 🌐 TypeScript | 📅 2026-05-19 - Adobe Spectrum design language implementation built with Web Components.
...
* [PatternFly Elements](https://github.com/patternfly/patternfly-elements) ⭐ 391 | 🐛 173 | 🌐 TypeScript | 📅 2026-05-19 - Collection of flexible and lightweight Web Components based on the Unified Design Kit.
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 362 | 🐛 900 | 🌐 TypeScript | 📅 2026-05-19 - Shared Web Components for Esri's Calcite design framework.
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 343 | 🐛 79 | 🌐 TypeScript | 📅 2026-05-18 - Web Components implementing Siemens iX design system.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 212 | 🐛 65 | 🌐 SCSS | 📅 2026-05-18 - Set of UI components based on Momentum Design.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 138 | 🐛 194 | 🌐 HTML | 📅 2026-05-18 - Web components for building uniform experiences with the Red Hat brand.
...
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 64 | 🐛 67 | 🌐 TypeScript | 📅 2026-05-19 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,090 | 🐛 180 | 🌐 TypeScript | 📅 2026-05-18 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,651 | 🐛 80 | 🌐 TypeScript | 📅 2026-05-19 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
...
* [Panel](https://github.com/mixpanel/panel) ⭐ 274 | 🐛 16 | 🌐 JavaScript | 📅 2026-05-18 - Web Components + Virtual DOM: web standards for powerful UIs.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,541 | 🐛 18 | 🌐 TypeScript | 📅 2026-05-18 - Library that extends Solid adding Custom Web Components and extensions.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 5,932 | 🐛 2,773 | 🌐 HTML | 📅 2026-05-19

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 5,932 | 🐛 2,773 | 🌐 HTML | 📅 2026-05-19
